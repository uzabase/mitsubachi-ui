...
var f1 = (i, t, e) => t.has(i) || O1("Cannot " + e);
var P = (i, t, e) => (f1(i, t, "read from private field"), e ? e.call(i) : t.get(i)), v = (i, t, e) => t.has(i) ? O1("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(i) : t.set(i, e), U1 = (i, t, e, r) => (f1(i, t, "write to private field"), r ? r.call(i, e) : t.set(i, e), e), V = (i, t, e) => (f1(i, t, "access private method"), e);
const e1 = globalThis, m1 = e1.ShadowRoot && (e1.ShadyCSS === void 0 || e1.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, M1 = /* @__PURE__ */ Symbol(), j1 = /* @__PURE__ */ new WeakMap();
let t2 = class {
  constructor(t, e, r) {
  ...
  get styleSheet() {
    ...
    if (m1 && t === void 0) {
      ...
      r && (t = j1.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && j1.set(e, t));
    }
    return t;
  }
  toString() {
...
const g = (i) => new t2(typeof i == "string" ? i : i + "", void 0, M1), g1 = (i, ...t) => {
  const e = i.length === 1 ? i[0] : t.reduce((r, s, o) => r + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(s) + i[o + 1], i[0]);
  return new t2(e, i, M1);
}, M2 = (i, t) => {
  if (m1) i.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const r = document.createElement("style"), s = e1.litNonce;
    s !== void 0 && r.setAttribute("nonce", s), r.textContent = e.cssText, i.appendChild(r);
  }
}, N1 = m1 ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const r of t.cssRules) e += r.cssText;
  return g(e);
})(i) : i;
const { is: y2, defineProperty: v2, getOwnPropertyDescriptor: Z2, getOwnPropertyNames: $2, getOwnPropertySymbols: x2, getPrototypeOf: _2 } = Object, p1 = globalThis, B1 = p1.trustedTypes, w2 = B1 ? B1.emptyScript : "", A2 = p1.reactiveElementPolyfillSupport, I = (i, t) => i, s1 = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? w2 : null;
      break;
  ...
  return e;
} }, y1 = (i, t) => !y2(i, t), R1 = { attribute: !0, type: String, converter: s1, reflect: !1, useDefault: !1, hasChanged: y1 };
Symbol.metadata ??= /* @__PURE__ */ Symbol("metadata"), p1.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let T = class extends HTMLElement {
  ...
  static createProperty(t, e = R1) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(t, e), !e.noAccessor) {
      ...
      s !== void 0 && v2(this.prototype, t, s);
    }
  }
  static getPropertyDescriptor(t, e, r) {
    const { get: s, set: o } = Z2(this.prototype, t) ?? { get() {
      return this[e];
    }, set(n) {
      this[e] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(I("properties"))) {
      const e = this.properties, r = [...$2(e), ...x2(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const s of r) e.unshift(N1(s));
  ...
  _$ET(t, e) {
    ...
    if (s !== void 0 && r.reflect === !0) {
      const o = (r.converter?.toAttribute !== void 0 ? r.converter : s1).toAttribute(e, r.type);
  ...
  _$AK(t, e) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const o = r.getPropertyOptions(s), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : s1;
      this._$Em = s;
  ...
  requestUpdate(t, e, r, s = !1, o) {
    if (t !== void 0) {
      ...
      if (s === !1 && (o = this[t]), r ??= n.getPropertyOptions(t), !((r.hasChanged ?? y1)(o, e) || r.useDefault && r.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(n._$Eu(t, r)))) return;
      this.C(t, e, r);
    }
...
T.elementStyles = [], T.shadowRootOptions = { mode: "open" }, T[I("elementProperties")] = /* @__PURE__ */ new Map(), T[I("finalized")] = /* @__PURE__ */ new Map(), A2?.({ ReactiveElement: T }), (p1.reactiveElementVersions ??= []).push("2.1.2");
const v1 = globalThis, D1 = (i) => i, i1 = v1.trustedTypes, F1 = i1 ? i1.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, e2 = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, s2 = "?" + w, k2 = `<${s2}>`, z = document, q = () => z.createComment(""), W = (i) => i === null || typeof i != "object" && typeof i != "function", Z1 = Array.isArray, E2 = (i) => Z1(i) || typeof i?.[Symbol.iterator] == "function", H1 = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, I1 = /-->/g, q1 = />/g, k = RegExp(`>|${H1}(?:([^\\s"'>=/]+)(${H1}*=${H1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), W1 = /'/g, J1 = /"/g, i2 = /^(?:script|style|textarea|title)$/i, z2 = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = z2(1), A = /* @__PURE__ */ Symbol.for("lit-noChange"), c = /* @__PURE__ */ Symbol.for("lit-nothing"), K1 = /* @__PURE__ */ new WeakMap(), E = z.createTreeWalker(z, 129);
function r2(i, t) {
  if (!Z1(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return F1 !== void 0 ? F1.createHTML(t) : t;
}
const S2 = (i, t) => {
  ...
  for (let C = 0; C < e; C++) {
    const l = i[C];
    let h, u, d = -1, y = 0;
    for (; y < l.length && (n.lastIndex = y, u = n.exec(l), u !== null); ) y = n.lastIndex, n === F ? u[1] === "!--" ? n = I1 : u[1] !== void 0 ? n = q1 : u[2] !== void 0 ? (i2.test(u[2]) && (s = RegExp("</" + u[2], "g")), n = k) : u[3] !== void 0 && (n = k) : n === k ? u[0] === ">" ? (n = s ?? F, d = -1) : u[1] === void 0 ? d = -2 : (d = n.lastIndex - u[2].length, h = u[1], n = u[3] === void 0 ? k : u[3] === '"' ? J1 : W1) : n === J1 || n === W1 ? n = k : n === I1 || n === q1 ? n = F : (n = k, s = void 0);
    const _ = n === k && i[C + 1].startsWith("/>") ? " " : "";
    o += n === F ? l + k2 : d >= 0 ? (r.push(h), l.slice(0, d) + e2 + l.slice(d) + w + _) : l + w + (d === -2 ? C : _);
  }
  return [r2(i, o + (i[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class J {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const C = t.length - 1, l = this.parts, [h, u] = S2(t, e);
    if (this.el = J.createElement(h, r), E.currentNode = this.el.content, e === 2 || e === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (s = E.nextNode()) !== null && l.length < C; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(e2)) {
          const y = u[n++], _ = s.getAttribute(d).split(w), t1 = /([.?@])?(.*)/.exec(y);
          l.push({ type: 1, index: o, name: t1[2], strings: _, ctor: t1[1] === "." ? T2 : t1[1] === "?" ? O2 : t1[1] === "@" ? U2 : u1 }), s.removeAttribute(d);
        } else d.startsWith(w) && (l.push({ type: 6, index: o }), s.removeAttribute(d));
        if (i2.test(s.tagName)) {
          const d = s.textContent.split(w), y = d.length - 1;
          if (y > 0) {
            s.textContent = i1 ? i1.emptyScript : "";
            for (let _ = 0; _ < y; _++) s.append(d[_], q()), E.nextNode(), l.push({ type: 2, index: ++o });
            s.append(d[y], q());
          }
        }
      } else if (s.nodeType === 8) if (s.data === s2) l.push({ type: 2, index: o });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(w, d + 1)) !== -1; ) l.push({ type: 7, index: o }), d += w.length - 1;
      }
      o++;
    }
  }
...
class P2 {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, s = (t?.creationScope ?? z).importNode(e, !0);
    E.currentNode = s;
    let o = E.nextNode(), n = 0, C = 0, l = r[0];
    for (; l !== void 0; ) {
      if (n === l.index) {
        let h;
        l.type === 2 ? h = new X(o, o.nextSibling, this, t) : l.type === 1 ? h = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (h = new j2(o, this, t)), this._$AV.push(h), l = r[++C];
      }
      n !== l?.index && (o = E.nextNode(), n++);
    }
    return E.currentNode = z, s;
  }
  p(t) {
    let e = 0;
...
class X {
  ...
  _$AI(t, e = this) {
    t = U(this, t, e), W(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : E2(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== c && W(this._$AH) ? this._$AA.nextSibling.data = t : this.T(z.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: r } = t, s = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = J.createElement(r2(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === s) this._$AH.p(e);
    else {
      const o = new P2(s, this), n = o.u(this.options);
      o.p(e), this.T(n), this._$AH = o;
    }
  }
  _$AC(t) {
    let e = K1.get(t.strings);
    return e === void 0 && K1.set(t.strings, e = new J(t)), e;
  }
  k(t) {
    Z1(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let r, s = 0;
    for (const o of t) s === e.length ? e.push(r = new X(this.O(q()), this.O(q()), this, this.options)) : r = e[s], r._$AI(o), s++;
    s < e.length && (this._$AR(r && r._$AB.nextSibling, s), e.length = s);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    for (this._$AP?.(!1, !0, e); t !== this._$AB; ) {
      const r = D1(t).nextSibling;
      D1(t).remove(), t = r;
    }
  }
  setConnected(t) {
...
class u1 {
  ...
  _$AI(t, e = this, r, s) {
    ...
    let n = !1;
    if (o === void 0) t = U(this, t, e, 0), n = !W(t) || t !== this._$AH && t !== A, n && (this._$AH = t);
    else {
      const C = t;
      let l, h;
      for (t = o[0], l = 0; l < o.length - 1; l++) h = U(this, C[r + l], e, l), h === A && (h = this._$AH[l]), n ||= !W(h) || h !== this._$AH[l], h === c ? t = c : t !== c && (t += (h ?? "") + o[l + 1]), this._$AH[l] = h;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
const N2 = v1.litHtmlPolyfillSupport;
N2?.(J, X), (v1.litHtmlVersions ??= []).push("3.3.2");
const B2 = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let s = r._$litPart$;
  if (s === void 0) {
    const o = e?.renderBefore ?? null;
    r._$litPart$ = s = new X(t.insertBefore(q(), o), o, void 0, e ?? {});
  }
  return s._$AI(i), s;
};
const $1 = globalThis;
let f = class extends T {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = B2(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const R2 = $1.litElementPolyfillSupport;
R2?.({ LitElement: f });
($1.litElementVersions ??= []).push("4.2.2");
const D2 = { attribute: !0, type: String, converter: s1, reflect: !1, hasChanged: y1 }, F2 = (i = D2, t, e) => {
...
function a(i) {
  return (t, e) => typeof e == "object" ? F2(i, t, e) : ((r, s, o) => {
    const n = s.hasOwnProperty(o);
    return s.constructor.createProperty(o, r), n ? Object.getOwnPropertyDescriptor(s, o) : void 0;
  })(i, t, e);
}
const o2 = { ATTRIBUTE: 1, CHILD: 2 }, x1 = (i) => (...t) => ({ _$litDirective$: i, values: t });
class n2 {
  constructor(t) {
  }
  get _$AU() {
...
let r1 = class extends n2 {
  constructor(t) {
    if (super(t), this.it = c, t.type !== o2.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const K2 = ":host{display:inline-block;width:1.28em;height:1.28em}.icon{width:100%;height:100%}", Y2 = [
  "app",
  "arrow-down",
  "arrow-down-small",
  "arrow-left",
...
var Q2 = Object.defineProperty, X2 = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && Q2(t, e, s), s;
};
function a2(i) {
  return Y2.includes(i);
}
...
`;
var e9 = Object.defineProperty, D = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && e9(t, e, s), s;
};
const s9 = ["small", "medium", "large", "x-large", "2x-large"], i9 = [
  "plum",
  "violet",
  "blue",
  "viridian",
...
function r9(i) {
  return s9.some((t) => t === i) ? i : (console.warn(`${i}は無効なsize属性です。`), "medium");
}
function o9(i) {
  return i9.some((t) => t === i);
}
var $, l2, C2, V1;
...
$ = new WeakSet(), l2 = function() {
  const e = ["base", `size-${r9(this.size)}`];
  return !this.src && P(this, $, V1) && this.color && o9(this.color) && e.push(`color-${this.color}`), this.inactive && e.push("inactive"), e.filter(Boolean).join(" ");
}, C2 = function() {
  this.src = "";
}, V1 = function() {
...
var C9 = Object.defineProperty, M = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && C9(t, e, s), s;
};
const Y1 = ["primary", "secondary", "tertiary", "ghost"], G1 = ["medium", "large", "xLarge"];
function Q1(i) {
  return Y1.some((t) => t === i) ? i : (console.warn(`${i}は無効なvariant属性です。`), Y1[0]);
}
function X1(i) {
  return G1.some((t) => t === i) ? i : (console.warn(`${i}は無効なsize属性です。`), G1[0]);
}
function d9(i) {
  return a2(i) ? !0 : (console.warn(`${i}は無効なicon-type属性です。`), !1);
}
var O, a1, c2;
const l1 = class l1 extends f {
  constructor() {
    ...
    v(this, a1);
    v(this, O);
    this.loading = !1, this.disabled = !1, this.danger = !1, this.variants = null, this.variant = "primary", this.size = "medium", this.name = "", this.value = "", this.type = "button", this.iconType = "", U1(this, O, this.attachInternals());
  }
  get buttonClasses() {
    const e = {
      medium: "medium",
    ...
    return [
      ...
      this.variants ? Q1(this.variants) : Q1(this.variant),
      e[X1(this.size)],
  ...
  get showIcon() {
    return !this.loading && this.iconType && d9(this.iconType);
  }
  renderIcon() {
...
}, l1.styles = b(g(l9)), l1.formAssociated = !0;
let H = l1;
M([
...
const Y = x1(class extends n2 {
  constructor(i) {
    if (super(i), i.type !== o2.ATTRIBUTE || i.name !== "class" || i.strings?.length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(i) {
...
var h9 = Object.defineProperty, h2 = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && h9(t, e, s), s;
}, N, p2, u2;
const E1 = class E1 extends f {
  ...
  render() {
    return p`
      <span class=${V(this, N, p2).call(this)}>${this.text}</span>
      <span class=${V(this, N, u2).call(this)}>${this.supportText}</span>
    `;
  }
};
...
const p9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, u9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, f9 = `<svg viewBox="0 0 134 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, H9 = `<svg viewBox="0 0 118 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var g9 = Object.defineProperty, f2 = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && g9(t, e, s), s;
}, C1, H2;
const z1 = class z1 extends f {
  ...
  render() {
    const e = V(this, C1, H2).call(this);
    return e ? p`${I2(e)}` : p``;
  }
};
C1 = new WeakSet(), H2 = function() {
  ...
  if (this.brand === "speeda")
    return this.language === "en" ? u9 : this.language === "zh" ? f9 : p9;
}, z1.styles = b();
let Q = z1;
f2([
  a({ type: String, reflect: !0 })
...
const L9 = ":host{display:block;border-radius:6px;padding:8px 0;box-shadow:0 5px 9px 2px #00000021;background-color:#fff}", S1 = class S1 extends f {
  render() {
    return p`<slot></slot>`;
  }
};
...
customElements.get("sp-control-menu-item") || customElements.define("sp-control-menu-item", j);
const m9 = ":host .container{display:flex;gap:2px;align-items:center;padding-top:8px;color:#c92812}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}";
var M9 = Object.defineProperty, y9 = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && M9(t, e, s), s;
}, d1, g2;
const T1 = class T1 extends f {
  ...
  render() {
    return p`
      <div class="${V(this, d1, g2).call(this)}" role="error">
...
}, c1.styles = b(g(v9)), c1.formAssociated = !0;
let m = c1;
S([
  a({ type: String, reflect: !0 })
], m.prototype, "error");
...
const $9 = ":host .label{margin-bottom:8px;text-align:left}:host .label.none{display:none}";
var x9 = Object.defineProperty, x = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && x9(t, e, s), s;
}, R, b2, m2;
...
R = new WeakSet(), b2 = function() {
  ...
  const r = e.target;
  this.value = r.value;
}, h1.styles = b(g($9)), h1.formAssociated = !0;
let L = h1;
x([
  a({ type: String, reflect: !0 })
], L.prototype, "text");
