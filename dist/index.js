...
var te = globalThis, C = (e) => e, ne = te.trustedTypes, re = ne ? ne.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ie = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, ae = "?" + w, oe = `<${ae}>`, T = document, se = () => T.createComment(""), ce = (e) => e === null || typeof e != "object" && typeof e != "function", le = Array.isArray, ue = (e) => le(e) || typeof e?.[Symbol.iterator] == "function", de = "[ 	\n\f\r]", fe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pe = /-->/g, me = />/g, E = RegExp(`>|${de}(?:([^\\s"'>=/]+)(${de}*=${de}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), he = /'/g, ge = /"/g, _e = /^(?:script|style|textarea|title)$/i, D = ((e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}))(1), O = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), ve = /* @__PURE__ */ new WeakMap(), ye = T.createTreeWalker(T, 129);
function be(e, t) {
...
var xe = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		a += o === fe ? n + oe : l >= 0 ? (r.push(s), n.slice(0, l) + ie + n.slice(l) + w + d) : n + w + (l === -2 ? t : d);
	}
	...
	constructor({ strings: t, _$litType$: n }, r) {
		...
		if (this.el = e.createElement(l, r), ye.currentNode = this.el.content, n === 2 || n === 3) {
			let e = this.el.content.firstChild;
			e.replaceWith(...e.childNodes);
		}
		for (; (i = ye.nextNode()) !== null && c.length < s;) {
			if (i.nodeType === 1) {
				...
				if (_e.test(i.tagName)) {
					...
					if (t > 0) {
						...
						for (let n = 0; n < t; n++) i.append(e[n], se()), ye.nextNode(), c.push({
							type: 2,
							index: ++a
						});
						i.append(e[t], se());
...
var we = class {
	...
	u(e) {
		...
		ye.currentNode = r;
		let i = ye.nextNode(), a = 0, o = 0, s = n[0];
		for (; s !== void 0;) {
			if (a === s.index) {
				let t;
			...
			a !== s?.index && (i = ye.nextNode(), a++);
		}
		return ye.currentNode = T, r;
	}
	p(e) {
		let t = 0;
	...
	_$AI(e, t = this) {
		e = Ce(this, e, t), ce(e) ? e === k || e == null || e === "" ? (this._$AH !== k && this._$AR(), this._$AH = k) : e !== this._$AH && e !== O && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? ue(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	_(e) {
		this._$AH !== k && ce(this._$AH) ? this._$AA.nextSibling.data = e : this.T(T.createTextNode(e)), this._$AH = e;
	}
	$(e) {
	...
	_$AI(e, t = this, n, r) {
		...
		if (i === void 0) e = Ce(this, e, t, 0), a = !ce(e) || e !== this._$AH && e !== O, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = Ce(this, r[n + o], t, o), s === O && (s = this._$AH[o]), a ||= !ce(s) || s !== this._$AH[o], s === k ? e = k : e !== k && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
...
}, je = te.litHtmlPolyfillSupport;
je?.(Se, Te), (te.litHtmlVersions ??= []).push("3.3.2");
var Me = (e, t, n) => {
...
var Be = {
	...
	constructor(e) {
		if (super(e), this.it = k, e.type !== Be.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
	}
	render(e) {
...
var Ze = {
	...N,
	"minus-cycle": N["minus-circle"],
	"minus-cycle-fill": N["minus-circle-fill"],
	"plus-cycle": N["plus-circle"],
	"plus-cycle-fill": N["plus-circle-fill"],
	question: N["question-circle"],
	followlist: N["follow-list"],
	"followlist-fill": N["follow-list-fill"]
}, Qe = [
	"minus-cycle",
	"minus-cycle-fill",
	"plus-cycle",
...
P([j({
	type: String,
	reflect: !0
})], tt.prototype, "type", void 0);
var nt = class extends tt {};
customElements.get("mi-icon") || customElements.define("mi-icon", tt), customElements.get("sp-icon") || customElements.define("sp-icon", nt);
//#endregion
...
function ot(e) {
	return it.some((t) => t === e) ? e : (console.warn(`${e}は無効なsize属性です。`), "medium");
}
function st(e) {
...
var F = class extends A {
	...
	get #e() {
		let e = ["base", `size-${ot(this.size)}`];
		return !this.src && this.#n && this.color && st(this.color) && e.push(`color-${this.color}`), this.inactive && e.push("inactive"), e.filter(Boolean).join(" ");
	}
	#t() {
		this.src = "";
	}
      ...
      <div class="${this.#e}">
        ${this.src ? D`
              <img
                ...
                class="image"
              />
            ` : e ? D`<div class="initials">${e}</div>` : D`<div class="icon"><mi-icon type="person"></mi-icon></div>`}
      </div>
    `;
	}
};
P([j({ type: String })], F.prototype, "src", void 0), P([j({ type: String })], F.prototype, "alt", void 0), P([j({ type: String })], F.prototype, "initials", void 0), P([j({ type: String })], F.prototype, "size", void 0), P([j({ type: String })], F.prototype, "color", void 0), P([j({ type: Boolean })], F.prototype, "inactive", void 0);
var ct = class extends F {};
customElements.get("mi-avatar") || customElements.define("mi-avatar", F), customElements.get("sp-avatar") || customElements.define("sp-avatar", ct);
//#endregion
//#region src/components/loading/loading.css?inline
var lt = ":host{--size-medium:12.5px;--size-large:15px;--size-x-large:17.5px;--size-2x-large:20px;--size-3x-large:26px;--size-4x-large:40px;--padding-medium:1.25px;--padding-large:1.5px;--padding-x-large:2px 2px 1.5px 1.5px;--padding-2x-large:2px;--padding-3x-large:3px;--padding-4x-large:4px;--border-size-ratio:1/10;--ui-semantic-object-regular-default:#000000d6;--neutral-neutral-20-alpha:#00000012;--background-normal:linear-gradient(white, white) padding-box padding-box,conic-gradient(var(--ui-semantic-object-regular-default) 0deg 270deg, var(--neutral-neutral-20-alpha) 270deg 360deg) border-box border-box;--background-ai:linear-gradient(white, white) padding-box padding-box,conic-gradient(#2a2af7 5%, #2a2af7 22%, #47d4ff 30%, #ff2ed5 73%, #f72a48 80%, #f72a48 84%, #2a2af7 100%) border-box border-box;flex-shrink:0;display:inline-flex}.base{display:flex}.base:has(.size-medium){padding:var(--padding-medium)}.base:has(.size-large){padding:var(--padding-large)}.base:has(.size-x-large){padding:var(--padding-x-large)}.base:has(.size-2x-large){padding:var(--padding-2x-large)}.base:has(.size-3x-large){padding:var(--padding-3x-large)}.base:has(.size-4x-large){padding:var(--padding-4x-large)}.size-medium{--size:var(--size-medium)}.size-large{--size:var(--size-large)}.size-x-large{--size:var(--size-x-large)}.size-2x-large{--size:var(--size-2x-large)}.size-3x-large{--size:var(--size-3x-large)}.size-4x-large{--size:var(--size-4x-large)}.loading{width:var(--size);height:var(--size);border:calc(var(--size) * var(--border-size-ratio)) solid transparent;border-radius:50%;animation:1s linear infinite spin;display:inline-block;-webkit-mask-image:radial-gradient(circle closest-side,#0000 80%,#000 80%);mask-image:radial-gradient(circle closest-side,#0000 80%,#000 80%)}.variant-ai{background:var(--background-ai)}.variant-normal{background:var(--background-normal)}@keyframes spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}", ut = class extends A {
	constructor(...e) {
...
P([j({ type: Boolean })], ut.prototype, "ai", void 0), P([j({ type: String })], ut.prototype, "size", void 0);
var dt = class extends ut {};
customElements.get("mi-loading") || customElements.define("mi-loading", ut), customElements.get("sp-loading") || customElements.define("sp-loading", dt);
//#endregion
...
function gt(e) {
	return mt.some((t) => t === e);
}
function _t(e) {
	return et(e) ? !0 : (console.warn(`${e}は無効なicon-type属性です。`), !1);
}
var I = class extends A {
	...
	getEffectiveVariant() {
		let e = ht(this.variant);
		return e || console.warn(`${this.variant}は無効なvariant属性です。`), e ? this.variant : pt[0];
	}
	get buttonClasses() {
		let e = {
			medium: "medium",
	...
	get loadingSize() {
		return {
			...
			large: "xLarge",
			xLarge: "2xLarge"
		}[gt(this.size) ? this.size : mt[0]];
	}
	renderLoading() {
		return D`<mi-loading size="${this.loadingSize}"></mi-loading>`;
	}
	get showIcon() {
		return !this.loading && this.iconType && _t(this.iconType);
	}
	renderIcon() {
		return D`<mi-icon type="${this.iconType}" class="icon"></mi-icon>`;
	}
	renderSlot() {
		return D`<slot class="text"></slot>`;
	}
	get effectiveRel() {
		return this.rel ? this.rel : this.target === "_blank" ? "noopener noreferrer" : "";
	}
	renderContent() {
		return D`${this.loading ? this.renderLoading() : k}${this.showIcon ? this.renderIcon() : k}
    ${this.renderSlot()}`;
	}
	render() {
		return this.isLink ? D`
        <a
          class="${this.buttonClasses}"
          href="${this.isDisabled ? k : this.href}"
          target="${this.target || k}"
          rel="${this.effectiveRel || k}"
      ...
      <button
        ...
        type="${this.type}"
        form="${this.form || k}"
        aria-pressed="${this.toggle ? this.selected ? "true" : "false" : k}"
        aria-busy="${this.loading ? "true" : k}"
...
P([j({
	type: Boolean,
	reflect: !0
})], I.prototype, "loading", void 0), P([j({
	type: Boolean,
	reflect: !0
})], I.prototype, "disabled", void 0), P([j({
	type: Boolean,
	reflect: !0
})], I.prototype, "selected", void 0), P([j({
	type: Boolean,
	reflect: !0
})], I.prototype, "toggle", void 0), P([j({
	type: String,
	reflect: !0
})], I.prototype, "variant", void 0), P([j({
	type: String,
	reflect: !0
})], I.prototype, "size", void 0), P([j({ type: String })], I.prototype, "name", void 0), P([j({ type: String })], I.prototype, "value", void 0), P([j({ type: String })], I.prototype, "type", void 0), P([j({ type: String })], I.prototype, "form", void 0), P([j({ type: String })], I.prototype, "href", void 0), P([j({ type: String })], I.prototype, "target", void 0), P([j({ type: String })], I.prototype, "rel", void 0), P([j({
	type: String,
	attribute: "icon-type"
})], I.prototype, "iconType", void 0);
//#endregion
...
var vt = class extends I {
	...
	renderIcon() {
		return D`<mi-icon type="magic-fill" class="icon"></mi-icon>`;
	}
	renderLoading() {
		return D`<mi-loading
...
P([j({ type: String })], vt.prototype, "variant", void 0), P([j({ attribute: !1 })], vt.prototype, "iconType", void 0), customElements.get("mi-ai-button") || customElements.define("mi-ai-button", vt);
//#endregion
...
P([j({ type: String })], yt.prototype, "variant", void 0), customElements.get("mi-danger-button") || customElements.define("mi-danger-button", yt);
//#endregion
//#region node_modules/@floating-ui/utils/dist/floating-ui.utils.mjs
var bt = Math.min, L = Math.max, xt = Math.round, St = Math.floor, R = (e) => ({
	x: e,
	y: e
}), Ct = {
	left: "right",
...
function jt(e, t, n) {
	n === void 0 && (n = !1);
	let r = Dt(e), i = At(e), a = kt(i), o = i === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
...
var Pt = ["left", "right"], Ft = ["right", "left"], It = ["top", "bottom"], Lt = ["bottom", "top"];
function Rt(e, t, n) {
	switch (e) {
		case "top":
		case "bottom": return n ? t ? Ft : Pt : t ? Pt : Ft;
		case "left":
		case "right": return t ? It : Lt;
		default: return [];
	}
}
function zt(e, t, n, r) {
	let i = Dt(e), a = Rt(Et(e), n === "start", r);
	return i && (a = a.map((e) => e + "-" + i), t && (a = a.concat(a.map(Nt)))), a;
}
function Bt(e) {
	let t = Et(e);
...
function Wt(e, t, n) {
	let { reference: r, floating: i } = e, a = z(t), o = At(t), s = kt(o), c = Et(t), l = a === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[s] / 2 - i[s] / 2, p;
	switch (c) {
		case "top":
			p = {
				x: u,
...
async function Gt(e, t) {
	t === void 0 && (t = {});
	let { x: n, y: r, platform: i, rects: a, elements: o, strategy: s } = e, { boundary: c = "clippingAncestors", rootBoundary: l = "viewport", elementContext: u = "floating", altBoundary: d = !1, padding: f = 0 } = Tt(t, e), p = Ht(f), m = o[d ? u === "floating" ? "reference" : "floating" : u], h = Ut(await i.getClippingRect({
		...
		x: 1,
		y: 1
	}, y = Ut(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
		elements: o,
		rect: g,
		offsetParent: _,
		strategy: s
...
var Kt = 50, qt = async (e, t, n) => {
	...
	for (let n = 0; n < a.length; n++) {
		...
		u = v ?? u, d = y ?? d, m[g] = {
			...m[g],
			...b
		}, x && p < Kt && (p++, typeof x == "object" && (x.placement && (f = x.placement), x.rects && (l = x.rects === !0 ? await o.getElementRects({
			reference: e,
			floating: t,
			strategy: i
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			...
			let g = Et(r), _ = z(o), v = Et(o) === o, y = await (s.isRTL == null ? void 0 : s.isRTL(c.floating)), b = d || (v || !m ? [Bt(o)] : Mt(o)), x = p !== "none";
			!d && x && b.push(...zt(o, m, p, y));
			let ee = [o, ...b], S = await s.detectOverflow(t, h), te = [], C = i.flip?.overflows || [];
			if (l && te.push(S[g]), u) {
				let e = jt(r, a, y);
				te.push(S[e[0]], S[e[1]]);
			}
			if (C = [...C, {
				...
				if (t && (!(u === "alignment" && _ !== z(t)) || C.every((e) => z(e.placement) === _ ? e.overflows[0] > 0 : !0))) return {
					data: {
						index: e,
						overflows: C
					},
...
async function Xt(e, t) {
	let { placement: n, platform: r, elements: i } = e, a = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), o = Et(n), s = Dt(n), c = z(n) === "y", l = Yt.has(o) ? -1 : 1, u = a && c ? -1 : 1, d = Tt(t, e), { mainAxis: f, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
...
var Zt = function(e) {
	return e === void 0 && (e = 0), {
		...
		async fn(t) {
			var n;
			let { x: r, y: i, placement: a, middlewareData: o } = t, s = await Xt(t, e);
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			let { x: n, y: r, placement: i, platform: a } = t, { mainAxis: o = !0, crossAxis: s = !1, limiter: c = { fn: (e) => {
				...
				x: n,
				y: r
			}, d = await a.detectOverflow(t, l), f = z(Et(i)), p = Ot(f), m = u[p], h = u[f];
			if (o) {
...
function tn(e) {
	return $t() ? e instanceof Node || e instanceof B(e).Node : !1;
}
function H(e) {
	return $t() ? e instanceof Element || e instanceof B(e).Element : !1;
}
function U(e) {
	return $t() ? e instanceof HTMLElement || e instanceof B(e).HTMLElement : !1;
}
function nn(e) {
	return !$t() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof B(e).ShadowRoot;
}
function rn(e) {
...
var sn = /transform|translate|scale|rotate|perspective|filter/, cn = /paint|layout|strict|content/, W = (e) => !!e && e !== "none", ln;
function un(e) {
	let t = H(e) ? G(e) : e;
	return W(t.transform) || W(t.translate) || W(t.scale) || W(t.rotate) || W(t.perspective) || !fn() && (W(t.backdropFilter) || W(t.filter)) || sn.test(t.willChange || "") || cn.test(t.contain || "");
}
function dn(e) {
	let t = K(e);
	for (; U(t) && !pn(t);) {
...
function K(e) {
	...
	let t = e.assignedSlot || e.parentNode || nn(e) && e.host || V(e);
	return nn(t) ? t.host : t;
}
function hn(e) {
	let t = K(e);
	return pn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : U(t) && rn(t) ? t : hn(t);
}
function gn(e, t, n) {
	t === void 0 && (t = []), n === void 0 && (n = !0);
	let r = hn(e), i = r === e.ownerDocument?.body, a = B(r);
	if (i) {
		let e = _n(a);
		return t.concat(a, a.visualViewport || [], rn(r) ? r : [], e && n ? gn(e) : []);
...
function vn(e) {
	let t = G(e), n = parseFloat(t.width) || 0, r = parseFloat(t.height) || 0, i = U(e), a = i ? e.offsetWidth : n, o = i ? e.offsetHeight : r, s = xt(n) !== a || xt(r) !== o;
	return s && (n = a, r = o), {
		width: n,
		height: r,
		$: s
...
function bn(e) {
	let t = yn(e);
	if (!U(t)) return R(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = vn(t), o = (a ? xt(n.width) : n.width) / r, s = (a ? xt(n.height) : n.height) / i;
...
function q(e, t, n, r) {
	...
	let i = e.getBoundingClientRect(), a = yn(e), o = R(1);
	t && (r ? H(r) && (o = bn(r)) : o = bn(e));
	let s = Cn(a, n, r) ? Sn(a) : R(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a) {
		let e = B(a), t = r && H(r) ? B(r) : r, n = e, i = _n(n);
		for (; i && r && t !== n;) {
			...
			c *= e.x, l *= e.y, u *= e.x, d *= e.y, c += a, l += o, n = B(i), i = _n(n);
		}
	}
	return Ut({
		width: u,
...
function Tn(e, t) {
	...
	return {
		x: n.left + t.scrollLeft - wn(e, n),
		y: n.top + t.scrollTop
	};
}
function En(e) {
	let { elements: t, rect: n, offsetParent: r, strategy: i } = e, a = i === "fixed", o = V(r), s = t ? on(t.floating) : !1;
	if (r === o || s && a) return n;
	let c = {
		scrollLeft: 0,
		scrollTop: 0
	}, l = R(1), u = R(0), d = U(r);
	if ((d || !d && !a) && ((en(r) !== "body" || rn(o)) && (c = mn(r)), d)) {
		let e = q(r);
		l = bn(r), u.x = e.x + r.clientLeft, u.y = e.y + r.clientTop;
	}
	let f = o && !d && !a ? Tn(o, c) : R(0);
	return {
		width: n.width * l.x,
		height: n.height * l.y,
...
function On(e) {
	let t = V(e), n = mn(e), r = e.ownerDocument.body, i = L(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = L(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + wn(e), s = -n.scrollTop;
	return G(r).direction === "rtl" && (o += L(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
function jn(e, t) {
	let n = q(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = U(e) ? bn(e) : R(1);
	return {
...
function Mn(e, t, n) {
	...
	else if (t === "document") r = On(V(e));
	else if (H(t)) r = jn(t, n);
	else {
		let n = Sn(e);
		r = {
			x: t.x - n.x,
...
function Nn(e, t) {
	let n = K(e);
	return n === t || !H(n) || pn(n) ? !1 : G(n).position === "fixed" || Nn(n, t);
}
function Pn(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = gn(e, [], !1).filter((e) => H(e) && en(e) !== "body"), i = null, a = G(e).position === "fixed", o = a ? K(e) : e;
	for (; H(o) && !pn(o);) {
		let t = G(o), n = un(o);
		!n && t.position === "fixed" && (i = null), (a ? !n && !i : !n && t.position === "static" && i && (i.position === "absolute" || i.position === "fixed") || rn(o) && !n && Nn(e, o)) ? r = r.filter((e) => e !== o) : i = t, o = K(o);
	}
	return t.set(e, r), r;
}
function Fn(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? on(t) ? [] : Pn(t, this._c) : [].concat(n), r], o = Mn(t, a[0], i), s = o.top, c = o.right, l = o.bottom, u = o.left;
	for (let e = 1; e < a.length; e++) {
		let n = Mn(t, a[e], i);
		s = L(n.top, s), c = bt(n.right, c), l = bt(n.bottom, l), u = L(n.left, u);
	}
	return {
		width: c - u,
		height: l - s,
...
function Ln(e, t, n) {
	...
	if (r || !r && !a) if ((en(t) !== "body" || rn(i)) && (s = mn(t)), r) {
		let e = q(t, !0, a, t);
		c.x = e.x + t.clientLeft, c.y = e.y + t.clientTop;
	} else i && l();
	a && !r && i && l();
	let u = i && !r && !a ? Tn(i, s) : R(0);
	return {
...
function zn(e, t) {
	if (!U(e) || G(e).position === "fixed") return null;
	if (t) return t(e);
...
function Bn(e, t) {
	...
	if (!U(e)) {
		let t = K(e);
		for (; t && !pn(t);) {
			if (H(t) && !Rn(t)) return t;
			t = K(t);
		}
		return n;
	}
	let r = zn(e, t);
	for (; r && an(r) && Rn(r);) r = zn(r, t);
	return r && pn(r) && Rn(r) && !un(r) ? n : r || dn(e) || n;
}
var Vn = async function(e) {
	let t = this.getOffsetParent || Bn, n = this.getDimensions, r = await n(e.floating);
	return {
...
function Gn(e, t) {
	...
	function o(s, c) {
		...
		function b(t) {
			...
			n === 1 && !Wn(l, e.getBoundingClientRect()) && o(), y = !1;
		}
		try {
...
function Kn(e, t, n, r) {
	...
	function g() {
		let t = q(e);
		h && !Wn(h, t) && n(), h = t, m = requestAnimationFrame(g);
	}
	return n(), () => {
		var e;
		u.forEach((e) => {
...
var qn = Zt, Jn = Qt, Yn = Jt, Xn = (e, t, n) => {
...
function $n(e) {
	return Qn.some((t) => t === e);
}
var er = class e extends A {
	constructor(...t) {
		super(...t), this.text = "", this.placement = "top", this._open = !1, this._pointerActive = !1, this._descId = `mi-tooltip-desc-${e._idCounter++}`, this._onSlotChange = () => {
			...
			clearTimeout(this._hideTimer), !(this._open || !this.text) && (this._open = !0, await this.updateComplete, !(!this._open || !this._tooltipEl || this._cleanup) && (this._cleanup = Kn(this, this._tooltipEl, () => this._updatePosition())));
		}, this._scheduleHide = () => {
	...
	async _updatePosition() {
		...
		let e = $n(this.placement);
		e || console.warn(`"${this.placement}" は無効な placement 属性です。"top" を使用します。`);
		let t = e ? this.placement : "top", { x: n, y: r } = await Xn(this, this._tooltipEl, {
			placement: t,
			strategy: "fixed",
			middleware: [
				qn(8),
	...
	render() {
      ...
      ${this._open ? D`<div class="tooltip" role="tooltip">${this.text}</div>` : k}
    `;
	}
};
P([j({ type: String })], er.prototype, "text", void 0), P([j({
	type: String,
	reflect: !0
})], er.prototype, "placement", void 0), P([Le()], er.prototype, "_open", void 0), P([ze(".tooltip")], er.prototype, "_tooltipEl", void 0), customElements.get("mi-tooltip") || customElements.define("mi-tooltip", er);
//#endregion
...
`, nr = [
	...
	render() {
		let e = this.renderContent(), t = this.isLink ? D`
          <a
            class="${this.buttonClasses}"
            href="${this.isDisabled ? k : this.href}"
            target="${this.target || k}"
            ...
            title="${this.tooltipDisabled && this.label ? this.label : k}"
            aria-disabled="${this.isDisabled ? "true" : k}"
            aria-busy="${this.loading ? "true" : k}"
            @click="${this.handleLinkClick}"
          >
        ...
        `;
		return !this.label || this.tooltipDisabled ? t : D`
...
P([j({ type: String })], ir.prototype, "variant", void 0), P([j({ type: String })], ir.prototype, "size", void 0), P([j({
	type: String,
	attribute: "aria-label",
	reflect: !0
})], ir.prototype, "label", void 0), P([j({
	type: String,
	attribute: "tooltip-placement"
})], ir.prototype, "tooltipPlacement", void 0), P([j({
	type: Boolean,
	attribute: "tooltip-disabled"
})], ir.prototype, "tooltipDisabled", void 0), customElements.get("mi-icon-button") || customElements.define("mi-icon-button", ir);
//#endregion
...
P([j({
	type: String,
	reflect: !0
})], J.prototype, "value", void 0), P([j({
	type: String,
	reflect: !0
})], J.prototype, "name", void 0), P([j({
	type: Boolean,
	reflect: !0
})], J.prototype, "checked", void 0), P([j({
	type: Boolean,
	reflect: !0
})], J.prototype, "indeterminate", void 0), P([j({
	type: Boolean,
	reflect: !0
})], J.prototype, "disabled", void 0);
var ur = class extends J {};
customElements.get("mi-checkbox") || customElements.define("mi-checkbox", J), customElements.get("sp-checkbox") || customElements.define("sp-checkbox", ur);
//#endregion
//#region src/components/checkbox/checkbox-text.css?inline
var dr = ":host{max-width:100%;display:inline-block}.base{cursor:pointer;justify-content:flex-start;align-items:flex-start;max-width:100%;display:inline-flex}.checkmark:has(.input:focus-visible):before{box-shadow:0 0 0 2px #fff,0 0 0 4px #191919}.base:has(.input:disabled){cursor:not-allowed}.text{color:#000000d6;letter-spacing:.02em;padding-block:3px;padding-inline:4px;font-size:14px;line-height:1.3}.base:has(.input:disabled) .text{color:#00000059}.base:hover .checkmark:has(:not(.input:disabled)):before{border-color:#0000008a;outline:4px solid #0000000a}.base:active .checkmark:has(:not(.input:disabled)):before{outline:4px solid #00000012}.base:hover:active .checkmark:has(:not(.input:disabled)):before{outline:4px solid #00000012}.base:hover .checkmark:has(:is(.input:checked,.input:indeterminate)):has(:not(.input:disabled)):before{background-color:#2666bf;border-color:#2666bf}", Y = class extends A {
	static {
		this.styles = M(a(lr), a(dr));
	}
	static {
		this.formAssociated = !0;
	}
...
P([j({
	type: String,
	reflect: !0
})], Y.prototype, "value", void 0), P([j({
	type: String,
	reflect: !0
})], Y.prototype, "name", void 0), P([j({
	type: Boolean,
	reflect: !0
})], Y.prototype, "checked", void 0), P([j({
	type: Boolean,
	reflect: !0
})], Y.prototype, "indeterminate", void 0), P([j({
	type: Boolean,
	reflect: !0
})], Y.prototype, "disabled", void 0), P([j({
	type: String,
	reflect: !0
})], Y.prototype, "text", void 0);
var fr = class extends Y {};
customElements.get("mi-checkbox-text") || customElements.define("mi-checkbox-text", Y), customElements.get("sp-checkbox-text") || customElements.define("sp-checkbox-text", fr);
//#endregion
//#region src/components/dialog/dialog.styles.ts
var pr = [a(".dialog-root::backdrop{background:var(--neutral-neutral-50-alpha,#0000004a)}"), o`
    /* ========== Dialog ルート ========== */
    .dialog-root {
      border: none;
      padding: 0;
  ...
  `], X = class extends A {
	...
	render() {
      ...
      <dialog
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby=${this.headerText ? "dialog-title" : k}
...
P([j({
	type: Boolean,
	reflect: !0
})], X.prototype, "open", void 0), P([j({
	type: String,
	attribute: "header-text"
})], X.prototype, "headerText", void 0), P([j({
	type: String,
	attribute: "cancel-label"
})], X.prototype, "cancelLabel", void 0), P([j({
	type: String,
	attribute: "action-label"
})], X.prototype, "actionLabel", void 0), P([j({
	type: Boolean,
	reflect: !0
})], X.prototype, "danger", void 0), P([j({
	type: String,
	attribute: "form-id"
})], X.prototype, "formId", void 0), P([ze(".body")], X.prototype, "_bodyEl", void 0), P([Le()], X.prototype, "_isScrolledFromTop", void 0), P([Le()], X.prototype, "_isScrolledFromBottom", void 0);
//#endregion
//#region src/components/dialog/mi-action-dialog.ts
var mr = class extends X {
	get dialogSize() {
		return "small";
	}
	get variant() {
...
customElements.get("mi-action-dialog") || customElements.define("mi-action-dialog", mr);
//#endregion
...
P([j({
	type: String,
	reflect: !0
})], _r.prototype, "size", void 0), customElements.get("mi-form-dialog") || customElements.define("mi-form-dialog", _r);
//#endregion
...
P([j({
	type: String,
	reflect: !0
})], br.prototype, "size", void 0), customElements.get("mi-information-dialog") || customElements.define("mi-information-dialog", br);
//#endregion
...
`, Sr = class extends A {
	...
	render() {
		return D`<button class="base">
      ${this.loading ? D`<mi-loading class="loading" ai size="3xLarge"></mi-loading>` : D`<mi-icon class="icon" type="magic-fill"></mi-icon>`}
    </button>`;
	}
};
P([j({ type: Boolean })], Sr.prototype, "loading", void 0);
var Cr = class extends Sr {};
customElements.get("mi-floating-button") || customElements.define("mi-floating-button", Sr), customElements.get("sp-floating-button") || customElements.define("sp-floating-button", Cr);
//#endregion
//#region src/components/icon-color/icon-color.css?inline
var wr = ":host{width:1.28em;height:1.28em;display:inline-block}.icon-color{width:100%;height:100%}", Tr = [
	"error",
	"information",
	"success",
	"warning"
...
P([j({
	type: String,
	reflect: !0
})], Or.prototype, "type", void 0), customElements.get("mi-icon-color") || customElements.define("mi-icon-color", Or);
//#endregion
...
`, Ar = [
	...
	render() {
		let e = Ar.includes(this.type) ? this.type : "information";
		return D`
...
P([j({
	type: String,
	reflect: !0
})], jr.prototype, "type", void 0), customElements.get("mi-inline-notification") || customElements.define("mi-inline-notification", jr);
//#endregion
//#region node_modules/lit-html/directives/class-map.js
var Mr = Ve(class extends He {
	constructor(e) {
...
}), Nr = ":host{flex-direction:column;gap:4px;display:flex}:host .label{font-weight:var(--font-weight-bold);color:#000000d6;font-size:14px}:host .label.none{display:none}:host .support{font-weight:var(--font-weight-normal);color:#0000008a;font-size:12px}:host .support.none{display:none}", Pr = class extends A {
	constructor(...e) {
...
var Ir = "Speeda", Lr = "Uzabase", Rr = "<svg viewBox=\"0 0 74 26\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<g clip-path=\"url(#clip0_10_438)\">\n<path d=\"M0.812012 1.2381V24.7619C0.812012 25.4457 1.36633 26 2.05011 26H57.9432C58.6067 26 59.2198 25.646 59.5516 25.0714L73.1687 1.48571C73.5499 0.825395 73.0734 0 72.3109 0H2.05011C1.36633 0 0.812012 0.554314 0.812012 1.2381Z\" fill=\"#F72A48\"/>\n<path d=\"M10.5969 17.5256C10.0161 17.8902 9.39656 18.2299 8.73824 18.5363C8.73805 18.5364 8.73787 18.5365 8.73767 18.5365C8.73767 18.5366 8.73768 18.5365 8.73767 18.5365L7.3739 16.5267C10.5202 15.1267 12.7216 13.069 13.7984 10.8079H8.36688V8.63046L16.9291 8.63047C16.6076 10.614 15.8557 12.3764 14.6848 13.9237C15.874 14.7334 17.1438 15.6717 18.2251 16.6103L16.6578 18.68C15.5557 17.6134 14.371 16.6055 13.1394 15.6214C12.395 16.3092 11.547 16.9436 10.5969 17.5256ZM31.8955 12.1251V14.533H39.9379L41.3298 12.1251H31.8955ZM53.7827 6.56189L53.3408 8.28962H54.8604L55.3012 6.56189H53.7827ZM51.3513 6.56189L50.9106 8.28962H52.4302L52.871 6.56189H51.3513ZM45.9291 18.9428L44.4946 16.9455C45.9176 16.5384 47.1377 15.9168 48.1075 15.1511C47.3533 14.4926 46.5161 13.8469 45.7377 13.2968C45.3318 13.667 44.9005 14.0141 44.4104 14.337L42.8305 12.7583C44.8763 11.2625 45.9776 9.51546 46.6234 7.63808L48.9448 8.21119C48.849 8.48682 48.7406 8.77393 48.6219 9.06111H53.4553C53.1748 13.532 50.8371 17.2615 45.9291 18.9428ZM50.6549 11.1668H47.5205C47.4018 
078C61.103 10.6742 62.1369 11.513 62.1369 13.1887V13.7194H62.1386ZM79.9078 1.50973C79.6562 0.475856 79.266 0.167748 78.2321 0.167748H76.1934C75.1596 0.167748 74.7693 0.475856 74.5177 1.50973L70.8854 17.6032C70.6612 18.4968 70.9693 18.8323 71.8919 18.8323H72.366C73.3434 18.8323 73.6789 18.5806 73.9032 17.6032L74.5177 14.7532H79.9096L80.5532 17.6032C80.7483 18.5806 81.0838 18.8323 82.0612 18.8323H82.5644C83.487 18.8323 83.766 18.4968 83.5418 17.6032L79.9096 1.50973H79.9078ZM75.1014 12.0984L75.632 9.64036C76.2739 6.65 76.7771 3.85649 77.1691 1.31459C77.4207 2.90649 77.9514 5.67261 78.7901 9.66946L79.3207 12.1001H75.1014V12.0984ZM95.2191 7.99027C93.5707 7.23541 92.2578 6.25802 92.2578 4.91604C92.2578 3.49189 93.2078 2.65315 94.7997 2.65315C96.4755 2.65315 97.5094 3.60315 97.5933 5.08378C97.6771 5.86604 98.0126 6.09027 98.9061 6.09027H99.3255C100.192 6.09027 100.5 5.78216 100.5 5.02901C100.5 3.54838 99.9691 2.34676 98.9352 1.42414C97.9014 0.474144 96.532 0 94.8271 0C93.2352 0 91.8932 0.474144 90.8594 1.39676C89.8255 2.31937 89.2949 3.51928 89.2949 5.00162C89.2384 8.43874 92.3691 9.83549 94.7433 10.8129C96.419 11.5113 97.7336 12.5177 97.7336 13.8854C97.7336 15.4225 96.6433 16.316 94.9401 16.316C93.0401 16.316 91.9224 15.1983 91.8385 13.7177C91.7546 12.9354 91.4465 12.6838 90.553 12.6838H90.1062C89.2966 12.6838 88.9046 13.0193 88.9046 13.6903C88.9046 15.2548 89.4626 16.5403 90.6095 17.5177C91.7546 18.495 93.1805 18.9709 94.9401 18.9709C96.6997 18.9709 98.0691 18.4968 99.103 17.5468C100.137 16.5968 100.667 15.3386 100.667 13.8032C100.695 10.45 97.6224 8.99847 95.2191 7.99198V7.99027ZM115.811 2.85C116.734 2.85 117.04 2.54189 117.04 1.62099V1.39676C117.04 0.474144 116.732 0.167748 115.811 0.167748H108.909C107.876 0.167748 107.54 0.503243 107.54 1.53712V17.4629C107.54 18.4968 107.876 18.8323 108.909 18.8323H115.811C116.734 18.8323 117.04 18.5241 117.04 17.6032V17.379C117.04 16.4564 116.732 16.15 115.811 16.15H110.419V10.842H115.226C116.148 10.842 116.427 10.563 116.427 9.58387V9.35964C116.427 8.43703 116.148 8.13063 115.226 8.13063H110.419V2.85H115.811Z\" fill=\"black\"/>\n</g>\n<defs>\n<clipPath id=\"clip0_2813_53\">\n<rect width=\"117.081\" height=\"19\" fill=\"white\"/>\n</clipPath>\n</defs>\n</svg>\n", Hr = class extends A {
	...
	#e() {
		if (this.brand === "uzabase") return Vr;
		if (this.brand === "speeda") return this.language === "en" ? zr : this.language === "zh" ? Br : Rr;
	}
	render() {
		let e = this.#e();
		return e ? D`${We(e)}` : k;
...
P([j({
	type: String,
	reflect: !0
})], Hr.prototype, "language", void 0), P([j({
	type: String,
	reflect: !0
})], Hr.prototype, "brand", void 0), P([j({ type: String })], Hr.prototype, "label", void 0);
var Ur = class extends Hr {};
customElements.get("mi-logo") || customElements.define("mi-logo", Hr), customElements.get("sp-logo") || customElements.define("sp-logo", Ur);
//#endregion
...
}, Gr = (e) => Wr[`inverse:${e.inverse ?? "null"}|logoLanguage:${e.logoLanguage ?? "null"}|symbol:${e.symbol ?? "null"}|subBrand:${e.subBrand ?? "null"}`] ?? void 0, Z = class extends A {
	constructor(...e) {
		super(...e), this.subBrand = null, this.inverse = !1, this.noSymbol = !1, this.logoLanguage = "en", this.label = Ir;
	}
	static {
		this.styles = M(o`
    :host {
...
P([j({
	...
	reflect: !0,
	attribute: "sub-brand"
})], Z.prototype, "subBrand", void 0), P([j({
	type: Boolean,
	reflect: !0
})], Z.prototype, "inverse", void 0), P([j({
	type: Boolean,
	reflect: !0,
	attribute: "no-symbol"
})], Z.prototype, "noSymbol", void 0), P([j({
	type: String,
	reflect: !0,
	attribute: "logo-language"
})], Z.prototype, "logoLanguage", void 0), P([j({ type: String })], Z.prototype, "label", void 0), customElements.get("mi-speeda-logo") || customElements.define("mi-speeda-logo", Z);
//#endregion
...
var Kr = {
...
}, qr = (e) => Kr[`inverse:${e.inverse ?? "null"}`] ?? void 0, Jr = class extends A {
	constructor(...e) {
		super(...e), this.inverse = !1, this.label = Lr;
	}
	static {
		this.styles = M(o`
    :host {
  ...
  `);
	...
	#e() {
		return qr({ inverse: this.inverse });
	}
	render() {
		let e = this.#e();
		return e ? D`${We(e)}` : k;
...
P([j({
	type: Boolean,
	reflect: !0
})], Jr.prototype, "inverse", void 0), P([j({ type: String })], Jr.prototype, "label", void 0), customElements.get("mi-uzabase-logo") || customElements.define("mi-uzabase-logo", Jr);
//#endregion
//#region src/components/menu/control-menu/styles.css?inline
var Yr = ":host{background-color:#fff;border-radius:6px;padding:8px 0;display:block;box-shadow:0 5px 9px 2px #00000021}", Xr = class extends A {
	static {
		this.styles = M(a(Yr));
	}
	render() {
...
customElements.get("mi-control-menu") || customElements.define("mi-control-menu", Xr), customElements.get("sp-control-menu") || customElements.define("sp-control-menu", Zr);
//#endregion
//#region src/components/menu/control-menu-item/styles.css?inline
var Qr = ":host{box-sizing:border-box;cursor:pointer;color:#000000d6;justify-content:space-between;align-items:center;column-gap:8px;min-height:32px;padding:4px 12px 4px 16px;font-size:14px;display:flex}:host .icon{width:24px;height:24px;display:none}:host([selected]){background-color:#f0f6ff}:host([selected]) .icon{display:block}:host([selected]:hover){background-color:#e3efff}:host([selected]:active){background-color:#d4e6ff}:host([disabled]){cursor:not-allowed;color:#00000059;background-color:#0000}:host([disabled]:hover),:host([disabled]:active){background-color:#0000}:host([disabled]:focus){border:none;padding:4px 12px 4px 16px}:host(:hover){background-color:#f8f8f8}:host(:active){background-color:#0000000d}:host(:focus){box-sizing:border-box;border:2px solid #191919;outline:none;padding:2px 10px 2px 14px}", $r = class extends A {
	constructor(...e) {
...
P([j({
	type: String,
	reflect: !0
})], $r.prototype, "text", void 0), P([j({
	type: Boolean,
	reflect: !0
})], $r.prototype, "selected", void 0), P([j({
	type: Boolean,
	reflect: !0
})], $r.prototype, "disabled", void 0);
var ei = class extends $r {};
customElements.get("mi-control-menu-item") || customElements.define("mi-control-menu-item", $r), customElements.get("sp-control-menu-item") || customElements.define("sp-control-menu-item", ei);
//#endregion
...
`, ni = o`
  ...
  .icon-wrapper {
    ...
    justify-content: center;
    flex-shrink: 0;
    min-inline-size: var(--icon-size-medium, 20px);
    min-block-size: var(--icon-size-medium, 20px);
    color: var(--_menu-item-icon-color);
  }

  @media (max-width: 720px) {
    .icon-wrapper {
      min-inline-size: var(--icon-size-large, 22px);
      min-block-size: var(--icon-size-large, 22px);
    }
  }
...
`, ri = class extends A {
	constructor(...e) {
		super(...e), this.variant = "neutral", this.disabled = !1, this.supportText = "", this._handleClick = (e) => {
			if (this.disabled) {
	...
	render() {
      ...
      <span class="item-layout">
        ${this.querySelector("[slot='icon']") === null ? k : D`<span class="icon-wrapper" aria-hidden="true">
              <slot name="icon"></slot>
            </span>`}
        <span class="text-area">
          <span class="label"><slot></slot></span>
          ${this.supportText ? D`<span class="support-text">${this.supportText}</span>` : k}
        </span>
      </span>
    `;
	}
...
P([j({
	type: String,
	reflect: !0
})], ri.prototype, "variant", void 0), P([j({
	type: Boolean,
	reflect: !0
})], ri.prototype, "disabled", void 0), P([j({
	type: String,
	attribute: "support-text"
})], ri.prototype, "supportText", void 0), customElements.get("mi-action-menu-item") || customElements.define("mi-action-menu-item", ri);
//#endregion
//#region src/components/menu/mi-link-menu-item.ts
var ii = class extends A {
	constructor(...e) {
		super(...e), this.href = "", this.newWindow = !1, this.supportText = "", this._handleClick = () => {
			this.dispatchEvent(new Event("menu-item-activate", {
				bubbles: !0,
				composed: !0
			}));
	...
	render() {
		let e = this.querySelector("[slot='icon']") !== null;
		return D`
      <a
        href=${this.href}
        target=${this.newWindow ? "_blank" : k}
        rel=${this.newWindow ? "noopener noreferrer" : k}
      >
        <span class="item-layout">
          ${e ? D`<span class="icon-wrapper" aria-hidden="true">
                <slot name="icon"></slot>
              </span>` : k}
          <span class="text-area">
            <span class="label"><slot></slot></span>
        ...
        ${this.newWindow ? D`<span class="new-window-icon" aria-hidden="true">
              ${ai}
            </span>` : k}
      </a>
    `;
...
P([j({ type: String })], ii.prototype, "href", void 0), P([j({
	type: Boolean,
	attribute: "new-window",
	reflect: !0
})], ii.prototype, "newWindow", void 0), P([j({
	type: String,
	attribute: "support-text"
})], ii.prototype, "supportText", void 0);
var ai = D`<svg
  width="20"
  height="20"
  viewBox="0 0 16 16"
...
>
  <path
    d="M13.0417 8.31667H14.2917V14.475C14.2917 14.8167 14.0083 15.1 13.6667 15.1H0.625C0.283333 15.1 0 14.8167 0 14.475V1.43333C0 1.09167 0.283333 0.808333 0.625 0.808333H6.79167V2.05833H1.25V13.85H13.0417V8.31667ZM9.28333 0V1.25H12.9667L7.175 7.04167L8.05833 7.925L13.8583 2.125V5.81667H15.1083V0H9.29167H9.28333Z"
    fill="currentColor"
  />
</svg>`;
customElements.get("mi-link-menu-item") || customElements.define("mi-link-menu-item", ii);
//#endregion
...
var oi = class extends A {
  ...
  `);
	...
	async _positionDropdown() {
		...
		if (!n) return;
		let r = t.side, i = t.align, a = t.sideOffset, o = si(r, i);
		this._cleanup?.(), this._cleanup = Kn(e, n, async () => {
			if (!this.open) return;
			let { x: t, y: r } = await Xn(e, n, {
				placement: o,
				strategy: "fixed",
				middleware: [
					qn(a),
...
customElements.get("mi-menu") || customElements.define("mi-menu", oi);
//#endregion
//#region src/components/menu/mi-menu-dropdown.ts
var ci = class extends A {
	constructor(...e) {
		super(...e), this.open = !1, this.side = "bottom", this.align = "start", this.sideOffset = 4, this.width = 200;
	}
	static {
		this.styles = M(o`
    :host {
...
P([j({
	type: Boolean,
	reflect: !0
})], ci.prototype, "open", void 0), P([j({ type: String })], ci.prototype, "side", void 0), P([j({ type: String })], ci.prototype, "align", void 0), P([j({
	type: Number,
	attribute: "side-offset"
})], ci.prototype, "sideOffset", void 0), P([j({ type: Number })], ci.prototype, "width", void 0), customElements.get("mi-menu-dropdown") || customElements.define("mi-menu-dropdown", ci);
//#endregion
...
var li = class extends A {
  ...
  `);
	...
	render() {
		return D`
      ${this.label ? D`<div class="group-label">${this.label}</div>` : k}
      <slot></slot>
    `;
	}
};
P([j({ type: String })], li.prototype, "label", void 0), customElements.get("mi-menu-group") || customElements.define("mi-menu-group", li);
//#endregion
...
P([j({
	type: String,
	reflect: !0
})], ui.prototype, "value", void 0), customElements.get("mi-menu-radio-group") || customElements.define("mi-menu-radio-group", ui);
//#endregion
...
var di = class extends A {
	...
	render() {
      ...
      ${this.selected ? D`<span class="check-icon" aria-hidden="true">
            <span class="check-icon-svg">${fi}</span>
          </span>` : k}
    `;
	}
};
P([j({
	type: String,
	reflect: !0
})], di.prototype, "value", void 0), P([j({
	type: Boolean,
	reflect: !0
})], di.prototype, "disabled", void 0), P([j({
	type: String,
	attribute: "support-text"
})], di.prototype, "supportText", void 0);
var fi = D`<svg
  xmlns="http://www.w3.org/2000/svg"
  width="100%"
  height="100%"
...
customElements.get("mi-select-menu-item") || customElements.define("mi-select-menu-item", di);
//#endregion
//#region src/components/menu/mi-sub-menu-item.ts
var pi = class extends A {
	constructor(...e) {
		super(...e), this.disabled = !1, this._subOpen = !1, this._handleMouseEnter = () => {
	...
	async _positionSubmenu(e) {
		...
		t && (this._cleanup?.(), this._cleanup = Kn(this, t, async () => {
			if (!this._subOpen) return;
			let { x: e, y: n } = await Xn(this, t, {
	...
	render() {
      ...
      <span class="chevron-icon" aria-hidden="true">
        <span class="chevron-icon-svg">${mi}</span>
      </span>
      ${this._subOpen ? D`<slot name="submenu"></slot>` : k}
    `;
	}
};
P([j({
	type: Boolean,
	reflect: !0
})], pi.prototype, "disabled", void 0), P([Le()], pi.prototype, "_subOpen", void 0);
var mi = D`<svg
  xmlns="http://www.w3.org/2000/svg"
  width="100%"
  height="100%"
...
customElements.get("mi-sub-menu-item") || customElements.define("mi-sub-menu-item", pi);
//#endregion
...
P([j({
	type: String,
	reflect: !0
})], gi.prototype, "value", void 0), P([j({
	type: String,
	reflect: !0
})], gi.prototype, "name", void 0), P([j({
	type: Boolean,
	reflect: !0
})], gi.prototype, "checked", void 0), P([j({
	type: Boolean,
	reflect: !0
})], gi.prototype, "disabled", void 0);
var _i = class extends gi {};
customElements.get("mi-radio-button-text") || customElements.define("mi-radio-button-text", gi), customElements.get("sp-radio-button-text") || customElements.define("sp-radio-button-text", _i);
//#endregion
...
`, yi = ["small", "medium"];
function bi(e) {
	return typeof e == "string" && yi.includes(e) ? e : "small";
}
var xi = class extends A {
	constructor(...e) {
	...
	render() {
		let e = bi(this.size), t = e === "small" ? "cross-small" : "cross", n = e === "small" ? "small" : "medium";
		return D`
      <div
        class="root ${e}"
...
P([j({
	type: String,
	reflect: !0
})], xi.prototype, "size", void 0), P([j({
	type: Number,
	attribute: "auto-hide-timeout"
})], xi.prototype, "autoHideTimeout", void 0), P([Le()], xi.prototype, "entering", void 0), P([Le()], xi.prototype, "exiting", void 0), customElements.get("mi-snackbar") || customElements.define("mi-snackbar", xi);
//#endregion
...
customElements.get("mi-snackbar-viewport") || customElements.define("mi-snackbar-viewport", Ci);
//#endregion
//#region src/components/text-field/text-field/error-text/styles.css?inline
var wi = ":host .container{color:#c92812;align-items:center;gap:2px;padding-top:8px;display:flex}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}", Ti = class extends A {
	constructor(...e) {
		super(...e), this.text = "";
	}
	static {
...
P([j({
	type: String,
	reflect: !0
})], Q.prototype, "error", void 0), P([j({
	type: String,
	reflect: !0
})], Q.prototype, "placeholder", void 0), P([j({
	type: String,
	reflect: !0
})], Q.prototype, "autocomplete", void 0), P([j({
	type: Boolean,
	reflect: !0
})], Q.prototype, "disabled", void 0), P([j({
	type: String,
	reflect: !0
})], Q.prototype, "name", void 0), P([j({
	type: String,
	reflect: !0
})], Q.prototype, "value", void 0), P([j({
	type: String,
	reflect: !0
})], Q.prototype, "type", void 0), P([j({
	type: Boolean,
	reflect: !0
})], Q.prototype, "autofocus", void 0), P([j({
	type: Boolean,
	attribute: "submit-on-enter",
	reflect: !0
})], Q.prototype, "submitOnEnter", void 0);
var Oi = class extends Q {};
customElements.get("mi-text-field") || customElements.define("mi-text-field", Q), customElements.get("sp-text-field") || customElements.define("sp-text-field", Oi);
//#endregion
//#region src/components/text-field/text-field-unit/styles.css?inline
var ki = ":host .label{text-align:left;margin-bottom:8px}:host .label.none{display:none}", $ = class extends A {
	static {
		this.styles = M(a(ki));
	}
	static {
...
P([j({
	type: String,
	reflect: !0
})], $.prototype, "text", void 0), P([j({
	type: String,
	reflect: !0
})], $.prototype, "error", void 0), P([j({
	type: String,
	reflect: !0
})], $.prototype, "placeholder", void 0), P([j({
	type: String,
	attribute: "support-text",
	reflect: !0
})], $.prototype, "supportText", void 0), P([j({
	type: Boolean,
	reflect: !0
})], $.prototype, "disabled", void 0), P([j({
	type: String,
	reflect: !0
})], $.prototype, "name", void 0), P([j({
	type: String,
	reflect: !0
})], $.prototype, "value", void 0), P([j({
	type: String,
	reflect: !0
})], $.prototype, "type", void 0), P([j({
	type: String,
	reflect: !0
})], $.prototype, "autocomplete", void 0), P([j({
	type: Boolean,
	reflect: !0
})], $.prototype, "autofocus", void 0), P([j({
	type: Boolean,
	attribute: "submit-on-enter",
	reflect: !0
})], $.prototype, "submitOnEnter", void 0);
var Ai = class extends $ {};
customElements.get("mi-text-field-unit") || customElements.define("mi-text-field-unit", $), customElements.get("sp-text-field-unit") || customElements.define("sp-text-field-unit", Ai);
//#endregion
export { mr as MiActionDialog, ri as MiActionMenuItem, vt as MiAiButton, F as MiAvatar, or as MiButton, J as MiCheckbox, Y as MiCheckboxText, Xr as MiControlMenu, $r as MiControlMenuItem, yt as MiDangerButton, Sr as MiFloatingButton, _r as MiFormDialog, tt as MiIcon, ir as MiIconButton, Or as MiIconColor, br as MiInformationDialog, jr as MiInlineNotification, Pr as MiLabelUnit, ii as MiLinkMenuItem, ut as MiLoading, Hr as MiLogo, oi as MiMenu, ci as MiMenuDropdown, li as MiMenuGroup, ui as MiMenuRadioGroup, ar as MiNeutralButton, gi as MiRadioButtonText, di as MiSelectMenuItem, xi as MiSnackbar, Ci as MiSnackbarViewport, Z as MiSpeedaLogo, pi as MiSubMenuItem, Q as MiTextField, Ti as MiTextFieldErrorText, $ as MiTextFieldUnit, er as MiTooltip, Jr as MiUzabaseLogo, ct as SpAvatar, sr as SpButton, ur as SpCheckbox, fr as SpCheckboxText, Zr as SpControlMenu, ei as SpControlMenuItem, Cr as SpFloatingButton, nt as SpIcon, Fr as SpLabelUnit, dt as SpLoading, Ur as SpLogo, _i as SpRadioButtonText, Oi as SpTextField, Ei as SpTextFieldErrorText, Ai as SpTextFieldUnit, hr as formDialogSizes, rr as iconButtonSizes, nr as iconButtonVariants, vr as informationDialogSizes, yi as snackbarSizes };
