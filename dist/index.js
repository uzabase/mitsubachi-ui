 ...
 */
const u1 = globalThis, P1 = u1.ShadowRoot && (u1.ShadyCSS === void 0 || u1.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, T1 = Symbol(), Q1 = /* @__PURE__ */ new WeakMap();
let p2 = class {
  constructor(e, t, r) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: j2, defineProperty: I2, getOwnPropertyDescriptor: O2, getOwnPropertyNames: N2, getOwnPropertySymbols: U2, getPrototypeOf: D2 } = Object, k1 = globalThis, t2 = k1.trustedTypes, B2 = t2 ? t2.emptyScript : "", R2 = k1.reactiveElementPolyfillSupport, e1 = (s, e) => s, f1 = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? B2 : null;
      break;
  ...
  return t;
} }, j1 = (s, e) => !j2(s, e), i2 = { attribute: !0, type: String, converter: f1, reflect: !1, useDefault: !1, hasChanged: j1 };
Symbol.metadata ??= Symbol("metadata"), k1.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let D = class extends HTMLElement {
  ...
  static createProperty(e, t = i2) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      ...
      i !== void 0 && I2(this.prototype, e, i);
    }
  }
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(e1("properties"))) {
      const t = this.properties, r = [...N2(t), ...U2(t)];
  ...
  requestUpdate(e, t, r) {
    if (e !== void 0) {
      ...
      if (r ??= i.getPropertyOptions(e), !((r.hasChanged ?? j1)(o, t) || r.useDefault && r.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(i._$Eu(e, r)))) return;
      this.C(e, t, r);
    }
...
D.elementStyles = [], D.shadowRootOptions = { mode: "open" }, D[e1("elementProperties")] = /* @__PURE__ */ new Map(), D[e1("finalized")] = /* @__PURE__ */ new Map(), R2?.({ ReactiveElement: D }), (k1.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const I1 = globalThis, g1 = I1.trustedTypes, s2 = g1 ? g1.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, u2 = "$lit$", S = `lit$${Math.random().toFixed(9).slice(2)}$`, f2 = "?" + S, F2 = `<${f2}>`, O = document, i1 = () => O.createComment(""), s1 = (s) => s === null || typeof s != "object" && typeof s != "function", O1 = Array.isArray, q2 = (s) => O1(s) || typeof s?.[Symbol.iterator] == "function", E1 = `[ 	
\f\r]`, Q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, r2 = /-->/g, o2 = />/g, j = RegExp(`>|${E1}(?:([^\\s"'>=/]+)(${E1}*=${E1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), n2 = /'/g, a2 = /"/g, g2 = /^(?:script|style|textarea|title)$/i, W2 = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), C = W2(1), P = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), l2 = /* @__PURE__ */ new WeakMap(), I = O.createTreeWalker(O, 129);
function m2(s, e) {
  if (!O1(s) || !s.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const G2 = (s, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = s[c];
    let u, f, d = -1, Z = 0;
    for (; Z < l.length && (n.lastIndex = Z, f = n.exec(l), f !== null); ) Z = n.lastIndex, n === Q ? f[1] === "!--" ? n = r2 : f[1] !== void 0 ? n = o2 : f[2] !== void 0 ? (g2.test(f[2]) && (i = RegExp("</" + f[2], "g")), n = j) : f[3] !== void 0 && (n = j) : n === j ? f[0] === ">" ? (n = i ?? Q, d = -1) : f[1] === void 0 ? d = -2 : (d = n.lastIndex - f[2].length, u = f[1], n = f[3] === void 0 ? j : f[3] === '"' ? a2 : n2) : n === a2 || n === n2 ? n = j : n === r2 || n === o2 ? n = Q : (n = j, i = void 0);
    const A = n === j && s[c + 1].startsWith("/>") ? " " : "";
    o += n === Q ? l + F2 : d >= 0 ? (r.push(u), l.slice(0, d) + u2 + l.slice(d) + S + A) : l + S + (d === -2 ? c : A);
  }
  return [m2(s, o + (s[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), r];
};
class r1 {
  constructor({ strings: e, _$litType$: t }, r) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const c = e.length - 1, l = this.parts, [u, f] = G2(e, t);
    ...
    for (; (i = I.nextNode()) !== null && l.length < c; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(u2)) {
          const Z = f[n++], A = i.getAttribute(d).split(S), h1 = /([.?@])?(.*)/.exec(Z);
          l.push({ type: 1, index: o, name: h1[2], strings: A, ctor: h1[1] === "." ? Y2 : h1[1] === "?" ? X2 : h1[1] === "@" ? K2 : w1 }), i.removeAttribute(d);
        } else d.startsWith(S) && (l.push({ type: 6, index: o }), i.removeAttribute(d));
        if (g2.test(i.tagName)) {
      ...
      } else if (i.nodeType === 8) if (i.data === f2) l.push({ type: 2, index: o });
      else {
        let d = -1;
...
class J2 {
  ...
  u(e) {
    const { el: { content: t }, parts: r } = this._$AD, i = (e?.creationScope ?? O).importNode(t, !0);
    I.currentNode = i;
    let o = I.nextNode(), n = 0, c = 0, l = r[0];
    for (; l !== void 0; ) {
      if (n === l.index) {
        let u;
        l.type === 2 ? u = new d1(o, o.nextSibling, this, e) : l.type === 1 ? u = new l.ctor(o, l.name, l.strings, this, e) : l.type === 6 && (u = new Q2(o, this, e)), this._$AV.push(u), l = r[++c];
      }
...
class d1 {
  ...
  _$AI(e, t = this) {
    e = R(this, e, t), s1(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== P && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : q2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && s1(this._$AH) ? this._$AA.nextSibling.data = e : this.T(O.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: r } = e, i = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = r1.createElement(m2(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === i) this._$AH.p(t);
    else {
      const o = new J2(i, this), n = o.u(this.options);
      o.p(t), this.T(n), this._$AH = o;
    }
  }
  _$AC(e) {
    let t = l2.get(e.strings);
    return t === void 0 && l2.set(e.strings, t = new r1(e)), t;
  }
  k(e) {
...
const e9 = I1.litHtmlPolyfillSupport;
e9?.(r1, d1), (I1.litHtmlVersions ??= []).push("3.3.1");
const t9 = (s, e, t) => {
...
let p = class extends D {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = t9(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
p._$litElement$ = !0, p.finalized = !0, N1.litElementHydrateSupport?.({ LitElement: p });
const i9 = N1.litElementPolyfillSupport;
i9?.({ LitElement: p });
(N1.litElementVersions ??= []).push("4.2.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const s9 = { attribute: !0, type: String, converter: f1, reflect: !1, hasChanged: j1 }, r9 = (s = s9, e, t) => {
  ...
  if (o === void 0 && globalThis.litPropertyMetadata.set(i, o = /* @__PURE__ */ new Map()), r === "setter" && ((s = Object.create(s)).wrapped = !0), o.set(t.name, s), r === "accessor") {
    ...
    return { set(c) {
      ...
      e.set.call(this, c), this.requestUpdate(n, l, s);
    }, init(c) {
  ...
  if (r === "setter") {
    ...
    return function(c) {
      const l = this[n];
      e.call(this, c), this.requestUpdate(n, l, s);
    };
  }
  throw Error("Unsupported decorator location: " + r);
};
function a(s) {
  return (e, t) => typeof t == "object" ? r9(s, e, t) : ((r, i, o) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const b2 = { ATTRIBUTE: 1, CHILD: 2 }, U1 = (s) => (...e) => ({ _$litDirective$: s, values: e });
class H2 {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
let m1 = class extends H2 {
  constructor(e) {
    if (super(e), this.it = h, e.type !== b2.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(e) {
...
const c9 = ":host{display:inline-block;width:1.28em;height:1.28em}.icon{width:100%;height:100%}", d9 = [
  "app",
  "arrow-down",
  "arrow-down-small",
  "arrow-left",
...
var C9 = Object.defineProperty, h9 = (s, e, t, r) => {
...
customElements.get("sp-icon") || customElements.define("sp-icon", g9);
const m9 = t1`
  :host {
...
`;
var b9 = Object.defineProperty, X = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && b9(e, t, i), i;
};
const H9 = ["small", "medium", "large", "x-large", "2x-large"], L9 = [
  "plum",
  "violet",
  "blue",
  "viridian",
...
function V9(s) {
  return H9.some((e) => e === s) ? s : (console.warn(`${s}は無効なsize属性です。`), "medium");
}
function v9(s) {
  return L9.some((e) => e === s);
}
var w, V2, v2, z1;
...
w = new WeakSet(), V2 = function() {
  ...
  return !this.src && L(this, w, z1) && this.color && v9(this.color) && t.push(`color-${this.color}`), this.inactive && t.push("inactive"), t.filter(Boolean).join(" ");
}, v2 = function() {
  this.src = "";
}, z1 = function() {
...
const L1 = class L1 extends p {
  ...
  get buttonClasses() {
    ...
    return [
      ...
      this.variants ? C2(this.variants) : C2(this.variant),
      t[h2(this.size)],
  ...
  get showIcon() {
    return !this.loading && this.iconType && w9(this.iconType);
  }
  renderIcon() {
...
z = new WeakMap(), H1 = new WeakSet(), x2 = function(t) {
...
}, L1.styles = m(g(Z9)), L1.formAssociated = !0;
let b = L1;
$([
...
customElements.get("sp-checkbox-text") || customElements.define("sp-checkbox-text", T9);
const j9 = t1`
  :host {
    display: inline-block;
...
`;
var I9 = Object.defineProperty, O9 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && I9(e, t, i), i;
};
...
customElements.get("sp-floating-button") || customElements.define("sp-floating-button", N9);
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const a1 = U1(class extends H2 {
  constructor(s) {
    if (super(s), s.type !== b2.ATTRIBUTE || s.name !== "class" || s.strings?.length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(s) {
...
var D9 = Object.defineProperty, $2 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && D9(e, t, i), i;
}, G, Z2, k2;
const W1 = class W1 extends p {
  ...
  render() {
    return C`
      <span class=${v(this, G, Z2).call(this)}>${this.text}</span>
      <span class=${v(this, G, k2).call(this)}>${this.supportText}</span>
    `;
  }
};
G = new WeakSet(), Z2 = function() {
  return a1({
    label: !0,
    none: !this.text
  });
...
customElements.get("sp-label-unit") || customElements.define("sp-label-unit", B9);
const R9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, F9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, q9 = `<svg viewBox="0 0 134 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, W9 = `<svg viewBox="0 0 118 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var G9 = Object.defineProperty, w2 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && G9(e, t, i), i;
}, y1, _2;
const G1 = class G1 extends p {
  ...
  render() {
    const t = v(this, y1, _2).call(this);
    return t ? C`${o9(t)}` : C``;
  }
};
y1 = new WeakSet(), _2 = function() {
  if (this.brand === "uzabase")
    return W9;
  if (this.brand === "speeda")
    return this.language === "en" ? F9 : this.language === "zh" ? q9 : R9;
}, G1.styles = m();
let W = G1;
w2([
  a({ type: String, reflect: !0 })
...
customElements.get("sp-logo") || customElements.define("sp-logo", J9);
const Y9 = ":host{display:block;border-radius:6px;padding:8px 0;box-shadow:0 5px 9px 2px #00000021;background-color:#fff}", J1 = class J1 extends p {
  render() {
    return C`<slot></slot>`;
  }
};
...
customElements.get("sp-control-menu-item") || customElements.define("sp-control-menu-item", e0);
const t0 = t1`
  :host {
    display: inline-block;
...
`;
var i0 = Object.defineProperty, _1 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && i0(e, t, i), i;
}, B, c1;
...
B = new WeakMap(), c1 = new WeakMap(), x1.styles = m(t0), x1.formAssociated = !0;
let T = x1;
_1([
  a({ type: String, reflect: !0 })
], T.prototype, "value");
...
customElements.get("sp-radio-button-text") || customElements.define("sp-radio-button-text", s0);
const r0 = ":host .container{display:flex;gap:2px;align-items:center;padding-top:8px;color:#c92812}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}";
var o0 = Object.defineProperty, n0 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && o0(e, t, i), i;
}, M1, A2;
const X1 = class X1 extends p {
  ...
  render() {
    return C`
      <div class="${v(this, M1, A2).call(this)}" role="error">
...
}, $1.styles = m(g(l0)), $1.formAssociated = !0;
let y = $1;
U([
  a({ type: String, reflect: !0 })
], y.prototype, "error");
...
customElements.get("sp-text-field") || customElements.define("sp-text-field", d0);
const C0 = ":host .label{margin-bottom:8px;text-align:left}:host .label.none{display:none}";
var h0 = Object.defineProperty, _ = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && h0(e, t, i), i;
}, Y, z2, P2;
...
Y = new WeakSet(), z2 = function() {
  ...
  const r = t.target;
  this.value = r.value;
}, Z1.styles = m(g(C0)), Z1.formAssociated = !0;
let H = Z1;
_([
  a({ type: String, reflect: !0 })
], H.prototype, "text");
...
customElements.get("sp-text-field-unit") || customElements.define("sp-text-field-unit", p0);
export {
  x as MiAvatar,
  b as MiButton,
  k as MiCheckbox,
  ...
  _9 as SpButton,
  S9 as SpCheckbox,
  T9 as SpCheckboxText,
  X9 as SpControlMenu,
  e0 as SpControlMenuItem,
  N9 as SpFloatingButton,
  g9 as SpIcon,
  B9 as SpLabelUnit,
  $9 as SpLoading,
  J9 as SpLogo,
  s0 as SpRadioButtonText,
  p0 as SpTextFieldUnit
};
