...
var m1 = (s, e, t) => e.has(s) || B1("Cannot " + t);
var j = (s, e, t) => (m1(s, e, "read from private field"), t ? t.call(s) : e.get(s)), v = (s, e, t) => e.has(s) ? B1("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(s) : e.set(s, t), R1 = (s, e, t, r) => (m1(s, e, "write to private field"), r ? r.call(s, t) : e.set(s, t), t), V = (s, e, t) => (m1(s, e, "access private method"), t);
const o1 = globalThis, $1 = o1.ShadowRoot && (o1.ShadyCSS === void 0 || o1.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, w1 = /* @__PURE__ */ Symbol(), F1 = /* @__PURE__ */ new WeakMap();
let n2 = class {
  constructor(e, t, r) {
    if (this._$cssResult$ = !0, r !== w1) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if ($1 && e === void 0) {
      ...
      r && (e = F1.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), r && F1.set(t, e));
    }
    return e;
  }
  toString() {
...
const g = (s) => new n2(typeof s == "string" ? s : s + "", void 0, w1), M1 = (s, ...e) => {
  const t = s.length === 1 ? s[0] : e.reduce((r, i, o) => r + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(i) + s[o + 1], s[0]);
  return new n2(t, s, w1);
}, _2 = (s, e) => {
  if ($1) s.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
...
}, q1 = $1 ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const r of e.cssRules) t += r.cssText;
  return g(t);
})(s) : s;
const { is: k2, defineProperty: A2, getOwnPropertyDescriptor: E2, getOwnPropertyNames: z2, getOwnPropertySymbols: S2, getPrototypeOf: P2 } = Object, L1 = globalThis, W1 = L1.trustedTypes, T2 = W1 ? W1.emptyScript : "", j2 = L1.reactiveElementPolyfillSupport, G = (s, e) => s, n1 = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? T2 : null;
      break;
  ...
  return t;
} }, _1 = (s, e) => !k2(s, e), G1 = { attribute: !0, type: String, converter: n1, reflect: !1, useDefault: !1, hasChanged: _1 };
...
let N = class extends HTMLElement {
  ...
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? G1;
  }
  static _$Ei() {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const i of r) t.unshift(q1(i));
    } else e !== void 0 && t.push(q1(e));
    return t;
  }
  static _$Eu(e, t) {
    const r = t.attribute;
  ...
  _$ET(e, t) {
    ...
    if (i !== void 0 && r.reflect === !0) {
      const o = (r.converter?.toAttribute !== void 0 ? r.converter : n1).toAttribute(t, r.type);
  ...
  _$AK(e, t) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const o = r.getPropertyOptions(i), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : n1;
      this._$Em = i;
  ...
  requestUpdate(e, t, r, i = !1, o) {
    if (e !== void 0) {
      ...
      if (i === !1 && (o = this[e]), r ??= n.getPropertyOptions(e), !((r.hasChanged ?? _1)(o, t) || r.useDefault && r.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(n._$Eu(e, r)))) return;
      this.C(e, t, r);
    }
...
N.elementStyles = [], N.shadowRootOptions = { mode: "open" }, N[G("elementProperties")] = /* @__PURE__ */ new Map(), N[G("finalized")] = /* @__PURE__ */ new Map(), j2?.({ ReactiveElement: N }), (L1.reactiveElementVersions ??= []).push("2.1.2");
const k1 = globalThis, J1 = (s) => s, a1 = k1.trustedTypes, Y1 = a1 ? a1.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, a2 = "$lit$", k = `lit$${Math.random().toFixed(9).slice(2)}$`, l2 = "?" + k, N2 = `<${l2}>`, P = document, J = () => P.createComment(""), Y = (s) => s === null || typeof s != "object" && typeof s != "function", A1 = Array.isArray, O2 = (s) => A1(s) || typeof s?.[Symbol.iterator] == "function", y1 = `[ 	
\f\r]`, W = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, X1 = /-->/g, K1 = />/g, z = RegExp(`>|${y1}(?:([^\\s"'>=/]+)(${y1}*=${y1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q1 = /'/g, e2 = /"/g, C2 = /^(?:script|style|textarea|title)$/i, I2 = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), h = I2(1), A = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), t2 = /* @__PURE__ */ new WeakMap(), S = P.createTreeWalker(P, 129);
function c2(s, e) {
  if (!A1(s) || !s.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const D2 = (s, e) => {
  ...
  for (let C = 0; C < t; C++) {
    const l = s[C];
    let p, f, c = -1, M = 0;
    for (; M < l.length && (n.lastIndex = M, f = n.exec(l), f !== null); ) M = n.lastIndex, n === W ? f[1] === "!--" ? n = X1 : f[1] !== void 0 ? n = K1 : f[2] !== void 0 ? (C2.test(f[2]) && (i = RegExp("</" + f[2], "g")), n = z) : f[3] !== void 0 && (n = z) : n === z ? f[0] === ">" ? (n = i ?? W, c = -1) : f[1] === void 0 ? c = -2 : (c = n.lastIndex - f[2].length, p = f[1], n = f[3] === void 0 ? z : f[3] === '"' ? e2 : Q1) : n === e2 || n === Q1 ? n = z : n === X1 || n === K1 ? n = W : (n = z, i = void 0);
    const _ = n === z && s[C + 1].startsWith("/>") ? " " : "";
    o += n === W ? l + N2 : c >= 0 ? (r.push(p), l.slice(0, c) + a2 + l.slice(c) + k + _) : l + k + (c === -2 ? C : _);
  }
    ...
    for (; (i = S.nextNode()) !== null && l.length < C; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const c of i.getAttributeNames()) if (c.endsWith(a2)) {
          const M = f[n++], _ = i.getAttribute(c).split(k), r1 = /([.?@])?(.*)/.exec(M);
          l.push({ type: 1, index: o, name: r1[2], strings: _, ctor: r1[1] === "." ? B2 : r1[1] === "?" ? R2 : r1[1] === "@" ? F2 : V1 }), i.removeAttribute(c);
        } else c.startsWith(k) && (l.push({ type: 6, index: o }), i.removeAttribute(c));
        if (C2.test(i.tagName)) {
          const c = i.textContent.split(k), M = c.length - 1;
          if (M > 0) {
            i.textContent = a1 ? a1.emptyScript : "";
            for (let _ = 0; _ < M; _++) i.append(c[_], J()), S.nextNode(), l.push({ type: 2, index: ++o });
            i.append(c[M], J());
          }
        }
...
class U2 {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let p;
        l.type === 2 ? p = new i1(o, o.nextSibling, this, e) : l.type === 1 ? p = new l.ctor(o, l.name, l.strings, this, e) : l.type === 6 && (p = new q2(o, this, e)), this._$AV.push(p), l = r[++C];
      }
...
class i1 {
  ...
  _$AI(e, t = this) {
    e = I(this, e, t), Y(e) ? e === d || e == null || e === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : e !== this._$AH && e !== A && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : O2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== d && Y(this._$AH) ? this._$AA.nextSibling.data = e : this.T(P.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: r } = e, i = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = X.createElement(c2(r.h, r.h[0]), this.options)), r);
  ...
  _$AC(e) {
    ...
    return t === void 0 && t2.set(e.strings, t = new X(e)), t;
  }
  k(e) {
    A1(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let r, i = 0;
...
class V1 {
  ...
  _$AI(e, t = this, r, i) {
    ...
    if (o === void 0) e = I(this, e, t, 0), n = !Y(e) || e !== this._$AH && e !== A, n && (this._$AH = e);
      ...
      const C = e;
      let l, p;
      for (e = o[0], l = 0; l < o.length - 1; l++) p = I(this, C[r + l], t, l), p === A && (p = this._$AH[l]), n ||= !Y(p) || p !== this._$AH[l], p === d ? e = d : e !== d && (e += (p ?? "") + o[l + 1]), this._$AH[l] = p;
    }
    n && !i && this.j(e);
  }
  j(e) {
...
const W2 = k1.litHtmlPolyfillSupport;
W2?.(X, i1), (k1.litHtmlVersions ??= []).push("3.3.2");
const G2 = (s, e, t) => {
...
const J2 = E1.litElementPolyfillSupport;
J2?.({ LitElement: u });
(E1.litElementVersions ??= []).push("4.2.2");
const Y2 = { attribute: !0, type: String, converter: n1, reflect: !1, hasChanged: _1 }, X2 = (s = Y2, e, t) => {
...
const d2 = { ATTRIBUTE: 1, CHILD: 2 }, z1 = (s) => (...e) => ({ _$litDirective$: s, values: e });
class h2 {
  constructor(e) {
  }
  get _$AU() {
...
var o9 = Object.defineProperty, n9 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && o9(e, t, i), i;
};
function p2(s) {
  return s9.includes(s);
}
...
`;
var l9 = Object.defineProperty, F = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && l9(e, t, i), i;
};
const C9 = ["small", "medium", "large", "x-large", "2x-large"], c9 = [
  "plum",
  "violet",
  "blue",
  "viridian",
...
function d9(s) {
  return C9.some((e) => e === s) ? s : (console.warn(`${s}は無効なsize属性です。`), "medium");
}
function h9(s) {
  return c9.some((e) => e === s);
}
var $, u2, f2, x1;
...
$ = new WeakSet(), u2 = function() {
  const t = ["base", `size-${d9(this.size)}`];
  return !this.src && j(this, $, x1) && this.color && h9(this.color) && t.push(`color-${this.color}`), this.inactive && t.push("inactive"), t.filter(Boolean).join(" ");
}, f2 = function() {
  this.src = "";
}, x1 = function() {
...
const h1 = class h1 extends u {
  constructor() {
    ...
    v(this, d1);
    v(this, O);
    this.loading = !1, this.disabled = !1, this.danger = !1, this.variants = null, this.variant = "primary", this.size = "medium", this.name = "", this.value = "", this.type = "button", this.iconType = "", R1(this, O, this.attachInternals());
  }
  get buttonClasses() {
    const t = {
      medium: "medium",
  ...
  get showIcon() {
    return !this.loading && this.iconType && H9(this.iconType);
  }
  renderIcon() {
...
var M9 = Object.defineProperty, L2 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && M9(e, t, i), i;
}, U, V2, m2;
const N1 = class N1 extends u {
  ...
  render() {
    return h`
      <span class=${V(this, U, V2).call(this)}>${this.text}</span>
      <span class=${V(this, U, m2).call(this)}>${this.supportText}</span>
    `;
  }
};
U = new WeakSet(), V2 = function() {
  return Q({
    label: !0,
    none: !this.text
  });
...
const v9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, x9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, Z9 = `<svg viewBox="0 0 134 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, $9 = `<svg viewBox="0 0 118 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var w9 = Object.defineProperty, y2 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && w9(e, t, i), i;
}, f1, M2;
const O1 = class O1 extends u {
  ...
  render() {
    const t = V(this, f1, M2).call(this);
    return t ? h`${K2(t)}` : h``;
  }
};
f1 = new WeakSet(), M2 = function() {
  if (this.brand === "uzabase")
    return $9;
  if (this.brand === "speeda")
    return this.language === "en" ? x9 : this.language === "zh" ? Z9 : v9;
}, O1.styles = b();
let t1 = O1;
y2([
  a({ type: String, reflect: !0 })
...
const _9 = ":host{display:block;border-radius:6px;padding:8px 0;box-shadow:0 5px 9px 2px #00000021;background-color:#fff}", I1 = class I1 extends u {
  render() {
    return h`<slot></slot>`;
  }
};
I1.styles = b(g(_9));
let Z1 = I1;
customElements.get("sp-control-menu") || customElements.define("sp-control-menu", Z1);
...
var A9 = Object.defineProperty, S1 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && A9(e, t, i), i;
};
...
const E9 = ":host .container{display:flex;gap:2px;align-items:center;padding-top:8px;color:#c92812}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}";
var z9 = Object.defineProperty, S9 = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && z9(e, t, i), i;
}, g1, v2;
const U1 = class U1 extends u {
  ...
  render() {
    return h`
      <div class="${V(this, g1, v2).call(this)}" role="error">
...
}, H1.styles = b(g(P9)), H1.formAssociated = !0;
let m = H1;
T([
  a({ type: String, reflect: !0 })
], m.prototype, "error");
...
const j9 = ":host .label{margin-bottom:8px;text-align:left}:host .label.none{display:none}";
var N9 = Object.defineProperty, w = (s, e, t, r) => {
  for (var i = void 0, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (i = n(e, t, i) || i);
  return i && N9(e, t, i), i;
}, R, $2, w2;
