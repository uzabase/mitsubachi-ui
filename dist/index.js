...
const { is: y2, defineProperty: x2, getOwnPropertyDescriptor: L2, getOwnPropertyNames: H2, getOwnPropertySymbols: V2, getPrototypeOf: w2 } = Object, be = globalThis, Ct = be.trustedTypes, $2 = Ct ? Ct.emptyScript : "", M2 = be.reactiveElementPolyfillSupport, A1 = (t, e) => t, Q1 = { toAttribute(t, e) {
  ...
  return i;
} }, je = (t, e) => !y2(t, e), gt = { attribute: !0, type: String, converter: Q1, reflect: !1, useDefault: !1, hasChanged: je };
...
let b1 = class extends HTMLElement {
  ...
  static createProperty(e, i = gt) {
    if (i.state && (i.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((i = Object.create(i)).wrapped = !0), this.elementProperties.set(e, i), !i.noAccessor) {
      ...
      o !== void 0 && x2(this.prototype, e, o);
    }
  }
  static getPropertyDescriptor(e, i, r) {
    const { get: o, set: s } = L2(this.prototype, e) ?? { get() {
      return this[i];
    }, set(n) {
      this[i] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(A1("properties"))) {
      const i = this.properties, r = [...H2(i), ...V2(i)];
...
b1.elementStyles = [], b1.shadowRootOptions = { mode: "open" }, b1[A1("elementProperties")] = /* @__PURE__ */ new Map(), b1[A1("finalized")] = /* @__PURE__ */ new Map(), M2?.({ ReactiveElement: b1 }), (be.reactiveElementVersions ??= []).push("2.1.2");
const Ne = globalThis, mt = (t) => t, ee = Ne.trustedTypes, bt = ee ? ee.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, zt = "$lit$", K = `lit$${Math.random().toFixed(9).slice(2)}$`, Pt = "?" + K, k2 = `<${Pt}>`, p1 = document, z1 = () => p1.createComment(""), P1 = (t) => t === null || typeof t != "object" && typeof t != "function", Be = Array.isArray, Z2 = (t) => Be(t) || typeof t?.[Symbol.iterator] == "function", Ee = `[ 	
\f\r]`, S1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, vt = /-->/g, yt = />/g, c1 = RegExp(`>|${Ee}(?:([^\\s"'>=/]+)(${Ee}*=${Ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), xt = /'/g, Lt = /"/g, Tt = /^(?:script|style|textarea|title)$/i, _2 = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), m = _2(1), t1 = /* @__PURE__ */ Symbol.for("lit-noChange"), g = /* @__PURE__ */ Symbol.for("lit-nothing"), Ht = /* @__PURE__ */ new WeakMap(), d1 = p1.createTreeWalker(p1, 129);
function Ot(t, e) {
...
const E2 = (t, e) => {
  ...
  for (let a = 0; a < i; a++) {
    const l = t[a];
    let c, p, h = -1, f = 0;
    for (; f < l.length && (n.lastIndex = f, p = n.exec(l), p !== null); ) f = n.lastIndex, n === S1 ? p[1] === "!--" ? n = vt : p[1] !== void 0 ? n = yt : p[2] !== void 0 ? (Tt.test(p[2]) && (o = RegExp("</" + p[2], "g")), n = c1) : p[3] !== void 0 && (n = c1) : n === c1 ? p[0] === ">" ? (n = o ?? S1, h = -1) : p[1] === void 0 ? h = -2 : (h = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? c1 : p[3] === '"' ? Lt : xt) : n === Lt || n === xt ? n = c1 : n === vt || n === yt ? n = S1 : (n = c1, o = void 0);
    const u = n === c1 && t[a + 1].startsWith("/>") ? " " : "";
    s += n === S1 ? l + k2 : h >= 0 ? (r.push(c), l.slice(0, h) + zt + l.slice(h) + K + u) : l + K + (h === -2 ? a : u);
  }
...
class T1 {
  constructor({ strings: e, _$litType$: i }, r) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const a = e.length - 1, l = this.parts, [c, p] = E2(e, i);
    if (this.el = T1.createElement(c, r), d1.currentNode = this.el.content, i === 2 || i === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (o = d1.nextNode()) !== null && l.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(zt)) {
          const f = p[n++], u = o.getAttribute(h).split(K), C = /([.?@])?(.*)/.exec(f);
          l.push({ type: 1, index: s, name: C[2], strings: u, ctor: C[1] === "." ? A2 : C[1] === "?" ? z2 : C[1] === "@" ? P2 : ve }), o.removeAttribute(h);
        ...
        if (Tt.test(o.tagName)) {
          ...
          if (f > 0) {
            ...
            for (let u = 0; u < f; u++) o.append(h[u], z1()), d1.nextNode(), l.push({ type: 2, index: ++s });
            o.append(h[f], z1());
          }
        }
  ...
  static createElement(e, i) {
    const r = p1.createElement("template");
    return r.innerHTML = e, r;
  }
}
function x1(t, e, i = t, r) {
  if (e === t1) return e;
  let o = r !== void 0 ? i._$Co?.[r] : i._$Cl;
  const s = P1(e) ? void 0 : e._$litDirective$;
  return o?.constructor !== s && (o?._$AO?.(!1), s === void 0 ? o = void 0 : (o = new s(t), o._$AT(t, i, r)), r !== void 0 ? (i._$Co ??= [])[r] = o : i._$Cl = o), o !== void 0 && (e = x1(t, o._$AS(t, e.values), o, r)), e;
}
class S2 {
  constructor(e, i) {
  ...
  u(e) {
    const { el: { content: i }, parts: r } = this._$AD, o = (e?.creationScope ?? p1).importNode(i, !0);
    d1.currentNode = o;
    let s = d1.nextNode(), n = 0, a = 0, l = r[0];
    for (; l !== void 0; ) {
      if (n === l.index) {
        let c;
        l.type === 2 ? c = new I1(s, s.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(s, l.name, l.strings, this, e) : l.type === 6 && (c = new T2(s, this, e)), this._$AV.push(c), l = r[++a];
      }
      n !== l?.index && (s = d1.nextNode(), n++);
    }
    return d1.currentNode = p1, o;
  }
  p(e) {
    let i = 0;
...
class I1 {
  ...
  _$AI(e, i = this) {
    e = x1(this, e, i), P1(e) ? e === g || e == null || e === "" ? (this._$AH !== g && this._$AR(), this._$AH = g) : e !== this._$AH && e !== t1 && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Z2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== g && P1(this._$AH) ? this._$AA.nextSibling.data = e : this.T(p1.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    ...
    if (this._$AH?._$AD === o) this._$AH.p(i);
      ...
      const s = new S2(o, this), n = s.u(this.options);
...
class ve {
  ...
  _$AI(e, i = this, r, o) {
    ...
    let n = !1;
    if (s === void 0) e = x1(this, e, i, 0), n = !P1(e) || e !== this._$AH && e !== t1, n && (this._$AH = e);
    else {
      const a = e;
      let l, c;
      for (e = s[0], l = 0; l < s.length - 1; l++) c = x1(this, a[r + l], i, l), c === t1 && (c = this._$AH[l]), n ||= !P1(c) || c !== this._$AH[l], c === g ? e = g : e !== g && (e += (c ?? "") + s[l + 1]), this._$AH[l] = c;
    }
    n && !o && this.j(e);
  }
  j(e) {
...
class P2 extends ve {
  ...
  _$AI(e, i = this) {
    if ((e = x1(this, e, i, 0) ?? g) === t1) return;
...
const O2 = Ne.litHtmlPolyfillSupport;
O2?.(T1, I1), (Ne.litHtmlVersions ??= []).push("3.3.2");
const R2 = (t, e, i) => {
...
let L = class extends b1 {
  ...
  update(e) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = R2(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const D2 = Ie.litElementPolyfillSupport;
D2?.({ LitElement: L });
(Ie.litElementVersions ??= []).push("4.2.2");
const j2 = { attribute: !0, type: String, converter: Q1, reflect: !1, hasChanged: je }, N2 = (t = j2, e, i) => {
...
function d(t) {
  return (e, i) => typeof i == "object" ? N2(t, e, i) : ((r, o, s) => {
...
const Y2 = ":host{display:inline-block;width:1.28em;height:1.28em}.icon{width:100%;height:100%}", G2 = [
  "app",
  "arrow-down",
  "arrow-down-small",
  "arrow-left",
...
var J2 = Object.defineProperty, X2 = (t, e, i, r) => {
...
`;
var o9 = Object.defineProperty, k1 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && o9(e, i, o), o;
};
const r9 = ["small", "medium", "large", "x-large", "2x-large"], s9 = [
  "plum",
  "violet",
  "blue",
  "viridian",
...
function n9(t) {
  return r9.some((e) => e === t) ? t : (console.warn(`${t}は無効なsize属性です。`), "medium");
}
function a9(t) {
...
var g9 = Object.defineProperty, m9 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && g9(e, i, o), o;
};
...
const y9 = /* @__PURE__ */ new Set(["top", "bottom"]);
function Q(t) {
  return y9.has(u1(t)) ? "y" : "x";
}
function Jt(t) {
  return Yt(Q(t));
}
...
function Te(t) {
  return t.replace(/start|end/g, (e) => v9[e]);
}
const $t = ["left", "right"], Mt = ["right", "left"], H9 = ["top", "bottom"], V9 = ["bottom", "top"];
function w9(t, e, i) {
  switch (t) {
    case "top":
    case "bottom":
...
function $9(t, e, i, r) {
  const o = xe(t);
  let s = w9(u1(t), i === "start", r);
  return o && (s = s.map((n) => n + "-" + o), e && (s = s.concat(s.map(Te)))), s;
}
function re(t) {
  return t.replace(/left|right|bottom|top/g, (e) => b9[e]);
}
function M9(t) {
  return {
    top: 0,
...
function kt(t, e, i) {
  ...
  const s = Q(e), n = Jt(e), a = Gt(n), l = u1(e), c = s === "y", p = r.x + r.width / 2 - o.width / 2, h = r.y + r.height / 2 - o.height / 2, f = r[a] / 2 - o[a] / 2;
  let u;
  switch (l) {
    case "top":
      u = {
...
async function Z9(t, e) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: u = 0
  } = ye(e, t), C = k9(u), y = a[f ? h === "floating" ? "reference" : "floating" : h], b = se(await s.getClippingRect({
...
const _9 = async (t, e, i) => {
  ...
  for (let y = 0; y < a.length; y++) {
    ...
    const {
      ...
      platform: {
        ...n,
        detectOverflow: (v = n.detectOverflow) != null ? v : Z9
      },
      elements: {
        reference: t,
        floating: e
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (m1 = [...m1, {
        ...
        let E1 = (dt = m1.filter((l1) => l1.overflows[0] <= 0).sort((l1, z) => l1.overflows[1] - z.overflows[1])[0]) == null ? void 0 : dt.placement;
        if (!E1)
          switch (u) {
            case "bestFit": {
              var ht;
              const l1 = (ht = m1.filter((z) => {
                ...
                return !0;
              }).map((z) => [z.placement, z.overflows.filter((J) => J > 0).reduce((J, b2) => J + b2, 0)]).sort((z, J) => z[1] - J[1])[0]) == null ? void 0 : ht[0];
              l1 && (E1 = l1);
              break;
            }
...
}, S9 = /* @__PURE__ */ new Set(["left", "top"]);
async function A9(t, e) {
  const {
    placement: i,
    platform: r,
    elements: o
  } = t, s = await (r.isRTL == null ? void 0 : r.isRTL(o.floating)), n = u1(i), a = xe(i), l = Q(i) === "y", c = S9.has(n) ? -1 : 1, p = s && l ? -1 : 1, h = ye(e, t);
  let {
    mainAxis: f,
    crossAxis: u,
    alignmentAxis: C
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: i,
        y: r
      }, h = await s.detectOverflow(e, c), f = Q(u1(o)), u = Yt(f);
      let C = p[u], v = p[f];
      if (n) {
...
function F1(t) {
  ...
  return /auto|scroll|overlay|hidden|clip/.test(e + r + i) && !T9.has(o);
}
const O9 = /* @__PURE__ */ new Set(["table", "td", "th"]);
function R9(t) {
  return O9.has(Z1(t));
}
const D9 = [":popover-open", ":modal"];
function He(t) {
  return D9.some((e) => {
    try {
      return t.matches(e);
...
const j9 = ["transform", "translate", "scale", "rotate", "perspective"], N9 = ["transform", "translate", "scale", "rotate", "perspective", "filter"], B9 = ["paint", "layout", "strict", "content"];
function qe(t) {
  const e = Ye(), i = T(t) ? O(t) : t;
  return j9.some((r) => i[r] ? i[r] !== "none" : !1) || (i.containerType ? i.containerType !== "normal" : !1) || !e && (i.backdropFilter ? i.backdropFilter !== "none" : !1) || !e && (i.filter ? i.filter !== "none" : !1) || N9.some((r) => (i.willChange || "").includes(r)) || B9.some((r) => (i.contain || "").includes(r));
}
function I9(t) {
  let e = i1(t);
  for (; B(e) && !H1(e); ) {
...
function we(t, e) {
  ...
  return e ? e.left + i : f1(F(t)).left + i;
}
function t2(t, e) {
...
function G9(t) {
  const e = F(t), i = Ve(t), r = t.ownerDocument.body, o = h1(e.scrollWidth, e.clientWidth, r.scrollWidth, r.clientWidth), s = h1(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight);
  let n = -i.scrollLeft + we(t);
  const a = -i.scrollTop;
  return O(r).direction === "rtl" && (n += h1(e.clientWidth, r.clientWidth) - o), {
    width: o,
    height: s,
    x: n,
    y: a
...
function i2(t, e) {
  const i = i1(t);
  return i === e || !T(i) || H1(i) ? !1 : O(i).position === "fixed" || i2(i, e);
}
function Q9(t, e) {
  const i = e.get(t);
  if (i)
  ...
  for (; T(n) && !H1(n); ) {
    const a = O(n), l = qe(n);
    !l && a.position === "fixed" && (o = null), (s ? !l && !o : !l && a.position === "static" && !!o && X9.has(o.position) || F1(n) && !l && i2(t, n)) ? r = r.filter((p) => p !== n) : o = a, n = i1(n);
  }
  return e.set(t, r), r;
}
function e0(t) {
  ...
  const n = [...i === "clippingAncestors" ? He(e) ? [] : Q9(e, this._c) : [].concat(i), r], a = n[0], l = n.reduce((c, p) => {
    const h = Et(e, p, o);
    return c.top = h1(h.top, c.top), c.right = ie(h.right, c.right), c.bottom = ie(h.bottom, c.bottom), c.left = h1(h.left, c.left), c;
  }, Et(e, a, o));
  return {
...
function o2(t, e) {
  ...
  for (; r && R9(r) && Se(r); )
    r = St(r, e);
  return r && H1(r) && Se(r) && !qe(r) ? i : r || I9(t) || i;
}
const o0 = async function(t) {
  const e = this.getOffsetParent || o2, i = this.getDimensions, r = await i(t.floating);
  return {
    reference: i0(t.reference, await e(t.floating), t.strategy),
    floating: {
      x: 0,
      y: 0,
      width: r.width,
...
function n0(t, e) {
  ...
  function n(a, l) {
    ...
    function E(k) {
      ...
      g1 === 1 && !r2(c, t.getBoundingClientRect()) && n(), V = !1;
    }
    try {
...
const l0 = z9, c0 = P9, d0 = E9, h0 = (t, e, i) => {
...
`;
var u0 = Object.defineProperty, $e = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && u0(e, i, o), o;
};
...
const U1 = (e1 = class extends L {
  constructor() {
    super(...arguments), this.text = "", this.placement = "top", this._open = !1, this._pointerActive = !1, this._descId = `mi-tooltip-desc-${e1._idCounter++}`, this._onSlotChange = () => {
      ...
      clearTimeout(this._hideTimer), !(this._open || !this.text) && (this._open = !0, await this.updateComplete, !(!this._open || !this._tooltipEl || this._cleanup) && (this._cleanup = a0(
        this,
        this._tooltipEl,
  ...
  async _updatePosition() {
    ...
    const e = C0(this.placement);
    e || console.warn(
      `"${this.placement}" は無効な placement 属性です。"top" を使用します。`
    );
    const i = e ? this.placement : "top", { x: r, y: o } = await h0(this, this._tooltipEl, {
      placement: i,
      strategy: "fixed",
      middleware: [l0(8), d0(), c0({ padding: 8 })]
    });
...
}, e1.styles = w(p0), e1._idCounter = 0, e1);
$e([
  d({ type: String })
], U1.prototype, "text");
$e([
...
`;
var b0 = Object.defineProperty, W1 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && b0(e, i, o), o;
};
...
de.styles = w(m0), de.shadowRootOptions = {
  ...L.shadowRootOptions,
  delegatesFocus: !0
};
let o1 = de;
...
var v0 = Object.defineProperty, Je = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && v0(e, i, o), o;
};
...
`;
var k0 = Object.defineProperty, Z0 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && k0(e, i, o), o;
};
...
customElements.get("sp-floating-button") || customElements.define("sp-floating-button", _0);
const E0 = ":host{display:inline-block;width:1.28em;height:1.28em}.icon-color{width:100%;height:100%}", S0 = [
  "error",
  "information",
  "success",
  "warning"
...
var z0 = Object.defineProperty, P0 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && z0(e, i, o), o;
};
function T0(t) {
  return S0.includes(t);
}
...
`;
var R0 = Object.defineProperty, D0 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && R0(e, i, o), o;
};
const j0 = ["information", "success", "warning", "error"], ot = class ot extends L {
  constructor() {
    super(...arguments), this.type = "information";
  }
  render() {
    const e = j0.includes(this.type) ? this.type : "information";
    return m`
...
}), N0 = ":host{display:flex;flex-direction:column;gap:4px}:host .label{font-weight:var(--font-weight-bold);font-size:14px;color:#000000d6}:host .label.none{display:none}:host .support{font-weight:var(--font-weight-normal);font-size:12px;color:#0000008a}:host .support.none{display:none}";
var B0 = Object.defineProperty, a2 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && B0(e, i, o), o;
}, $1, l2, c2;
const rt = class rt extends L {
  ...
  render() {
    return m`
      <span class=${P(this, $1, l2).call(this)}>${this.text}</span>
      <span class=${P(this, $1, c2).call(this)}>${this.supportText}</span>
    `;
  }
};
$1 = new WeakSet(), l2 = function() {
  return j1({
    label: !0,
    none: !this.text
  });
...
`, U0 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var Y0 = Object.defineProperty, d2 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && Y0(e, i, o), o;
}, ue, h2;
...
ue = new WeakSet(), h2 = function() {
  ...
  if (this.brand === "speeda")
    return this.language === "en" ? U0 : this.language === "zh" ? W0 : F0;
}, st.styles = w();
let w1 = st;
d2([
  d({ type: String, reflect: !0 })
...
customElements.get("sp-logo") || customElements.define("sp-logo", G0);
const J0 = ":host{display:block;border-radius:6px;padding:8px 0;box-shadow:0 5px 9px 2px #00000021;background-color:#fff}", nt = class nt extends L {
  render() {
    return m`<slot></slot>`;
  }
};
...
`;
var i5 = Object.defineProperty, Me = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && i5(e, i, o), o;
}, y1, B1;
  ...
  render() {
    return m`
      <label class="base">
        ...
        <span class="text" id="${S(this, y1)}" aria-hidden="true">
          <slot></slot>
        </span>
      </label>
    `;
...
y1 = new WeakMap(), B1 = new WeakMap(), fe.styles = w(t5), fe.formAssociated = !0;
let r1 = fe;
Me([
  d({ type: String, reflect: !0 })
], r1.prototype, "value");
...
customElements.get("sp-radio-button-text") || customElements.define("sp-radio-button-text", o5);
const r5 = ":host .container{display:flex;gap:2px;align-items:center;padding-top:8px;color:#c92812}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}";
var s5 = Object.defineProperty, n5 = (t, e, i, r) => {
  for (var o = void 0, s = t.length - 1, n; s >= 0; s--)
    (n = t[s]) && (o = n(e, i, o) || o);
  return o && s5(e, i, o), o;
}, Ce, p2;
...
export {
  ...
  $0 as SpCheckboxText,
  X0 as SpControlMenu,
  e5 as SpControlMenuItem,
  _0 as SpFloatingButton,
  t9 as SpIcon,
  I0 as SpLabelUnit,
  h9 as SpLoading,
  G0 as SpLogo,
  o5 as SpRadioButtonText,
  u5 as SpTextFieldUnit,
  y5 as iconButtonSizes,
  v5 as iconButtonVariants
};
