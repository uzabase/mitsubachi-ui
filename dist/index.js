...
var C = globalThis, w = (e) => e, te = C.trustedTypes, ne = te ? te.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, re = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, ie = "?" + T, ae = `<${ie}>`, oe = document, se = () => oe.createComment(""), ce = (e) => e === null || typeof e != "object" && typeof e != "function", le = Array.isArray, ue = (e) => le(e) || typeof e?.[Symbol.iterator] == "function", de = "[ 	\n\f\r]", fe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pe = /-->/g, me = />/g, he = RegExp(`>|${de}(?:([^\\s"'>=/]+)(${de}*=${de}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), ge = /'/g, _e = /"/g, ve = /^(?:script|style|textarea|title)$/i, E = ((e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}))(1), D = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), ye = /* @__PURE__ */ new WeakMap(), k = oe.createTreeWalker(oe, 129);
function be(e, t) {
...
var xe = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === fe ? c[1] === "!--" ? o = pe : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = he) : (ve.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = he) : o = me : o === he ? c[0] === ">" ? (o = i ?? fe, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? he : c[3] === "\"" ? _e : ge) : o === _e || o === ge ? o = he : o === pe || o === me ? o = fe : (o = he, i = void 0);
		let d = o === he && e[t + 1].startsWith("/>") ? " " : "";
		a += o === fe ? n + ae : l >= 0 ? (r.push(s), n.slice(0, l) + re + n.slice(l) + T + d) : n + T + (l === -2 ? t : d);
	}
			...
			if (i.nodeType === 1) {
				...
				if (ve.test(i.tagName)) {
					...
					if (t > 0) {
						...
						for (let n = 0; n < t; n++) i.append(e[n], se()), k.nextNode(), c.push({
							type: 2,
							index: ++a
						});
						i.append(e[t], se());
...
var we = class {
	...
	_$AI(e, t = this) {
		e = Ce(this, e, t), ce(e) ? e === O || e == null || e === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : e !== this._$AH && e !== D && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? ue(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	_(e) {
		this._$AH !== O && ce(this._$AH) ? this._$AA.nextSibling.data = e : this.T(oe.createTextNode(e)), this._$AH = e;
	}
	$(e) {
	...
	_$AI(e, t = this, n, r) {
		...
		if (i === void 0) e = Ce(this, e, t, 0), a = !ce(e) || e !== this._$AH && e !== D, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = Ce(this, r[n + o], t, o), s === D && (s = this._$AH[o]), a ||= !ce(s) || s !== this._$AH[o], s === O ? e = O : e !== O && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
...
}, je = C.litHtmlPolyfillSupport;
je?.(Se, Te), (C.litHtmlVersions ??= []).push("3.3.3");
var Me = (e, t, n) => {
	let r = n?.renderBefore ?? t, i = r._$litPart$;
	if (i === void 0) {
		let e = n?.renderBefore ?? null;
		r._$litPart$ = i = new Te(t.insertBefore(se(), e), e, void 0, n ?? {});
	}
	return i._$AI(e), i;
}, Ne = globalThis, A = class extends S {
	constructor() {
...
var ze = {
	...
	constructor(e) {
		if (super(e), this.it = O, e.type !== ze.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
	}
	render(e) {
...
var Ue = Be(He), We = class extends He {};
We.directiveName = "unsafeSVG", We.resultType = 2;
var Ge = Be(We), Ke = "*,:before,:after{box-sizing:border-box}html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{font-size:100%;font:inherit;vertical-align:baseline;border:0;margin:0;padding:0}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}[hidden]:not([hidden=until-found]){display:none!important}body,article,p,span,div,li,td,th,dt,dd,h1,h2,h3,h4,h5,h6{overflow-wrap:anywhere;line-break:strict}body{-webkit-text-size-adjust:100%;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;line-height:1}li{list-style:none}blockquote,q{quotes:none}blockquote:before,blockquote:after,q:before,q:after{content:\"\";content:none}table{border-collapse:collapse;border-spacing:0}a{color:inherit;text-decoration:none}button{all:unset;box-sizing:border-box}button,label,select,summary,[role=button],[role=option]{cursor:pointer}button,input,select,textarea{margin:0;font-family:inherit;font-size:100%}button,input{overflow:visible}button,select{text-transform:none}button,[type=button],[type=reset],[type=submit]{-webkit-appearance:button}button::-moz-focus-inner{border-style:none;padding:0}[type=button]::-moz-focus-inner{border-style:none;padding:0}[type=reset]::-moz-focus-inner{border-style:none;padding:0}[type=submit]::-moz-focus-inner{border-style:none;padding:0}@media (prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition-duration:.01ms!important;animation-duration:.01ms!important;animation-iteration-count:1!important}}input[type=text],input[type=email],input[type=password],input[type=search],input[type=tel],input[type=url],input[type=number],textarea{-webkit-appearance:none}a,button,input,select,textarea{touch-action:manipulation}:focus{outline-offset:2px;outline:auto}:focus:not(:focus-visible){outline:0}:focus-visible{outline-offset:2px;outline:auto}img{max-width:100%;height:auto}", qe = ":host{--font-weight-normal:400;--font-weight-bold:700}:host,:host *{font-family:Arial,YakuHanJPs,Hiragino Sans,Hiragino Kaku Gothic ProN,Meiryo,Noto Sans JP,sans-serif;font-weight:var(--font-weight-normal);overflow-wrap:anywhere;line-break:strict}:host :lang(ja),:host :lang(en){--font-weight-normal:300;--font-weight-bold:600}:host :lang(zh){font-family:Arial,YakuHanJPs,PingFang SC,Microsoft YaHei,PingFang TC,Microsoft JhengHei,sans-serif}:where(:focus-visible){outline:inherit}fieldset{border:none}button{box-sizing:border-box}";
//#endregion
...
var Je = ":host{pointer-events:none;width:1.28em;height:1.28em;display:inline-block}.icon{fill:currentColor;width:100%;height:100%}", Ye = /* @__PURE__ */ "app.arrow-down.arrow-down-small.arrow-left.arrow-up.arrow-up-down.arrow-up-small.bell.bell-fill.book-ai.bookmark.bookmark-fill.building.building-add.building-cancel-fill.calendar.calendar-event.calendar-fill.chain.check.check-small.chevron-down.chevron-down-fill.chevron-down-small.chevron-left.chevron-left-small.chevron-right.chevron-right-fill.chevron-right-small.chevron-up.chevron-up-small.clock.copy.cross.cross-small.double-chevron-right.download.drag.error-fill.exit.eye.eye-slash.follow.follow-fill.follow-list.follow-list-fill.gear.headset.headset-face.history.home.home-fill.information.information-fill.kebab-menu.language.list-close.list-open.lock.lock-fill.magic.magic-fill.mail.mail-gear.maximize.menu.minimize.minus.minus-circle.minus-circle-fill.money.open-in-new.pencil-square.person.person-add.person-cancel-fill.person-fill.person-gear.plus.plus-circle.plus-circle-fill.plus-small.question-circle.refresh.report.route.search.search-fill.share.side-left.side-right.stop-fill.success.success-fill.unlock.unlock-fill.warning-fill".split("."), P = {
	...
	"arrow-up": "<path d=\"M18.93 9.94001L12 3.01001L5.07 9.94001L6.13 11L11.25 5.88001V21.05H12.75V5.88001L17.87 11L18.93 9.94001Z\"/>",
	...
	refresh: "<path d=\"M8 8.75H2.26V3.01H3.76V6.37C5.56 3.74 8.57 2 12 2C17.43 2 21.85 6.35 21.99 11.75H20.49C20.35 7.18 16.6 3.5 12 3.5C9.08 3.5 6.51 5 4.98 7.25H8V8.75ZM21.61 14.75H20.04H16.01V16.25H19.34C17.87 18.78 15.15 20.5 12.01 20.5C7.32 20.5 3.51 16.69 3.51 12C3.51 11.91 3.52 11.83 3.52 11.75H2.02C2.02 11.84 2.01 11.92 2.01 12C2.01 17.51 6.5 22 12.01 22C15.43 22 18.45 20.27 20.25 17.64V20.49H21.75V14.75H21.61Z\"/>",
...
var Xe = {
	...P,
	"minus-cycle": P["minus-circle"],
	"minus-cycle-fill": P["minus-circle-fill"],
	"plus-cycle": P["plus-circle"],
	"plus-cycle-fill": P["plus-circle-fill"],
	question: P["question-circle"],
	followlist: P["follow-list"],
	"followlist-fill": P["follow-list-fill"]
}, Ze = [
	"minus-cycle",
	"minus-cycle-fill",
	"plus-cycle",
...
customElements.get("mi-icon") || customElements.define("mi-icon", et), customElements.get("sp-icon") || customElements.define("sp-icon", tt);
//#endregion
...
function at(e) {
	return rt.some((t) => t === e) ? e : (console.warn(`${e}は無効なsize属性です。`), "medium");
}
function ot(e) {
	return it.some((t) => t === e);
}
var I = class extends A {
	constructor(...e) {
		super(...e), this.src = "", this.alt = "", this.initials = "", this.size = "medium", this.color = "", this.inactive = !1;
	}
	static {
		this.styles = N(nt);
	}
	get #e() {
		let e = ["base", `size-${at(this.size)}`];
		return !this.src && this.#n && this.color && ot(this.color) && e.push(`color-${this.color}`), this.inactive && e.push("inactive"), e.filter(Boolean).join(" ");
	}
	#t() {
		this.src = "";
	}
      ...
      <div class="${this.#e}">
        ${this.src ? E`
              <img
                ...
                class="image"
              />
            ` : e ? E`<div class="initials">${e}</div>` : E`<div class="icon"><mi-icon type="person"></mi-icon></div>`}
      </div>
    `;
	}
};
F([j({ type: String })], I.prototype, "src", void 0), F([j({ type: String })], I.prototype, "alt", void 0), F([j({ type: String })], I.prototype, "initials", void 0), F([j({ type: String })], I.prototype, "size", void 0), F([j({ type: String })], I.prototype, "color", void 0), F([j({ type: Boolean })], I.prototype, "inactive", void 0);
var st = class extends I {};
customElements.get("mi-avatar") || customElements.define("mi-avatar", I), customElements.get("sp-avatar") || customElements.define("sp-avatar", st);
//#endregion
//#region src/components/loading/loading.css?inline
var ct = ":host{--size-medium:12.5px;--size-large:15px;--size-x-large:17.5px;--size-2x-large:20px;--size-3x-large:26px;--size-4x-large:40px;--padding-medium:1.25px;--padding-large:1.5px;--padding-x-large:2px 2px 1.5px 1.5px;--padding-2x-large:2px;--padding-3x-large:3px;--padding-4x-large:4px;--border-size-ratio:1/10;--ui-semantic-object-regular-default:#000000d6;--neutral-neutral-20-alpha:#00000012;--background-normal:linear-gradient(white, white) padding-box padding-box,conic-gradient(var(--ui-semantic-object-regular-default) 0deg 270deg, var(--neutral-neutral-20-alpha) 270deg 360deg) border-box border-box;--background-ai:linear-gradient(white, white) padding-box padding-box,conic-gradient(#2a2af7 5%, #2a2af7 22%, #47d4ff 30%, #ff2ed5 73%, #f72a48 80%, #f72a48 84%, #2a2af7 100%) border-box border-box;flex-shrink:0;display:inline-flex}.base{display:flex}.base:has(.size-medium){padding:var(--padding-medium)}.base:has(.size-large){padding:var(--padding-large)}.base:has(.size-x-large){padding:var(--padding-x-large)}.base:has(.size-2x-large){padding:var(--padding-2x-large)}.base:has(.size-3x-large){padding:var(--padding-3x-large)}.base:has(.size-4x-large){padding:var(--padding-4x-large)}.size-medium{--size:var(--size-medium)}.size-large{--size:var(--size-large)}.size-x-large{--size:var(--size-x-large)}.size-2x-large{--size:var(--size-2x-large)}.size-3x-large{--size:var(--size-3x-large)}.size-4x-large{--size:var(--size-4x-large)}.loading{width:var(--size);height:var(--size);border:calc(var(--size) * var(--border-size-ratio)) solid transparent;border-radius:50%;animation:1s linear infinite spin;display:inline-block;-webkit-mask-image:radial-gradient(circle closest-side,#0000 80%,#000 80%);mask-image:radial-gradient(circle closest-side,#0000 80%,#000 80%)}.variant-ai{background:var(--background-ai)}.variant-normal{background:var(--background-normal)}@keyframes spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}", lt = class extends A {
	constructor(...e) {
		super(...e), this.ai = !1, this.size = "medium";
	}
	static {
		this.styles = N(a(ct));
	}
...
F([j({ type: Boolean })], lt.prototype, "ai", void 0), F([j({ type: String })], lt.prototype, "size", void 0);
var ut = class extends lt {};
customElements.get("mi-loading") || customElements.define("mi-loading", lt), customElements.get("sp-loading") || customElements.define("sp-loading", ut);
//#endregion
...
function mt(e) {
	return ft.some((t) => t === e);
}
function ht(e) {
	return pt.some((t) => t === e);
}
function gt(e) {
	return $e(e) ? !0 : (console.warn(`${e}は無効なicon-type属性です。`), !1);
}
var L = class extends A {
	...
	#e;
	constructor() {
		super(), this.loading = !1, this.disabled = !1, this.selected = !1, this.toggle = !1, this.variant = "primary", this.size = "medium", this.name = "", this.value = "", this.type = "button", this.form = "", this.href = "", this.target = "", this.rel = "", this.iconType = "", this.#e = this.attachInternals();
	}
	getEffectiveVariant() {
		let e = mt(this.variant);
		return e || console.warn(`${this.variant}は無効なvariant属性です。`), e ? this.variant : ft[0];
	}
	get buttonClasses() {
		let e = {
			medium: "medium",
		...
		t || console.warn(`${this.size}は無効なsize属性です。`);
		let n = t ? this.size : pt[0];
		return [
			"base",
			this.getTheme(),
	...
	get loadingSize() {
		return {
			...
			large: "xLarge",
			xLarge: "2xLarge"
		}[ht(this.size) ? this.size : pt[0]];
	}
	renderLoading() {
		return E`<mi-loading size="${this.loadingSize}"></mi-loading>`;
	}
	get showIcon() {
		return !this.loading && this.iconType && gt(this.iconType);
	}
	renderIcon() {
		return E`<mi-icon type="${this.iconType}" class="icon"></mi-icon>`;
	}
	renderSlot() {
		return E`<slot class="text"></slot>`;
	}
	get effectiveRel() {
		return this.rel ? this.rel : this.target === "_blank" ? "noopener noreferrer" : "";
	}
	renderContent() {
		return E`${this.loading ? this.renderLoading() : O}${this.showIcon ? this.renderIcon() : O}
    ${this.renderSlot()}`;
	}
	render() {
        ...
        <a
          ...
          href="${this.isDisabled ? O : this.href}"
          target="${this.target || O}"
          rel="${this.effectiveRel || O}"
      ...
      <button
        ...
        type="${this.type}"
        form="${this.form || O}"
        aria-pressed="${this.toggle ? this.selected ? "true" : "false" : O}"
        aria-busy="${this.loading ? "true" : O}"
	...
	handleClick(e) {
		if (e.stopPropagation(), !this.loading && !(!this.dispatchEvent(new MouseEvent("click", e)) || !this.#e.form)) if (this.type === "submit") if (e.preventDefault(), this.name) {
			let e = document.createElement("input");
			e.type = "hidden", e.name = this.name, e.value = this.value, this.#e.form.appendChild(e), this.#e.form.requestSubmit(), e.remove();
		} else this.#e.form.requestSubmit();
		else this.type === "reset" && this.#e.form.reset();
	}
	handleLinkClick(e) {
		...
		this.dispatchEvent(new MouseEvent("click", e)) || e.preventDefault();
	}
};
F([j({
	type: Boolean,
	reflect: !0
})], L.prototype, "loading", void 0), F([j({
	type: Boolean,
	reflect: !0
})], L.prototype, "disabled", void 0), F([j({
	type: Boolean,
	reflect: !0
})], L.prototype, "selected", void 0), F([j({
	type: Boolean,
	reflect: !0
})], L.prototype, "toggle", void 0), F([j({
	type: String,
	reflect: !0
})], L.prototype, "variant", void 0), F([j({
	type: String,
	reflect: !0
})], L.prototype, "size", void 0), F([j({ type: String })], L.prototype, "name", void 0), F([j({ type: String })], L.prototype, "value", void 0), F([j({ type: String })], L.prototype, "type", void 0), F([j({ type: String })], L.prototype, "form", void 0), F([j({ type: String })], L.prototype, "href", void 0), F([j({ type: String })], L.prototype, "target", void 0), F([j({ type: String })], L.prototype, "rel", void 0), F([j({
	type: String,
	attribute: "icon-type"
})], L.prototype, "iconType", void 0);
//#endregion
//#region src/components/button/mi-ai-button.ts
try {
...
var _t = class extends L {
	constructor(...e) {
		super(...e), this.variant = "primary", this.iconType = "";
	}
	getTheme() {
		return "ai";
	}
	...
	renderIcon() {
		return E`<mi-icon type="magic-fill" class="icon"></mi-icon>`;
	}
	renderLoading() {
		return E`<mi-loading
...
F([j({ type: String })], _t.prototype, "variant", void 0), F([j({ attribute: !1 })], _t.prototype, "iconType", void 0), customElements.get("mi-ai-button") || customElements.define("mi-ai-button", _t);
//#endregion
//#region src/components/button/mi-danger-button.ts
...
F([j({ type: String })], vt.prototype, "variant", void 0), customElements.get("mi-danger-button") || customElements.define("mi-danger-button", vt);
//#endregion
//#region node_modules/@floating-ui/utils/dist/floating-ui.utils.mjs
var yt = Math.min, R = Math.max, bt = Math.round, xt = Math.floor, z = (e) => ({
	x: e,
	y: e
}), St = {
	left: "right",
...
function At(e, t, n) {
	n === void 0 && (n = !1);
	let r = Et(e), i = kt(e), a = Ot(i), o = i === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
...
var Nt = ["left", "right"], Pt = ["right", "left"], Ft = ["top", "bottom"], It = ["bottom", "top"];
function Lt(e, t, n) {
	switch (e) {
		case "top":
		case "bottom": return n ? t ? Pt : Nt : t ? Nt : Pt;
		case "left":
		case "right": return t ? Ft : It;
		default: return [];
	}
}
function Rt(e, t, n, r) {
	let i = Et(e), a = Lt(Tt(e), n === "start", r);
	return i && (a = a.map((e) => e + "-" + i), t && (a = a.concat(a.map(Mt)))), a;
}
function zt(e) {
	let t = Tt(e);
...
function Ut(e, t, n) {
	let { reference: r, floating: i } = e, a = B(t), o = kt(t), s = Ot(o), c = Tt(t), l = a === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[s] / 2 - i[s] / 2, p;
	switch (c) {
		case "top":
			p = {
				x: u,
...
async function Wt(e, t) {
	t === void 0 && (t = {});
	let { x: n, y: r, platform: i, rects: a, elements: o, strategy: s } = e, { boundary: c = "clippingAncestors", rootBoundary: l = "viewport", elementContext: u = "floating", altBoundary: d = !1, padding: f = 0 } = wt(t, e), p = Vt(f), m = o[d ? u === "floating" ? "reference" : "floating" : u], h = Ht(await i.getClippingRect({
		...
		x: 1,
		y: 1
	}, y = Ht(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
		elements: o,
		rect: g,
		offsetParent: _,
		strategy: s
...
var Gt = 50, Kt = async (e, t, n) => {
	...
	for (let n = 0; n < a.length; n++) {
		...
		u = v ?? u, d = y ?? d, m[g] = {
			...m[g],
			...b
		}, x && p < Gt && (p++, typeof x == "object" && (x.placement && (f = x.placement), x.rects && (l = x.rects === !0 ? await o.getElementRects({
			reference: e,
			floating: t,
			strategy: i
		}) : x.rects), {x: u, y: d} = Ut(l, f, c)), n = -1);
	}
	return {
		x: u,
		y: d,
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			...
			let g = Tt(r), _ = B(o), v = Tt(o) === o, y = await (s.isRTL == null ? void 0 : s.isRTL(c.floating)), b = d || (v || !m ? [zt(o)] : jt(o)), x = p !== "none";
			!d && x && b.push(...Rt(o, m, p, y));
			...
			if (w = [...w, {
				...
				if (t && (!(u === "alignment" && _ !== B(t)) || w.every((e) => B(e.placement) === _ ? e.overflows[0] > 0 : !0))) return {
					data: {
						index: e,
						overflows: w
					},
...
async function Yt(e, t) {
	let { placement: n, platform: r, elements: i } = e, a = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), o = Tt(n), s = Et(n), c = B(n) === "y", l = Jt.has(o) ? -1 : 1, u = a && c ? -1 : 1, d = wt(t, e), { mainAxis: f, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			let { x: n, y: r, placement: i, platform: a } = t, { mainAxis: o = !0, crossAxis: s = !1, limiter: c = { fn: (e) => {
				...
				x: n,
				y: r
			}, d = await a.detectOverflow(t, l), f = B(Tt(i)), p = Dt(f), m = u[p], h = u[f];
			if (o) {
...
function en(e) {
	return Qt() ? e instanceof Node || e instanceof V(e).Node : !1;
}
function U(e) {
	return Qt() ? e instanceof Element || e instanceof V(e).Element : !1;
}
function W(e) {
	return Qt() ? e instanceof HTMLElement || e instanceof V(e).HTMLElement : !1;
}
function tn(e) {
	return !Qt() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof V(e).ShadowRoot;
}
function nn(e) {
...
var on = /transform|translate|scale|rotate|perspective|filter/, sn = /paint|layout|strict|content/, cn = (e) => !!e && e !== "none", ln;
function un(e) {
	let t = U(e) ? G(e) : e;
	return cn(t.transform) || cn(t.translate) || cn(t.scale) || cn(t.rotate) || cn(t.perspective) || !fn() && (cn(t.backdropFilter) || cn(t.filter)) || on.test(t.willChange || "") || sn.test(t.contain || "");
}
function dn(e) {
	let t = K(e);
	for (; W(t) && !pn(t);) {
...
function fn() {
	return ln ??= typeof CSS < "u" && CSS.supports && CSS.supports("-webkit-backdrop-filter", "none"), ln;
}
function pn(e) {
...
function K(e) {
	...
	let t = e.assignedSlot || e.parentNode || tn(e) && e.host || H(e);
	return tn(t) ? t.host : t;
}
function hn(e) {
	let t = K(e);
	return pn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : W(t) && nn(t) ? t : hn(t);
}
function gn(e, t, n) {
	t === void 0 && (t = []), n === void 0 && (n = !0);
	let r = hn(e), i = r === e.ownerDocument?.body, a = V(r);
	if (i) {
		let e = _n(a);
		return t.concat(a, a.visualViewport || [], nn(r) ? r : [], e && n ? gn(e) : []);
	} else return t.concat(r, gn(r, [], n));
}
function _n(e) {
...
function vn(e) {
	let t = G(e), n = parseFloat(t.width) || 0, r = parseFloat(t.height) || 0, i = W(e), a = i ? e.offsetWidth : n, o = i ? e.offsetHeight : r, s = bt(n) !== a || bt(r) !== o;
	return s && (n = a, r = o), {
		width: n,
		height: r,
		$: s
...
function bn(e) {
	let t = yn(e);
	if (!W(t)) return z(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = vn(t), o = (a ? bt(n.width) : n.width) / r, s = (a ? bt(n.height) : n.height) / i;
...
function wn(e, t, n, r) {
	...
	let i = e.getBoundingClientRect(), a = yn(e), o = z(1);
	t && (r ? U(r) && (o = bn(r)) : o = bn(e));
	let s = Cn(a, n, r) ? Sn(a) : z(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a) {
		let e = V(a), t = r && U(r) ? V(r) : r, n = e, i = _n(n);
		for (; i && r && t !== n;) {
			let e = bn(i), t = i.getBoundingClientRect(), r = G(i), a = t.left + (i.clientLeft + parseFloat(r.paddingLeft)) * e.x, o = t.top + (i.clientTop + parseFloat(r.paddingTop)) * e.y;
			c *= e.x, l *= e.y, u *= e.x, d *= e.y, c += a, l += o, n = V(i), i = _n(n);
		}
	}
	return Ht({
		width: u,
...
function Tn(e, t) {
	let n = mn(e).scrollLeft;
	return t ? t.left + n : wn(H(e)).left + n;
}
function En(e, t) {
...
function Dn(e) {
	let { elements: t, rect: n, offsetParent: r, strategy: i } = e, a = i === "fixed", o = H(r), s = t ? an(t.floating) : !1;
	if (r === o || s && a) return n;
	let c = {
		scrollLeft: 0,
		scrollTop: 0
	}, l = z(1), u = z(0), d = W(r);
	if ((d || !d && !a) && (($t(r) !== "body" || nn(o)) && (c = mn(r)), d)) {
		let e = wn(r);
...
function kn(e) {
	let t = H(e), n = mn(e), r = e.ownerDocument.body, i = R(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = R(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + Tn(e), s = -n.scrollTop;
	return G(r).direction === "rtl" && (o += R(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
function Mn(e, t) {
	let n = wn(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = W(e) ? bn(e) : z(1);
	return {
...
function Pn(e, t) {
	let n = K(e);
	return n === t || !U(n) || pn(n) ? !1 : G(n).position === "fixed" || Pn(n, t);
}
function Fn(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = gn(e, [], !1).filter((e) => U(e) && $t(e) !== "body"), i = null, a = G(e).position === "fixed", o = a ? K(e) : e;
	for (; U(o) && !pn(o);) {
		let t = G(o), n = un(o);
		!n && t.position === "fixed" && (i = null), (a ? !n && !i : !n && t.position === "static" && i && (i.position === "absolute" || i.position === "fixed") || nn(o) && !n && Pn(e, o)) ? r = r.filter((e) => e !== o) : i = t, o = K(o);
	}
	return t.set(e, r), r;
}
function In(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? an(t) ? [] : Fn(t, this._c) : [].concat(n), r], o = Nn(t, a[0], i), s = o.top, c = o.right, l = o.bottom, u = o.left;
	for (let e = 1; e < a.length; e++) {
		let n = Nn(t, a[e], i);
		s = R(n.top, s), c = yt(n.right, c), l = yt(n.bottom, l), u = R(n.left, u);
	}
	return {
		width: c - u,
		height: l - s,
...
function Rn(e, t, n) {
	let r = W(t), i = H(t), a = n === "fixed", o = wn(e, !0, a, t), s = {
		scrollLeft: 0,
		scrollTop: 0
	}, c = z(0);
	function l() {
	...
	if (r || !r && !a) if (($t(t) !== "body" || nn(i)) && (s = mn(t)), r) {
		let e = wn(t, !0, a, t);
...
function Vn(e, t) {
	...
	if (!W(e)) {
		let t = K(e);
		for (; t && !pn(t);) {
			if (U(t) && !zn(t)) return t;
			t = K(t);
		}
		return n;
	}
	let r = Bn(e, t);
	for (; r && rn(r) && zn(r);) r = Bn(r, t);
	return r && pn(r) && zn(r) && !un(r) ? n : r || dn(e) || n;
}
...
function Kn(e, t) {
	...
	function o(s, c) {
		...
		function b(t) {
			...
			n === 1 && !Gn(l, e.getBoundingClientRect()) && o(), y = !1;
		}
		try {
...
function qn(e, t, n, r) {
	r === void 0 && (r = {});
	let { ancestorScroll: i = !0, ancestorResize: a = !0, elementResize: o = typeof ResizeObserver == "function", layoutShift: s = typeof IntersectionObserver == "function", animationFrame: c = !1 } = r, l = yn(e), u = i || a ? [...l ? gn(l) : [], ...t ? gn(t) : []] : [];
	u.forEach((e) => {
	...
	function g() {
		let t = wn(e);
		h && !Gn(h, t) && n(), h = t, m = requestAnimationFrame(g);
	}
	return n(), () => {
		var e;
		u.forEach((e) => {
...
var Jn = Xt, Yn = Zt, Xn = qt, Zn = (e, t, n) => {
...
var tr = class e extends A {
	constructor(...t) {
		super(...t), this.text = "", this.placement = "top", this._open = !1, this._pointerActive = !1, this._descId = `mi-tooltip-desc-${e._idCounter++}`, this._onSlotChange = () => {
			...
			e.key === "Escape" && this._open && (clearTimeout(this._hideTimer), this._open = !1, this._cleanup?.(), this._cleanup = void 0);
		}, this._show = async () => {
			clearTimeout(this._hideTimer), !(this._open || !this.text) && (this._open = !0, await this.updateComplete, !(!this._open || !this._tooltipEl || this._cleanup) && (this._cleanup = qn(this, this._tooltipEl, () => this._updatePosition())));
		}, this._scheduleHide = () => {
	...
	connectedCallback() {
		super.connectedCallback(), this._descEl = document.createElement("span"), this._descEl.id = this._descId, this._descEl.hidden = !0, this._descEl.textContent = this.text, this.appendChild(this._descEl), this.addEventListener("mouseenter", this._handleMouseEnter), this.addEventListener("mouseleave", this._scheduleHide), this.addEventListener("pointerdown", this._onPointerDown), this.addEventListener("focusin", this._handleFocusin), this.addEventListener("focusout", this._scheduleHide), this.addEventListener("keydown", this._handleKeyDown);
	}
	disconnectedCallback() {
	...
	updated(e) {
		super.updated(e), e.has("text") && this._descEl && (this._descEl.textContent = this.text);
	}
	async _updatePosition() {
		if (!this._tooltipEl) return;
		let e = er(this.placement);
		e || console.warn(`"${this.placement}" は無効な placement 属性です。"top" を使用します。`);
		let t = e ? this.placement : "top", { x: n, y: r } = await Zn(this, this._tooltipEl, {
			placement: t,
			strategy: "fixed",
			middleware: [
				Jn(8),
	...
	render() {
      ...
      ${this._open ? E`<div class="tooltip" role="tooltip">${this.text}</div>` : O}
    `;
	}
};
F([j({ type: String })], tr.prototype, "text", void 0), F([j({
	type: String,
	reflect: !0
})], tr.prototype, "placement", void 0), F([M()], tr.prototype, "_open", void 0), F([Re(".tooltip")], tr.prototype, "_tooltipEl", void 0), customElements.get("mi-tooltip") || customElements.define("mi-tooltip", tr);
//#endregion
//#region src/components/button/icon-button.styles.ts
var nr = o`
  :host {
    display: inline-block;
  }
...
`, rr = [
	...
	constructor(...e) {
		super(...e), this.variant = "ghost", this.size = "medium", this.label = "", this.tooltipPlacement = "top", this.tooltipDisabled = !1;
	}
	static {
		this.styles = N(nr);
	}
	...
	render() {
		let e = this.renderContent(), t = this.isLink ? E`
          <a
            class="${this.buttonClasses}"
            href="${this.isDisabled ? O : this.href}"
            target="${this.target || O}"
            ...
            title="${this.tooltipDisabled && this.label ? this.label : O}"
            aria-disabled="${this.isDisabled ? "true" : O}"
            aria-busy="${this.loading ? "true" : O}"
            @click="${this.handleLinkClick}"
          >
        ...
        `;
		return !this.label || this.tooltipDisabled ? t : E`
...
F([j({ type: String })], ar.prototype, "variant", void 0), F([j({ type: String })], ar.prototype, "size", void 0), F([j({
	type: String,
	attribute: "aria-label",
	reflect: !0
})], ar.prototype, "label", void 0), F([j({
	type: String,
	attribute: "tooltip-placement"
})], ar.prototype, "tooltipPlacement", void 0), F([j({
	type: Boolean,
	attribute: "tooltip-disabled"
})], ar.prototype, "tooltipDisabled", void 0), customElements.get("mi-icon-button") || customElements.define("mi-icon-button", ar);
//#endregion
//#region src/components/button/mi-neutral-button.ts
var or = class extends L {
	constructor(...e) {
		super(...e), this.danger = !1, this.variants = null, this.variant = "primary";
	}
	getTheme() {
		return this.danger ? "danger" : "normal";
	}
	getEffectiveVariant() {
		let e = this.variants == null ? this.variant : this.variants, t = mt(e);
		return t || console.warn(`${e}は無効なvariant属性です。`), t ? e : ft[0];
	}
};
F([j({
	type: Boolean,
	reflect: !0
})], or.prototype, "danger", void 0), F([j({ type: String })], or.prototype, "variants", void 0), F([j({ type: String })], or.prototype, "variant", void 0);
var sr = class extends or {}, cr = class extends sr {};
customElements.get("mi-neutral-button") || customElements.define("mi-neutral-button", or), customElements.get("mi-button") || customElements.define("mi-button", sr), customElements.get("sp-button") || customElements.define("sp-button", cr);
//#endregion
//#region src/components/checkbox/checkbox.css?inline
var lr = ":host{display:inline-block}.checkmark:has(.input:focus-visible):before{box-shadow:0 0 0 2px #fff,0 0 0 4px #191919}.base:hover .checkmark:has(:not(.input:disabled)):before{border-color:#0000008a;outline:4px solid #0000000a}.base:active .checkmark:has(:not(.input:disabled)):before{outline:4px solid #00000012}.base:hover:active .checkmark:has(:not(.input:disabled)):before{outline:4px solid #00000012}.base:hover .checkmark:has(:is(.input:checked,.input:indeterminate)):has(:not(.input:disabled)):before{background-color:#2666bf;border-color:#2666bf}", ur = ".checkmark{cursor:pointer;flex-grow:0;flex-shrink:0;padding-block:4px;padding-inline:4px;display:inline-flex}.checkmark:before{content:\"\";background:#fff 50% no-repeat;border:1.5px solid #0000004a;border-radius:2px;width:16px;height:16px;display:inline-block}.checkmark:has(:is(.input:checked,.input:indeterminate)):before{background-color:#3f69f2;border-color:#3f69f2}.checkmark:has(.input:checked):before{background-image:url(data:image/svg+xml;base64,)}.checkmark:has(.input:indeterminate):before{background-image:url(data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIHZpZXdCb3g9IjAgMCAxNiAxNiIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cGF0aCBkPSJNMTIgN1Y5SDRWN0gxMloiIGZpbGw9IndoaXRlIi8+PC9zdmc+)}.checkmark:has(.input:disabled){cursor:not-allowed}.checkmark:has(.input:disabled):before{background-color:#e5e5e5;border-color:#0000000d}.checkmark .input{z-index:-1;opacity:0;position:absolute}", q = class extends A {
	static {
		this.styles = N(a(ur), a(lr));
	}
	static {
		this.formAssociated = !0;
	}
	...
	updated(e) {
		super.updated(e), e.has("checked") && this.internals.setFormValue(this.checked ? this.value : null);
	}
	handleChange(e) {
		let t = e.target;
		this.checked = t.checked, this.indeterminate = t.indeterminate, this.dispatchEvent(new CustomEvent("change", {
			bubbles: !0,
			composed: !0,
			detail: {
...
F([j({
	type: String,
	reflect: !0
})], q.prototype, "value", void 0), F([j({
	type: String,
	reflect: !0
})], q.prototype, "name", void 0), F([j({
	type: Boolean,
	reflect: !0
})], q.prototype, "checked", void 0), F([j({
	type: Boolean,
	reflect: !0
})], q.prototype, "indeterminate", void 0), F([j({
	type: Boolean,
	reflect: !0
})], q.prototype, "disabled", void 0);
var dr = class extends q {};
customElements.get("mi-checkbox") || customElements.define("mi-checkbox", q), customElements.get("sp-checkbox") || customElements.define("sp-checkbox", dr);
//#endregion
//#region src/components/checkbox/checkbox-text.css?inline
var fr = ":host{max-width:100%;display:inline-block}.base{cursor:pointer;justify-content:flex-start;align-items:flex-start;max-width:100%;display:inline-flex}.checkmark:has(.input:focus-visible):before{box-shadow:0 0 0 2px #fff,0 0 0 4px #191919}.base:has(.input:disabled){cursor:not-allowed}.text{color:#000000d6;letter-spacing:.02em;padding-block:3px;padding-inline:4px;font-size:14px;line-height:1.3}.base:has(.input:disabled) .text{color:#00000059}.base:hover .checkmark:has(:not(.input:disabled)):before{border-color:#0000008a;outline:4px solid #0000000a}.base:active .checkmark:has(:not(.input:disabled)):before{outline:4px solid #00000012}.base:hover:active .checkmark:has(:not(.input:disabled)):before{outline:4px solid #00000012}.base:hover .checkmark:has(:is(.input:checked,.input:indeterminate)):has(:not(.input:disabled)):before{background-color:#2666bf;border-color:#2666bf}", J = class extends A {
	static {
		this.styles = N(a(ur), a(fr));
	}
	static {
		this.formAssociated = !0;
	}
...
F([j({
	type: String,
	reflect: !0
})], J.prototype, "value", void 0), F([j({
	type: String,
	reflect: !0
})], J.prototype, "name", void 0), F([j({
	type: Boolean,
	reflect: !0
})], J.prototype, "checked", void 0), F([j({
	type: Boolean,
	reflect: !0
})], J.prototype, "indeterminate", void 0), F([j({
	type: Boolean,
	reflect: !0
})], J.prototype, "disabled", void 0), F([j({
	type: String,
	reflect: !0
})], J.prototype, "text", void 0);
var pr = class extends J {};
customElements.get("mi-checkbox-text") || customElements.define("mi-checkbox-text", J), customElements.get("sp-checkbox-text") || customElements.define("sp-checkbox-text", pr);
//#endregion
//#region src/components/dialog/dialog.styles.ts
var mr = [a(".dialog-root::backdrop{background:var(--neutral-neutral-50-alpha,#0000004a)}"), o`
    /* ========== Dialog ルート ========== */
    .dialog-root {
      border: none;
      padding: 0;
  ...
  `], Y = class extends A {
	constructor(...e) {
		super(...e), this.open = !1, this.headerText = "", this.cancelLabel = "", this.actionLabel = "", this.danger = !1, this.formId = "", this._isScrolledFromTop = !1, this._isScrolledFromBottom = !1, this._closingFromFooterButton = !1, this._boundCheckScroll = () => this._checkScroll(), this._handleClose = () => {
			...
			this._closingFromFooterButton = !0, this._nativeDialog()?.close(), this._closingFromFooterButton = !1, this.open = !1, this.dispatchEvent(new Event("close", {
				bubbles: !1,
				composed: !1
			}));
		}, this._handleActionClick = () => {
			if (this.formId) {
				let e = document.getElementById(this.formId);
	...
	get actionButtonType() {
		return "button";
	}
	disconnectedCallback() {
		super.disconnectedCallback(), this._bodyEl?.removeEventListener("scroll", this._boundCheckScroll), this._resizeObserver?.disconnect();
	}
	updated(e) {
		super.updated(e), e.has("open") && (this._handleOpenChange(), this.open || this._resizeObserver?.disconnect()), this._bodyEl && (this._bodyEl.removeEventListener("scroll", this._boundCheckScroll), this._bodyEl.addEventListener("scroll", this._boundCheckScroll), this._resizeObserver ||= new ResizeObserver(this._boundCheckScroll), this._resizeObserver.disconnect(), this._resizeObserver.observe(this._bodyEl), this._checkScroll());
	}
	_checkScroll() {
		if (!this._bodyEl) return;
		let { scrollTop: e, scrollHeight: t, clientHeight: n } = this._bodyEl;
		this._isScrolledFromTop = e > 0, this._isScrolledFromBottom = e + n < t - 1;
	}
	_handleOpenChange() {
		let e = this._nativeDialog();
		e && (this.open ? e.showModal() : e.close());
	}
	_nativeDialog() {
	...
	render() {
      ...
      <dialog
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby=${this.headerText ? "dialog-title" : O}
        ...
        >
          ...
          >
            ...
            <div
              class="body"
              id="dialog-body"
              data-scrolled-from-top=${this._isScrolledFromTop ? "true" : "false"}
              data-scrolled-from-bottom=${this._isScrolledFromBottom ? "true" : "false"}
...
F([j({
	type: Boolean,
	reflect: !0
})], Y.prototype, "open", void 0), F([j({
	type: String,
	attribute: "header-text"
})], Y.prototype, "headerText", void 0), F([j({
	type: String,
	attribute: "cancel-label"
})], Y.prototype, "cancelLabel", void 0), F([j({
	type: String,
	attribute: "action-label"
})], Y.prototype, "actionLabel", void 0), F([j({
	type: Boolean,
	reflect: !0
})], Y.prototype, "danger", void 0), F([j({
	type: String,
	attribute: "form-id"
})], Y.prototype, "formId", void 0), F([Re(".body")], Y.prototype, "_bodyEl", void 0), F([M()], Y.prototype, "_isScrolledFromTop", void 0), F([M()], Y.prototype, "_isScrolledFromBottom", void 0);
//#endregion
//#region src/components/dialog/mi-action-dialog.ts
...
customElements.get("mi-action-dialog") || customElements.define("mi-action-dialog", hr);
//#endregion
//#region src/components/dialog/mi-form-dialog.ts
var gr = [
	"small",
	"medium",
	"large"
...
var vr = class extends Y {
	...
	get dialogSize() {
		let e = _r(this.size);
		return e || console.warn(`"${this.size}" は無効な size 属性です。"medium" を使用します。`), e ? this.size : "medium";
	}
	get variant() {
		return "form";
	}
...
F([j({
	type: String,
	reflect: !0
})], vr.prototype, "size", void 0), customElements.get("mi-form-dialog") || customElements.define("mi-form-dialog", vr);
//#endregion
//#region src/components/dialog/mi-information-dialog.ts
var yr = ["small", "medium"];
function br(e) {
...
F([j({
	type: String,
	reflect: !0
})], xr.prototype, "size", void 0), customElements.get("mi-information-dialog") || customElements.define("mi-information-dialog", xr);
//#endregion
//#region src/components/floating-button/floating-button.styles.ts
var Sr = o`
  :host {
    display: inline-block;
...
`, Cr = class extends A {
	...
	render() {
      ...
      ${this.loading ? E`<mi-loading class="loading" ai size="3xLarge"></mi-loading>` : E`<mi-icon class="icon" type="magic-fill"></mi-icon>`}
    </button>`;
	}
};
F([j({ type: Boolean })], Cr.prototype, "loading", void 0);
var wr = class extends Cr {};
customElements.get("mi-floating-button") || customElements.define("mi-floating-button", Cr), customElements.get("sp-floating-button") || customElements.define("sp-floating-button", wr);
//#endregion
//#region src/components/icon-color/icon-color.css?inline
var Tr = ":host{width:1.28em;height:1.28em;display:inline-block}.icon-color{width:100%;height:100%}", Er = [
	"error",
	"information",
	"success",
	"warning"
...
//#endregion
//#region src/components/icon-color/index.ts
function Or(e) {
	return Er.includes(e);
}
var kr = class extends A {
	constructor(...e) {
		super(...e), this.type = "information";
	}
	static {
		this.styles = N(a(Tr));
	}
	render() {
		return Or(this.type) ? E`<svg
        class="icon-color"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        aria-hidden="true"
...
F([j({
	type: String,
	reflect: !0
})], kr.prototype, "type", void 0), customElements.get("mi-icon-color") || customElements.define("mi-icon-color", kr);
//#endregion
//#region src/components/inline-notification/inline-notification.styles.ts
var Ar = o`
  .base {
    display: flex;
...
`, jr = [
	...
	render() {
		let e = jr.includes(this.type) ? this.type : "information";
		return E`
      <div class="base" data-type=${e}>
        <mi-icon-color class="icon" type=${e}></mi-icon-color>
        <div><slot></slot></div>
      </div>
    `;
	}
...
F([j({
	type: String,
	reflect: !0
})], Mr.prototype, "type", void 0), customElements.get("mi-inline-notification") || customElements.define("mi-inline-notification", Mr);
//#endregion
//#region node_modules/lit-html/directives/class-map.js
var Nr = Be(class extends Ve {
	constructor(e) {
...
}), Pr = ":host{flex-direction:column;gap:4px;display:flex}:host .label{font-weight:var(--font-weight-bold);color:#000000d6;font-size:14px}:host .label.none{display:none}:host .support{font-weight:var(--font-weight-normal);color:#0000008a;font-size:12px}:host .support.none{display:none}", Fr = class extends A {
	constructor(...e) {
		super(...e), this.text = "", this.supportText = "";
	}
	static {
		this.styles = N(a(Pr));
	}
	...
	render() {
		return E`
      <span class=${this.#e()}>${this.text}</span>
      <span class=${this.#t()}>${this.supportText}</span>
    `;
	}
};
F([j({
...
var Gr = {
  ...
  `);
	...
	updated() {
		this.setAttribute("role", "img"), this.setAttribute("aria-label", this.label);
	}
	#e() {
		return Kr({
...
F([j({
	...
	reflect: !0,
	attribute: "sub-brand"
})], qr.prototype, "subBrand", void 0), F([j({
	type: Boolean,
	reflect: !0
})], qr.prototype, "inverse", void 0), F([j({
	type: Boolean,
	reflect: !0,
	attribute: "no-symbol"
})], qr.prototype, "noSymbol", void 0), F([j({
	type: String,
	reflect: !0,
	attribute: "logo-language"
})], qr.prototype, "logoLanguage", void 0), F([j({ type: String })], qr.prototype, "label", void 0), customElements.get("mi-speeda-logo") || customElements.define("mi-speeda-logo", qr);
//#endregion
//#region src/components/logo/uzabase-logos.ts
var Jr = {
...
}, Yr = (e) => Jr[`inverse:${e.inverse ?? "null"}`] ?? void 0, Xr = class extends A {
	constructor(...e) {
		super(...e), this.inverse = !1, this.label = Rr;
	}
	static {
		this.styles = N(o`
    :host {
  ...
  `);
	...
	#e() {
		return Yr({ inverse: this.inverse });
	}
	render() {
		let e = this.#e();
		return e ? E`${Ue(e)}` : O;
...
F([j({
	type: Boolean,
	reflect: !0
})], Xr.prototype, "inverse", void 0), F([j({ type: String })], Xr.prototype, "label", void 0), customElements.get("mi-uzabase-logo") || customElements.define("mi-uzabase-logo", Xr);
//#endregion
//#region src/components/menu/control-menu/styles.css?inline
var Zr = ":host{background-color:#fff;border-radius:6px;padding:8px 0;display:block;box-shadow:0 5px 9px 2px #00000021}", Qr = class extends A {
	static {
		this.styles = N(a(Zr));
	}
	render() {
...
customElements.get("mi-control-menu") || customElements.define("mi-control-menu", Qr), customElements.get("sp-control-menu") || customElements.define("sp-control-menu", $r);
//#endregion
//#region src/components/menu/control-menu-item/styles.css?inline
var ei = ":host{box-sizing:border-box;cursor:pointer;color:#000000d6;justify-content:space-between;align-items:center;column-gap:8px;min-height:32px;padding:4px 12px 4px 16px;font-size:14px;display:flex}:host .icon{width:24px;height:24px;display:none}:host([selected]){background-color:#f0f6ff}:host([selected]) .icon{display:block}:host([selected]:hover){background-color:#e3efff}:host([selected]:active){background-color:#d4e6ff}:host([disabled]){cursor:not-allowed;color:#00000059;background-color:#0000}:host([disabled]:hover),:host([disabled]:active){background-color:#0000}:host([disabled]:focus){border:none;padding:4px 12px 4px 16px}:host(:hover){background-color:#f8f8f8}:host(:active){background-color:#0000000d}:host(:focus){box-sizing:border-box;border:2px solid #191919;outline:none;padding:2px 10px 2px 14px}", ti = class extends A {
	constructor(...e) {
		super(...e), this.text = "", this.selected = !1, this.disabled = !1;
	}
	static {
		this.styles = N(a(ei));
	}
...
F([j({
	type: String,
	reflect: !0
})], ti.prototype, "text", void 0), F([j({
	type: Boolean,
	reflect: !0
})], ti.prototype, "selected", void 0), F([j({
	type: Boolean,
	reflect: !0
})], ti.prototype, "disabled", void 0);
var ni = class extends ti {};
customElements.get("mi-control-menu-item") || customElements.define("mi-control-menu-item", ti), customElements.get("sp-control-menu-item") || customElements.define("sp-control-menu-item", ni);
//#endregion
//#region src/components/menu/menu-item.styles.ts
var ri = o`
  /* ==============================
     ルート（共通ベース）
     ============================== */
...
`, ai = class extends A {
	constructor(...e) {
		super(...e), this.variant = "neutral", this.disabled = !1, this.supportText = "", this._hasIcon = !1, this._handleClick = (e) => {
			if (this.disabled) {
	...
	connectedCallback() {
		super.connectedCallback(), this.setAttribute("role", "menuitem"), this.setAttribute("tabindex", "-1"), this.addEventListener("click", this._handleClick), this.addEventListener("keydown", this._handleKeyDown);
	}
	disconnectedCallback() {
...
F([j({
	type: String,
	reflect: !0
})], ai.prototype, "variant", void 0), F([j({
	type: Boolean,
	reflect: !0
})], ai.prototype, "disabled", void 0), F([j({
	type: String,
	attribute: "support-text"
})], ai.prototype, "supportText", void 0), F([M()], ai.prototype, "_hasIcon", void 0), customElements.get("mi-action-menu-item") || customElements.define("mi-action-menu-item", ai);
//#endregion
//#region src/components/menu/mi-link-menu-item.ts
var oi = class extends A {
	...
	render() {
      ...
      <a
        href=${this.href}
        target=${this.newWindow ? "_blank" : O}
        rel=${this.newWindow ? "noopener noreferrer" : O}
      >
        <span class="item-layout">
          ${this._hasIcon ? E`<span class="icon-wrapper" aria-hidden="true">
                <slot name="icon" @slotchange=${this._onIconSlotChange}></slot>
        ...
        ${this.newWindow ? E`<span class="new-window-icon" aria-hidden="true">
...
F([j({ type: String })], oi.prototype, "href", void 0), F([j({
	type: Boolean,
	attribute: "new-window",
	reflect: !0
})], oi.prototype, "newWindow", void 0), F([j({
	type: String,
	attribute: "support-text"
})], oi.prototype, "supportText", void 0), F([M()], oi.prototype, "_hasIcon", void 0), customElements.get("mi-link-menu-item") || customElements.define("mi-link-menu-item", oi);
//#endregion
//#region src/components/menu/mi-menu.ts
var si = class extends A {
	constructor(...e) {
		super(...e), this.open = !1, this._handleTriggerClick = (e) => {
			let t = this._triggerEl;
			if (!t) return;
			let n = e.target;
			(t === n || t.contains(n)) && (e.stopPropagation(), this.open = !this.open);
		}, this._handleKeyDown = (e) => {
			e.key === "Escape" && this.open && (e.preventDefault(), this.open = !1, this._triggerEl?.focus());
		}, this._handleItemActivate = () => {
			this.open = !1, this._triggerEl?.focus();
		}, this._handleOutsideClick = (e) => {
			this.contains(e.target) || (this.open = !1);
		};
	}
	static {
		this.styles = N(o`
  ...
  `);
	...
	connectedCallback() {
		super.connectedCallback(), this.addEventListener("click", this._handleTriggerClick), this.addEventListener("keydown", this._handleKeyDown), this.addEventListener("menu-item-activate", this._handleItemActivate);
	}
	disconnectedCallback() {
		super.disconnectedCallback(), this.removeEventListener("click", this._handleTriggerClick), this.removeEventListener("keydown", this._handleKeyDown), this.removeEventListener("menu-item-activate", this._handleItemActivate), this._removeOutsideListeners(), this._cleanup?.();
	}
	updated(e) {
		if (super.updated(e), e.has("open")) {
			let e = this._dropdownEl;
			e && (e.open = this.open), this.open ? (this._addOutsideListeners(), this._positionDropdown(), requestAnimationFrame(() => {
				e?.focusFirstItem();
			})) : (this._removeOutsideListeners(), this._cleanup?.(), this._cleanup = void 0);
		}
	}
	closeMenu() {
		this.open = !1;
	...
	async _positionDropdown() {
		let e = this._triggerEl, t = this._dropdownEl;
		if (!e || !t) return;
		await t.updateComplete;
		let n = t.shadowRoot?.querySelector(".popup");
		if (!n) return;
		let r = t.side, i = t.align, a = t.sideOffset, o = ci(r, i);
		this._cleanup?.(), this._cleanup = qn(e, n, async () => {
			if (!this.open) return;
			let { x: t, y: r } = await Zn(e, n, {
				placement: o,
				strategy: "fixed",
				middleware: [
					Jn(a),
...
customElements.get("mi-menu") || customElements.define("mi-menu", si);
//#endregion
//#region src/components/menu/menu-dropdown.styles.ts
var li = o`
  :host {
    display: contents;
  }
...
`, X = class extends A {
	constructor(...e) {
		super(...e), this.open = !1, this.side = "bottom", this.align = "start", this.sideOffset = 4, this.width = 200, this.positionStatic = !1;
	}
	static {
		this.styles = N(li);
	}
	focusFirstItem() {
		this._getMenuItems().find((e) => !e.hasAttribute("disabled"))?.focus();
	}
	_getMenuItems() {
		return Array.from(this.querySelectorAll("mi-action-menu-item:not([disabled]), mi-link-menu-item:not([disabled]), mi-select-menu-item:not([disabled]), mi-sub-menu-item:not([disabled])"));
	}
	_handleKeyDown(e) {
		let t = this._getMenuItems();
		if (t.length === 0) return;
		let n = t.indexOf(this.getRootNode().activeElement?.closest("mi-action-menu-item, mi-link-menu-item, mi-select-menu-item, mi-sub-menu-item"));
		switch (e.key) {
			case "ArrowDown":
				e.preventDefault(), t[n + 1 < t.length ? n + 1 : 0]?.focus();
				break;
			case "ArrowUp":
				e.preventDefault(), t[n - 1 >= 0 ? n - 1 : t.length - 1]?.focus();
				break;
			case "Home":
	...
	render() {
      ...
      <div
        ...
        role="menu"
        tabindex="-1"
        style="inline-size: ${this.width === 0 ? "fit-content" : `${this.width}px`}"
...
F([j({
	type: Boolean,
	reflect: !0
})], X.prototype, "open", void 0), F([j({ type: String })], X.prototype, "side", void 0), F([j({ type: String })], X.prototype, "align", void 0), F([j({
	type: Number,
	attribute: "side-offset"
})], X.prototype, "sideOffset", void 0), F([j({ type: Number })], X.prototype, "width", void 0), F([j({
	type: Boolean,
	reflect: !0,
	attribute: "position-static"
})], X.prototype, "positionStatic", void 0), customElements.get("mi-menu-dropdown") || customElements.define("mi-menu-dropdown", X);
//#endregion
//#region src/components/menu/mi-menu-group.ts
var ui = class extends A {
  ...
  `);
	...
	connectedCallback() {
		super.connectedCallback(), this.setAttribute("role", "group"), this.label && this.setAttribute("aria-label", this.label);
	}
	updated(e) {
		super.updated(e), e.has("label") && (this.label ? this.setAttribute("aria-label", this.label) : this.removeAttribute("aria-label"));
	}
	render() {
		return E`
      ${this.label ? E`<div class="group-label">${this.label}</div>` : O}
      <slot></slot>
    `;
	}
};
F([j({ type: String })], ui.prototype, "label", void 0), customElements.get("mi-menu-group") || customElements.define("mi-menu-group", ui);
//#endregion
//#region src/components/menu/mi-menu-radio-group.ts
var di = class extends A {
  ...
  `);
	...
	_updateChildren() {
		this.querySelectorAll("mi-select-menu-item").forEach((e) => {
			e.requestUpdate();
		});
	}
	render() {
...
F([j({
	type: String,
	reflect: !0
})], di.prototype, "value", void 0), customElements.get("mi-menu-radio-group") || customElements.define("mi-menu-radio-group", di);
//#endregion
...
var fi = class extends A {
	...
	get selected() {
		let e = this.closest("mi-menu-radio-group");
		return e ? e.value === this.value : !1;
	}
	connectedCallback() {
		super.connectedCallback(), this.setAttribute("role", "menuitemradio"), this.setAttribute("tabindex", "-1"), this.addEventListener("click", this._handleClick), this.addEventListener("keydown", this._handleKeyDown);
	}
	disconnectedCallback() {
		super.disconnectedCallback(), this.removeEventListener("click", this._handleClick), this.removeEventListener("keydown", this._handleKeyDown);
	}
	...
	render() {
      ...
      ${this.selected ? E`<span class="check-icon" aria-hidden="true">
...
var pi = class extends A {
	constructor(...e) {
		super(...e), this.disabled = !1, this._hasIcon = !1, this._subOpen = !1, this._handleMouseEnter = () => {
			this.disabled || (clearTimeout(this._hoverTimer), this._hoverTimer = setTimeout(() => {
				this._subOpen = !0;
			}, 100));
		}, this._handleMouseLeave = () => {
			clearTimeout(this._hoverTimer), this._hoverTimer = setTimeout(() => {
				this._subOpen = !1;
			}, 150);
		}, this._handleClick = (e) => {
			if (this.disabled) {
			...
			e.stopPropagation(), this._subOpen = !this._subOpen;
		}, this._handleKeyDown = (e) => {
			this.disabled || ((e.key === "ArrowRight" || e.key === "Enter" || e.key === " ") && (e.preventDefault(), this._subOpen = !0, requestAnimationFrame(() => {
				this.querySelector("mi-menu-dropdown")?.focusFirstItem();
			})), (e.key === "ArrowLeft" || e.key === "Escape") && this._subOpen && (e.preventDefault(), e.stopPropagation(), this._subOpen = !1, this.focus()));
		};
	}
	static {
		this.styles = N(ri, ii, o`
	...
	connectedCallback() {
		super.connectedCallback(), this.setAttribute("role", "menuitem"), this.setAttribute("tabindex", "-1"), this.setAttribute("aria-haspopup", "menu"), this.addEventListener("mouseenter", this._handleMouseEnter), this.addEventListener("mouseleave", this._handleMouseLeave), this.addEventListener("click", this._handleClick), this.addEventListener("keydown", this._handleKeyDown);
	}
	disconnectedCallback() {
		super.disconnectedCallback(), this.removeEventListener("mouseenter", this._handleMouseEnter), this.removeEventListener("mouseleave", this._handleMouseLeave), this.removeEventListener("click", this._handleClick), this.removeEventListener("keydown", this._handleKeyDown), this._cleanup?.(), clearTimeout(this._hoverTimer);
	}
	updated(e) {
		if (super.updated(e), e.has("_subOpen")) {
			this.setAttribute("aria-expanded", String(this._subOpen));
			let e = this.querySelector("[slot=\"submenu\"] mi-menu-dropdown, mi-menu-dropdown[slot=\"submenu\"]");
			e && (e.open = this._subOpen, this._subOpen ? this._positionSubmenu(e) : (this._cleanup?.(), this._cleanup = void 0));
		}
	}
	async _positionSubmenu(e) {
		await e.updateComplete;
		let t = e.shadowRoot?.querySelector(".popup");
		t && (this._cleanup?.(), this._cleanup = qn(this, t, async () => {
			if (!this._subOpen) return;
			let { x: e, y: n } = await Zn(this, t, {
	...
	render() {
      ...
      ${this._subOpen ? E`<slot name="submenu"></slot>` : O}
    `;
	}
};
F([j({
	type: Boolean,
	reflect: !0
})], pi.prototype, "disabled", void 0), F([M()], pi.prototype, "_hasIcon", void 0), F([M()], pi.prototype, "_subOpen", void 0), customElements.get("mi-sub-menu-item") || customElements.define("mi-sub-menu-item", pi);
//#endregion
//#region src/components/radio-button/radio-button-text.styles.ts
var mi = o`
  :host {
    display: inline-block;
...
`, hi = class extends A {
	...
	render() {
      ...
      <label class="base">
        ...
        <span class="text" id="${this.#e}" aria-hidden="true">
          <slot></slot>
        </span>
      </label>
    `;
...
F([j({
	type: String,
	reflect: !0
})], hi.prototype, "value", void 0), F([j({
	type: String,
	reflect: !0
})], hi.prototype, "name", void 0), F([j({
	type: Boolean,
	reflect: !0
})], hi.prototype, "checked", void 0), F([j({
	type: Boolean,
	reflect: !0
})], hi.prototype, "disabled", void 0);
var gi = class extends hi {};
customElements.get("mi-radio-button-text") || customElements.define("mi-radio-button-text", hi), customElements.get("sp-radio-button-text") || customElements.define("sp-radio-button-text", gi);
//#endregion
//#region src/components/search-box/search-box.css?inline
var _i = ":host{box-sizing:border-box;inline-size:100%;display:block}.container{gap:var(--spacing-x-small,4px);min-block-size:40px;padding-block:2px;padding-inline:var(--spacing-small,8px) var(--spacing-x-small,4px);border-radius:var(--radius-medium,6px);box-sizing:border-box;align-items:center;inline-size:100%;display:flex}.container.has-value{padding-inline-end:var(--spacing-small,8px)}.primary{background-color:var(--surface-semi-strong-default,#ededed);border:none}.primary:has(:disabled){background-color:var(--surface-regular-disabled,#00000008)}.primary:hover:not(:has(:disabled),:has(:focus-visible)){background-color:var(--surface-semi-strong-hover,#e5e5e5)}.secondary{background-color:var(--surface-regular-default,#fff);border:1px solid var(--border-semi-strong-default,#0003)}.secondary:has(:disabled){background-color:var(--surface-regular-disabled,#00000008);border-color:#0000}.secondary:hover:not(:has(:disabled),:has(:focus-visible)){border-color:var(--border-semi-strong-hover,#00000059)}.container:has(.input:focus-visible){box-shadow:0 0 0 2px var(--surface-regular-default,#fff), 0 0 0 4px var(--focus-ring-default,#191919);outline:none;overflow:clip}.search-icon{block-size:20px;inline-size:20px;color:var(--object-weak-default,#0000008a);flex-shrink:0;justify-content:center;align-items:center;display:inline-flex}.search-icon mi-icon{block-size:20px;inline-size:20px;display:block}.container:has(:disabled) .search-icon{color:var(--text-disabled,#00000059)}.input{min-block-size:1px;min-inline-size:1px;font-family:var(--typography-font-family,Arial, sans-serif);font-weight:var(--typography-font-weight-regular,400);font-size:var(--font-scale-40,14px);letter-spacing:.02em;color:var(--text-regular-default,#000000d6);text-overflow:ellipsis;white-space:nowrap;background-color:#0000;border:none;outline:none;flex:1 0 0;padding-block:0;padding-inline:0;line-height:1.5;overflow:hidden}.input::placeholder{color:var(--text-weak-default,#0000008a)}.input:disabled{color:var(--text-disabled,#00000059);cursor:not-allowed}.input:disabled::placeholder{color:var(--text-disabled,#00000059)}.input::-webkit-search-cancel-button{appearance:none;display:none}.clear-button{border-radius:var(--radius-full,9999px);block-size:24px;inline-size:24px;color:var(--object-regular-default,#000000d6);cursor:pointer;box-sizing:border-box;background-color:#0000;border:none;outline:none;flex-shrink:0;justify-content:center;align-items:center;padding-block:2px;padding-inline:2px;display:inline-flex}.clear-button:hover{background-color:var(--surface-overlay-hover,#00000012)}.clear-button:active{background-color:var(--surface-overlay-active,#0000001a)}.clear-button:focus-visible{background-color:var(--surface-regular-focus,#fff0);box-shadow:0 0 0 2px var(--surface-regular-default,#fff), 0 0 0 4px var(--focus-ring-default,#191919)}.clear-button mi-icon{block-size:20px;inline-size:20px;display:block}@media (width<=720px){.search-icon,.search-icon mi-icon{block-size:22px;inline-size:22px}.input{font-size:var(--font-scale-50,16px)}}", Z = class extends A {
	static {
		this.styles = N(a(_i));
	}
	static {
	...
	constructor() {
		super(), this.variant = "primary", this.value = "", this.placeholder = "", this.name = "", this.label = "", this.disabled = !1, this.autocomplete = "off", this.autofocus = !1, this.internals = this.attachInternals();
	}
	updated(e) {
	...
	#n(e) {
		e.composed || this.dispatchEvent(new Event("change", {
			bubbles: !1,
	...
	#r() {
		this.value = "", this.inputEl && (this.inputEl.value = ""), this.dispatchEvent(new InputEvent("input", {
			bubbles: !1,
			composed: !1,
			data: null,
	...
	render() {
		let e = this.value.length > 0 && !this.disabled;
		return E`
      <search class="${this.#e()}">
...
F([j({
	type: String,
	reflect: !0
})], Z.prototype, "variant", void 0), F([j({
	type: String,
	reflect: !0
})], Z.prototype, "value", void 0), F([j({
	type: String,
	reflect: !0
})], Z.prototype, "placeholder", void 0), F([j({
	type: String,
	reflect: !0
})], Z.prototype, "name", void 0), F([j({
	type: String,
	reflect: !0
})], Z.prototype, "label", void 0), F([j({
	type: Boolean,
	reflect: !0
})], Z.prototype, "disabled", void 0), F([j({
	type: String,
	reflect: !0
})], Z.prototype, "autocomplete", void 0), F([j({
	type: Boolean,
	reflect: !0
})], Z.prototype, "autofocus", void 0), F([Re("input")], Z.prototype, "inputEl", void 0);
var vi = class extends Z {};
customElements.get("mi-search-box") || customElements.define("mi-search-box", Z), customElements.get("sp-search-box") || customElements.define("sp-search-box", vi);
//#endregion
...
`, bi = ["text", "icon"], xi = class extends A {
	constructor(...e) {
...
F([j({
	type: String,
	reflect: !0
})], xi.prototype, "value", void 0), F([j({
	type: String,
	reflect: !0
})], xi.prototype, "variant", void 0), F([j({
	type: Boolean,
	reflect: !0
})], xi.prototype, "disabled", void 0), F([j({
	type: Boolean,
	reflect: !0
})], xi.prototype, "selected", void 0), customElements.get("mi-segment") || customElements.define("mi-segment", xi);
//#endregion
...
`, Ci = class extends A {
	...
	render() {
      ...
      <div
        role="radiogroup"
        aria-label="${this.getAttribute("aria-label") ?? O}"
      >
...
`, Ti = ["small", "medium"];
function Ei(e) {
	return typeof e == "string" && Ti.includes(e) ? e : "small";
}
var Di = class extends A {
	constructor(...e) {
	...
	scheduleAutoHide() {
		...
		let e = this.autoHideTimeout;
		typeof e != "number" || !Number.isFinite(e) || e <= 0 || typeof window > "u" || (this.autoHideTimerId = window.setTimeout(() => {
			this.autoHideTimerId = void 0, this.beginClose();
		}, e));
	}
	connectedCallback() {
		super.connectedCallback(), typeof window < "u" && window.matchMedia("(prefers-reduced-motion: reduce)").matches && (this.entering = !1), queueMicrotask(() => this.scheduleAutoHide());
	}
	disconnectedCallback() {
		super.disconnectedCallback(), this.clearAutoHideTimer(), this.exitFallbackTimer !== void 0 && (clearTimeout(this.exitFallbackTimer), this.exitFallbackTimer = void 0);
	}
	updated(e) {
		super.updated(e), e.has("autoHideTimeout") && this.scheduleAutoHide();
	}
	firstUpdated() {
		typeof window < "u" && window.matchMedia("(prefers-reduced-motion: reduce)").matches || requestAnimationFrame(() => {
	...
	beginClose() {
		if (this.isConnected && !this.exiting) {
			if (this.clearAutoHideTimer(), typeof window < "u" && window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
				this.exiting = !0, this.exitRemoved = !0, this.removeSelf();
				return;
			}
			this.exitTransitionSeen.clear(), this.entering = !1, this.exiting = !0, this.exitRemoved = !1, this.exitFallbackTimer = window.setTimeout(() => {
				this.exiting && !this.exitRemoved && (this.exitRemoved = !0, this.removeSelf());
			}, 350);
		}
	}
	handleRootTransitionEnd(e) {
		if (!this.isConnected || !this.exiting || this.exitRemoved) return;
		let t = this.shadowRoot?.querySelector(".root");
		!t || e.target !== t || e.propertyName !== "opacity" && e.propertyName !== "transform" || (this.exitTransitionSeen.add(e.propertyName), !(this.exitTransitionSeen.size < 2) && (this.exitTransitionSeen.clear(), this.exitRemoved = !0, this.exitFallbackTimer !== void 0 && (clearTimeout(this.exitFallbackTimer), this.exitFallbackTimer = void 0), this.removeSelf()));
	}
	handleClose() {
		this.beginClose();
	}
	...
	render() {
		let e = Ei(this.size), t = e === "small" ? "cross-small" : "cross", n = e === "small" ? "small" : "medium";
		return E`
      <div
        class="root ${e}"
...
F([j({
	type: String,
	reflect: !0
})], Di.prototype, "size", void 0), F([j({
	type: Number,
	attribute: "auto-hide-timeout"
})], Di.prototype, "autoHideTimeout", void 0), F([M()], Di.prototype, "entering", void 0), F([M()], Di.prototype, "exiting", void 0), customElements.get("mi-snackbar") || customElements.define("mi-snackbar", Di);
//#endregion
...
customElements.get("mi-snackbar-viewport") || customElements.define("mi-snackbar-viewport", ki);
//#endregion
//#region src/components/text-field/text-field/error-text/styles.css?inline
var Ai = ":host .container{color:#c92812;align-items:center;gap:2px;padding-top:8px;display:flex}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}", ji = class extends A {
	constructor(...e) {
		super(...e), this.text = "";
	}
	static {
...
var Ni = ".input{box-sizing:border-box;width:100%;height:48px;font-weight:var(--font-weight-normal);background:#fff;border:1px solid #b6b6b6;border-radius:6px;padding:4px 12px;font-size:16px;line-height:24}.input::placeholder{color:#0000008a}.input[disabled]{color:#000000ad;background-color:#0000000d;border-color:#e5e5e5}.input[disabled]::placeholder{color:#00000059}.input[disabled]:hover{border-color:#e5e5e5}.input:hover{border-color:#0000008f}.input:focus-visible{outline-offset:1px;outline:3px solid canvastext;box-shadow:0 0 0 2px #fff,0 0 0 4px #282828}.input.error{border-color:#db351f}", Q = class extends A {
	...
	constructor() {
		super(), this.error = "", this.placeholder = "", this.autocomplete = "off", this.disabled = !1, this.name = "", this.value = "", this.type = "text", this.autofocus = !1, this.submitOnEnter = !1, this.internals = this.attachInternals();
	}
	updated(e) {
		super.updated(e), e.has("value") && this.internals.setFormValue(this.value);
	}
...
F([j({
	type: String,
	reflect: !0
})], Q.prototype, "error", void 0), F([j({
	type: String,
	reflect: !0
})], Q.prototype, "placeholder", void 0), F([j({
	type: String,
	reflect: !0
})], Q.prototype, "autocomplete", void 0), F([j({
	type: Boolean,
	reflect: !0
})], Q.prototype, "disabled", void 0), F([j({
	type: String,
	reflect: !0
})], Q.prototype, "name", void 0), F([j({
	type: String,
	...
	type: String,
	reflect: !0
})], Q.prototype, "type", void 0), F([j({
	type: Boolean,
	reflect: !0
})], Q.prototype, "autofocus", void 0), F([j({
	type: Boolean,
	attribute: "submit-on-enter",
	reflect: !0
})], Q.prototype, "submitOnEnter", void 0);
var Pi = class extends Q {};
customElements.get("mi-text-field") || customElements.define("mi-text-field", Q), customElements.get("sp-text-field") || customElements.define("sp-text-field", Pi);
//#endregion
//#region src/components/text-field/text-field-unit/styles.css?inline
var Fi = ":host .label{text-align:left;margin-bottom:8px}:host .label.none{display:none}", $ = class extends A {
	static {
		this.styles = N(a(Fi));
	}
	static {
	...
	constructor() {
		super(), this.text = "", this.error = "", this.placeholder = "", this.supportText = "", this.disabled = !1, this.name = "", this.value = "", this.type = "text", this.autocomplete = "off", this.autofocus = !1, this.submitOnEnter = !1, this.internals = this.attachInternals();
	}
	updated(e) {
		super.updated(e), e.has("value") && this.internals.setFormValue(this.value);
	}
...
F([j({
	type: String,
	reflect: !0
})], $.prototype, "text", void 0), F([j({
	type: String,
	reflect: !0
})], $.prototype, "error", void 0), F([j({
	type: String,
	reflect: !0
})], $.prototype, "placeholder", void 0), F([j({
	type: String,
	attribute: "support-text",
	reflect: !0
})], $.prototype, "supportText", void 0), F([j({
	type: Boolean,
	reflect: !0
})], $.prototype, "disabled", void 0), F([j({
	type: String,
	reflect: !0
})], $.prototype, "name", void 0), F([j({
	type: String,
	reflect: !0
})], $.prototype, "value", void 0), F([j({
	type: String,
	reflect: !0
})], $.prototype, "type", void 0), F([j({
	type: String,
	reflect: !0
})], $.prototype, "autocomplete", void 0), F([j({
	type: Boolean,
	reflect: !0
})], $.prototype, "autofocus", void 0), F([j({
	type: Boolean,
	attribute: "submit-on-enter",
	reflect: !0
})], $.prototype, "submitOnEnter", void 0);
var Ii = class extends $ {};
customElements.get("mi-text-field-unit") || customElements.define("mi-text-field-unit", $), customElements.get("sp-text-field-unit") || customElements.define("sp-text-field-unit", Ii);
//#endregion
export { hr as MiActionDialog, ai as MiActionMenuItem, _t as MiAiButton, I as MiAvatar, sr as MiButton, q as MiCheckbox, J as MiCheckboxText, Qr as MiControlMenu, ti as MiControlMenuItem, vt as MiDangerButton, Cr as MiFloatingButton, vr as MiFormDialog, et as MiIcon, ar as MiIconButton, kr as MiIconColor, xr as MiInformationDialog, Mr as MiInlineNotification, Fr as MiLabelUnit, oi as MiLinkMenuItem, lt as MiLoading, Ur as MiLogo, si as MiMenu, X as MiMenuDropdown, ui as MiMenuGroup, di as MiMenuRadioGroup, or as MiNeutralButton, hi as MiRadioButtonText, Z as MiSearchBox, xi as MiSegment, Ci as MiSegmentedControl, fi as MiSelectMenuItem, Di as MiSnackbar, ki as MiSnackbarViewport, qr as MiSpeedaLogo, pi as MiSubMenuItem, Q as MiTextField, ji as MiTextFieldErrorText, $ as MiTextFieldUnit, tr as MiTooltip, Xr as MiUzabaseLogo, st as SpAvatar, cr as SpButton, dr as SpCheckbox, pr as SpCheckboxText, $r as SpControlMenu, ni as SpControlMenuItem, wr as SpFloatingButton, tt as SpIcon, Ir as SpLabelUnit, ut as SpLoading, Wr as SpLogo, gi as SpRadioButtonText, vi as SpSearchBox, Pi as SpTextField, Mi as SpTextFieldErrorText, Ii as SpTextFieldUnit, gr as formDialogSizes, ir as iconButtonSizes, rr as iconButtonVariants, yr as informationDialogSizes, bi as segmentVariants, Ti as snackbarSizes };
