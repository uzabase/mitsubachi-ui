...
var Y1 = (i, e, t) => e.has(i) || J1("Cannot " + t);
var o1 = (i, e, t) => (Y1(i, e, "read from private field"), t ? t.call(i) : e.get(i)), z = (i, e, t) => e.has(i) ? J1("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t);
var L = (i, e, t) => (Y1(i, e, "access private method"), t);
const n1 = globalThis, z1 = n1.ShadowRoot && (n1.ShadyCSS === void 0 || n1.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, E1 = Symbol(), X1 = /* @__PURE__ */ new WeakMap();
let C2 = class {
  constructor(e, t, s) {
    if (this._$cssResult$ = !0, s !== E1) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (z1 && e === void 0) {
      ...
      s && (e = X1.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), s && X1.set(t, e));
    }
    return e;
  }
  toString() {
...
const g = (i) => new C2(typeof i == "string" ? i : i + "", void 0, E1), a1 = (i, ...e) => {
  const t = i.length === 1 ? i[0] : e.reduce(((s, r, o) => s + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(r) + i[o + 1]), i[0]);
  return new C2(t, i, E1);
}, E2 = (i, e) => {
  if (z1) i.adoptedStyleSheets = e.map(((t) => t instanceof CSSStyleSheet ? t : t.styleSheet));
...
}, K1 = z1 ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const s of e.cssRules) t += s.cssText;
  return g(t);
})(i) : i;
const { is: S2, defineProperty: P2, getOwnPropertyDescriptor: T2, getOwnPropertyNames: j2, getOwnPropertySymbols: O2, getPrototypeOf: N2 } = Object, V1 = globalThis, Q1 = V1.trustedTypes, I2 = Q1 ? Q1.emptyScript : "", D2 = V1.reactiveElementPolyfillSupport, W = (i, e) => i, l1 = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? I2 : null;
      break;
  ...
  return t;
} }, S1 = (i, e) => !S2(i, e), e2 = { attribute: !0, type: String, converter: l1, reflect: !1, useDefault: !1, hasChanged: S1 };
Symbol.metadata ??= Symbol("metadata"), V1.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let O = class extends HTMLElement {
  ...
  static createProperty(e, t = e2) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      const s = Symbol(), r = this.getPropertyDescriptor(e, s, t);
      r !== void 0 && P2(this.prototype, e, r);
    }
  }
  static getPropertyDescriptor(e, t, s) {
    const { get: r, set: o } = T2(this.prototype, e) ?? { get() {
      return this[t];
    }, set(n) {
      this[t] = n;
    } };
  ...
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? e2;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(W("properties"))) {
      const t = this.properties, s = [...j2(t), ...O2(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of s) t.unshift(K1(r));
    } else e !== void 0 && t.push(K1(e));
    return t;
  }
  static _$Eu(e, t) {
    const s = t.attribute;
  ...
  createRenderRoot() {
    ...
    return E2(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
  ...
  _$ET(e, t) {
    ...
    if (r !== void 0 && s.reflect === !0) {
      const o = (s.converter?.toAttribute !== void 0 ? s.converter : l1).toAttribute(t, s.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const o = s.getPropertyOptions(r), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : l1;
      this._$Em = r;
  ...
  requestUpdate(e, t, s) {
    if (e !== void 0) {
      ...
      if (s ??= r.getPropertyOptions(e), !((s.hasChanged ?? S1)(o, t) || s.useDefault && s.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(r._$Eu(e, s)))) return;
      this.C(e, t, s);
    }
...
O.elementStyles = [], O.shadowRootOptions = { mode: "open" }, O[W("elementProperties")] = /* @__PURE__ */ new Map(), O[W("finalized")] = /* @__PURE__ */ new Map(), D2?.({ ReactiveElement: O }), (V1.reactiveElementVersions ??= []).push("2.1.1");
const P1 = globalThis, C1 = P1.trustedTypes, t2 = C1 ? C1.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, c2 = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, d2 = "?" + w, U2 = `<${d2}>`, P = document, G = () => P.createComment(""), J = (i) => i === null || typeof i != "object" && typeof i != "function", T1 = Array.isArray, B2 = (i) => T1(i) || typeof i?.[Symbol.iterator] == "function", M1 = `[ 	
\f\r]`, q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, r2 = /-->/g, i2 = />/g, E = RegExp(`>|${M1}(?:([^\\s"'>=/]+)(${M1}*=${M1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), s2 = /'/g, o2 = /"/g, p2 = /^(?:script|style|textarea|title)$/i, R2 = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), d = R2(1), _ = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), n2 = /* @__PURE__ */ new WeakMap(), S = P.createTreeWalker(P, 129);
function h2(i, e) {
  if (!T1(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return t2 !== void 0 ? t2.createHTML(e) : e;
}
const F2 = (i, e) => {
  ...
  for (let C = 0; C < t; C++) {
    const l = i[C];
    let h, f, c = -1, y = 0;
    for (; y < l.length && (n.lastIndex = y, f = n.exec(l), f !== null); ) y = n.lastIndex, n === q ? f[1] === "!--" ? n = r2 : f[1] !== void 0 ? n = i2 : f[2] !== void 0 ? (p2.test(f[2]) && (r = RegExp("</" + f[2], "g")), n = E) : f[3] !== void 0 && (n = E) : n === E ? f[0] === ">" ? (n = r ?? q, c = -1) : f[1] === void 0 ? c = -2 : (c = n.lastIndex - f[2].length, h = f[1], n = f[3] === void 0 ? E : f[3] === '"' ? o2 : s2) : n === o2 || n === s2 ? n = E : n === r2 || n === i2 ? n = q : (n = E, r = void 0);
    const Z = n === E && i[C + 1].startsWith("/>") ? " " : "";
    o += n === q ? l + U2 : c >= 0 ? (s.push(h), l.slice(0, c) + c2 + l.slice(c) + w + Z) : l + w + (c === -2 ? C : Z);
  }
  return [h2(i, o + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), s];
};
class Y {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const C = e.length - 1, l = this.parts, [h, f] = F2(e, t);
    if (this.el = Y.createElement(h, s), S.currentNode = this.el.content, t === 2 || t === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (r = S.nextNode()) !== null && l.length < C; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const c of r.getAttributeNames()) if (c.endsWith(c2)) {
          const y = f[n++], Z = r.getAttribute(c).split(w), s1 = /([.?@])?(.*)/.exec(y);
          l.push({ type: 1, index: o, name: s1[2], strings: Z, ctor: s1[1] === "." ? W2 : s1[1] === "?" ? G2 : s1[1] === "@" ? J2 : y1 }), r.removeAttribute(c);
        } else c.startsWith(w) && (l.push({ type: 6, index: o }), r.removeAttribute(c));
        if (p2.test(r.tagName)) {
          const c = r.textContent.split(w), y = c.length - 1;
          if (y > 0) {
            r.textContent = C1 ? C1.emptyScript : "";
            for (let Z = 0; Z < y; Z++) r.append(c[Z], G()), S.nextNode(), l.push({ type: 2, index: ++o });
            r.append(c[y], G());
          }
        }
      } else if (r.nodeType === 8) if (r.data === d2) l.push({ type: 2, index: o });
      else {
        let c = -1;
...
function N(i, e, t = i, s) {
  ...
  return r?.constructor !== o && (r?._$AO?.(!1), o === void 0 ? r = void 0 : (r = new o(i), r._$AT(i, t, s)), s !== void 0 ? (t._$Co ??= [])[s] = r : t._$Cl = r), r !== void 0 && (e = N(i, r._$AS(i, e.values), r, s)), e;
}
class q2 {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: s } = this._$AD, r = (e?.creationScope ?? P).importNode(t, !0);
    S.currentNode = r;
    let o = S.nextNode(), n = 0, C = 0, l = s[0];
    for (; l !== void 0; ) {
      if (n === l.index) {
        let h;
        l.type === 2 ? h = new t1(o, o.nextSibling, this, e) : l.type === 1 ? h = new l.ctor(o, l.name, l.strings, this, e) : l.type === 6 && (h = new Y2(o, this, e)), this._$AV.push(h), l = s[++C];
      }
      n !== l?.index && (o = S.nextNode(), n++);
    }
...
class t1 {
  ...
  _$AI(e, t = this) {
    e = N(this, e, t), J(e) ? e === p || e == null || e === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : e !== this._$AH && e !== _ && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : B2(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    const { values: t, _$litType$: s } = e, r = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = Y.createElement(h2(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === r) this._$AH.p(t);
    else {
      const o = new q2(r, this), n = o.u(this.options);
      o.p(t), this.T(n), this._$AH = o;
    }
  }
  _$AC(e) {
    let t = n2.get(e.strings);
    return t === void 0 && n2.set(e.strings, t = new Y(e)), t;
  }
  k(e) {
    T1(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let s, r = 0;
    for (const o of e) r === t.length ? t.push(s = new t1(this.O(G()), this.O(G()), this, this.options)) : s = t[r], s._$AI(o), r++;
...
class y1 {
  ...
  _$AI(e, t = this, s, r) {
    ...
    let n = !1;
    if (o === void 0) e = N(this, e, t, 0), n = !J(e) || e !== this._$AH && e !== _, n && (this._$AH = e);
    else {
      const C = e;
      let l, h;
      for (e = o[0], l = 0; l < o.length - 1; l++) h = N(this, C[s + l], t, l), h === _ && (h = this._$AH[l]), n ||= !J(h) || h !== this._$AH[l], h === p ? e = p : e !== p && (e += (h ?? "") + o[l + 1]), this._$AH[l] = h;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
const X2 = P1.litHtmlPolyfillSupport;
X2?.(Y, t1), (P1.litHtmlVersions ??= []).push("3.3.1");
const K2 = (i, e, t) => {
  const s = t?.renderBefore ?? e;
  let r = s._$litPart$;
  if (r === void 0) {
    const o = t?.renderBefore ?? null;
    s._$litPart$ = r = new t1(e.insertBefore(G(), o), o, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
const j1 = globalThis;
let u = class extends O {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = K2(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
u._$litElement$ = !0, u.finalized = !0, j1.litElementHydrateSupport?.({ LitElement: u });
const Q2 = j1.litElementPolyfillSupport;
Q2?.({ LitElement: u });
(j1.litElementVersions ??= []).push("4.2.1");
const e9 = { attribute: !0, type: String, converter: l1, reflect: !1, hasChanged: S1 }, t9 = (i = e9, e, t) => {
  ...
  if (o === void 0 && globalThis.litPropertyMetadata.set(r, o = /* @__PURE__ */ new Map()), s === "setter" && ((i = Object.create(i)).wrapped = !0), o.set(t.name, i), s === "accessor") {
    ...
    return { set(C) {
      ...
      e.set.call(this, C), this.requestUpdate(n, l, i);
    }, init(C) {
  ...
  if (s === "setter") {
    ...
    return function(C) {
      const l = this[n];
      e.call(this, C), this.requestUpdate(n, l, i);
    };
  }
  throw Error("Unsupported decorator location: " + s);
};
function a(i) {
  return (e, t) => typeof t == "object" ? t9(i, e, t) : ((s, r, o) => {
    const n = r.hasOwnProperty(o);
    return r.constructor.createProperty(o, s), n ? Object.getOwnPropertyDescriptor(r, o) : void 0;
  })(i, e, t);
}
const u2 = { ATTRIBUTE: 1, CHILD: 2 }, O1 = (i) => (...e) => ({ _$litDirective$: i, values: e });
class f2 {
  constructor(e) {
  }
  get _$AU() {
...
let c1 = class extends f2 {
  constructor(e) {
    if (super(e), this.it = p, e.type !== u2.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(e) {
...
const n9 = ":host{display:inline-block;width:1.28em;height:1.28em}.icon{width:100%;height:100%}", a9 = [
  "app",
  "arrow-down",
  "arrow-down-small",
  "arrow-left",
...
var l9 = Object.defineProperty, C9 = (i, e, t, s) => {
...
customElements.get("sp-icon") || customElements.define("sp-icon", d1);
const h9 = a1`
  :host {
...
`;
var u9 = Object.defineProperty, R = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && u9(e, t, r), r;
};
const f9 = ["small", "medium", "large", "x-large", "2x-large"], g9 = [
  "plum",
  "violet",
  "blue",
  "viridian",
...
function b9(i) {
  return f9.some((e) => e === i) ? i : (console.warn(`${i}は無効なsize属性です。`), "medium");
}
function H9(i) {
  return g9.some((e) => e === i);
}
var x, b2, H2, _1;
const D1 = class D1 extends u {
  ...
  render() {
    const t = o1(this, x, _1);
    return d`
      <div class="${o1(this, x, b2)}">
        ${this.src ? d`
              <img
                src="${this.src}"
                alt="${this.alt}"
                ...
                class="image"
              />
            ` : t ? d`<div class="initials">${t}</div>` : d`<div class="icon"><sp-icon type="person"></sp-icon></div>`}
      </div>
    `;
  }
};
x = new WeakSet(), b2 = function() {
  const t = ["base", `size-${b9(this.size)}`];
  return !this.src && o1(this, x, _1) && this.color && H9(this.color) && t.push(`color-${this.color}`), this.inactive && t.push("inactive"), t.filter(Boolean).join(" ");
}, H2 = function() {
  this.src = "";
}, _1 = function() {
...
customElements.get("sp-loading") || customElements.define("sp-loading", X);
const V9 = ":host{display:inline-block}.normal.primary{--border-color: transparent;--background-color: rgb(0 0 0 / 84%);--background-color-hover: rgb(0 0 0 / 90%);--background-color-active: #000;--color: #FFF}.normal.secondary{--border-color: rgb(0 0 0 / 84%);--background-color: transparent;--background-color-hover: rgb(0 0 0 / 4%);--background-color-active: rgb(0 0 0 / 7%);--color: rgb(0 0 0 / 84%)}.normal.tertiary{--border-color: rgb(0 0 0 / 29%);--background-color: transparent;--background-color-hover: rgb(0 0 0 / 4%);--background-color-active: rgb(0 0 0 / 7%);--color: rgb(0 0 0 / 84%)}.normal.ghost{--border-color: transparent;--background-color: transparent;--background-color-hover: rgb(0 0 0 / 4%);--background-color-active: rgb(0 0 0 / 7%);--color: rgb(0 0 0 / 84%)}.normal.plane{--border-color: transparent;--background-color: transparent;--background-color-hover: rgb(0 0 0 / 10%);--background-color-active: rgb(0 0 0 / 10%);--color: #315ce8}.danger.primary{--border-color: transparent;--background-color: #DB351F;--background-color-hover: #C92812;--background-color-active: #B02412;--color: #fff}.danger.secondary,.danger.tertiary{--border-color: #DB351F;--background-color: transparent;--background-color-hover: #FFF4F2;--background-color-active: #FFEDEB;--color: #C92812}.danger.ghost{--border-color: transparent;--background-color: transparent;--background-color-hover: #FFF4F2;--background-color-active: #FFEDEB;--color: #C92812}.mode-ai.primary{--border-color: transparent;--background-color: linear-gradient(135deg, #667eea 0%, #764ba2 100%);--background-color-hover: linear-gradient(135deg, #5568d3 0%, #5e3a82 100%);--background-color-active: linear-gradient(135deg, #4a5abd 0%, #4d2f6b 100%);--color: #FFF;background-image:var(--background-color);border:none}.mode-ai.primary:hover{background-image:var(--background-color-hover)}.mode-ai.primary:active{background-image:var(--background-color-active)}.mode-ai.secondary{--border-color: #667eea;--background-color: transparent;--background-color-hover: rgba(102, 126, 234, .1);--background-color-active: rgba(102, 126, 234, .2);--color: #667eea}.primary{--border-color-disabled: transparent;--background-color-disabled: rgb(0 0 0 / 5%);--color-disabled: rgb(0 0 0 / 35%)}:is(.secondary,.tertiary){--border-color-disabled: rgb(0 0 0 / 10%);--background-color-disabled: transparent;--color-disabled: rgb(0 0 0 / 35%)}.ghost{--border-color-disabled: transparent;--background-color-disabled: transparent;--color-disabled: rgb(0 0 0 / 35%)}.plane{--border-color-disabled: transparent;--background-color-disabled: transparent;--color-disabled: rgb(49 92 232 / 35%)}.base{display:inline-flex;justify-content:center;align-items:center;gap:4px;width:100%;flex-basis:100%;padding-block:2px;border:1px solid var(--border-color);border-radius:9999px;background-color:var(--background-color);color:var(--color);position:relative;cursor:pointer}.base:focus-visible{box-shadow:0 0 0 2px #fff,0 0 0 4px #191919}.base:hover{background-color:var(--background-color-hover)}.base:active{background-color:var(--background-color-active)}.base:disabled{border-color:var(--border-color-disabled);background-color:var(--background-color-disabled);color:var(--color-disabled);cursor:not-allowed}.base:disabled:hover{border-color:var(--border-color-disabled);background-color:var(--background-color-disabled)}.base:disabled.loading{color:#000000d6}.medium{min-height:32px;padding-inline:12px;font-size:12px}.large{min-height:40px;padding-inline:16px;font-size:14px}.x-large{min-height:48px;padding-inline:16px;font-size:16px}.plane.medium{min-height:18px;padding-inline:4px;padding-block:0;border-radius:9999px}.plane.large{min-height:25px;padding-inline:4px;padding-block:0;font-size:14px;border-radius:9999px}.plane.x-large{min-height:28px;padding-inline:4px;padding-block:0;font-size:16px;border-radius:9999px}.icon{fill:currentcolor}.text{line-height:1.5;letter-spacing:.02em}.text:is(.primary *,.secondary *){font-weight:var(--font-weight-bold)}";
var y9 = Object.defineProperty, T = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && y9(e, t, r), r;
};
const x1 = ["medium", "large", "xLarge"];
function a2(i) {
  return i ? x1.some((e) => e === i) ? i : (console.warn(`${i}は無効なsize属性です。`), x1[0]) : x1[0];
}
function v9(i) {
  return i ? g2(i) ? !0 : (console.warn(`${i}は無効なicon-type属性です。`), !1) : !1;
}
const u1 = class u1 extends u {
  constructor() {
    super(), this.loading = !1, this.disabled = !1, this.size = "medium", this.name = "", this.value = "", this.type = "button", this.iconType = "", this.internals = this.attachInternals();
  }
  get buttonClasses() {
    const e = {
      medium: "medium",
  ...
  renderLoading() {
    return d`<sp-loading size="${this.loadingSize}"></sp-loading>`;
  }
  get showIcon() {
    return !this.loading && this.iconType && v9(this.iconType);
  }
  renderIcon() {
    return d`<sp-icon type="${this.iconType}" class="icon"></sp-icon>`;
  }
  render() {
    return d`
      <button
      ...
      >
        ${this.loading ? this.renderLoading() : p}
        ${this.showIcon ? this.renderIcon() : p}
        <slot class="text"></slot>
      </button>
    `;
  }
  handleClick(e) {
    e.preventDefault(), e.stopPropagation(), this.dispatchEvent(new MouseEvent("click", e)) && this.internals.form && this.internals.form.requestSubmit();
  }
};
u1.styles = b(g(V9)), u1.formAssociated = !0;
let H = u1;
T([
...
], H.prototype, "iconType");
var M9 = Object.defineProperty, x9 = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && M9(e, t, r), r;
};
const $1 = ["primary", "secondary"];
function $9(i) {
  return i ? $1.some((e) => e === i) ? i : (console.warn(
    `${i}は無効なvariant属性です。AI ボタンでは primary, secondary のみ使用可能です。`
  ), $1[0]) : $1[0];
}
class L2 extends H {
  constructor() {
  ...
  get variantClass() {
    return $9(this.variant);
  }
}
x9([
  a({ type: String })
], L2.prototype, "variant");
customElements.get("sp-ai-button") || customElements.define("sp-ai-button", L2);
var Z9 = Object.defineProperty, v1 = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && Z9(e, t, r), r;
};
...
function l2(i) {
  return i ? Z1.some((e) => e === i) ? i : (console.warn(`${i}は無効なvariant属性です。`), Z1[0]) : Z1[0];
}
class r1 extends H {
  constructor() {
    super(...arguments), this.danger = !1, this.buttonType = "normal", this.variants = null, this.variant = "primary";
  }
  updated(e) {
    super.updated(e), this.danger && console.warn(
      "⚠️ sp-button で danger プロパティを使用しています。代わりに sp-danger-button コンポーネントの使用を推奨します。"
    ), this.buttonType === "danger" && console.warn(
  ...
  get variantClass() {
    return this.variants ? l2(this.variants) : l2(this.variant);
  }
}
v1([
  a({ type: Boolean, reflect: !0 })
...
v1([
  a({ type: String, attribute: "button-type" })
], r1.prototype, "buttonType");
v1([
  a({ type: String })
], r1.prototype, "variants");
v1([
  a({ type: String })
], r1.prototype, "variant");
customElements.get("sp-button") || customElements.define("sp-button", r1);
var k9 = Object.defineProperty, w9 = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && k9(e, t, r), r;
};
const k1 = ["primary", "secondary", "ghost"];
function _9(i) {
  return i ? k1.some((e) => e === i) ? i : (console.warn(
    `${i}は無効なvariant属性です。danger ボタンでは primary, secondary, ghost のみ使用可能です。`
  ), k1[0]) : k1[0];
}
class V2 extends H {
  constructor() {
...
customElements.get("sp-checkbox-text") || customElements.define("sp-checkbox-text", M);
const P9 = a1`
  :host {
    display: inline-block;
...
`;
var T9 = Object.defineProperty, j9 = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && T9(e, t, r), r;
};
const B1 = class B1 extends u {
  ...
  render() {
    return d`<button class="base">
      ${this.loading ? d`<sp-loading class="loading" ai size="3xLarge"></sp-loading>` : d`<sp-icon class="icon" type="magic-fill"></sp-icon>`}
    </button>`;
  }
};
B1.styles = b(P9);
...
j9([
  a({ type: Boolean })
], p1.prototype, "loading");
customElements.get("sp-floating-button") || customElements.define("sp-floating-button", p1);
const K = O1(class extends f2 {
  constructor(i) {
    if (super(i), i.type !== u2.ATTRIBUTE || i.name !== "class" || i.strings?.length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(i) {
...
}), O9 = ":host{display:flex;flex-direction:column;gap:4px}:host .label{font-weight:var(--font-weight-bold);font-size:14px;color:#000000d6}:host .label.none{display:none}:host .support{font-weight:var(--font-weight-normal);font-size:12px;color:#0000008a}:host .support.none{display:none}";
var N9 = Object.defineProperty, v2 = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && N9(e, t, r), r;
}, D, M2, x2;
const R1 = class R1 extends u {
  ...
  render() {
    return d`
      <span class=${L(this, D, M2).call(this)}>${this.text}</span>
      <span class=${L(this, D, x2).call(this)}>${this.supportText}</span>
    `;
  }
};
D = new WeakSet(), M2 = function() {
  return K({
    label: !0,
    none: !this.text
  });
...
], Q.prototype, "supportText");
customElements.get("sp-label-unit") || customElements.define("sp-label-unit", Q);
const I9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, D9 = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, U9 = `<svg viewBox="0 0 134 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, B9 = `<svg viewBox="0 0 118 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var R9 = Object.defineProperty, $2 = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && R9(e, t, r), r;
}, b1, Z2;
const F1 = class F1 extends u {
  ...
  render() {
    const t = L(this, b1, Z2).call(this);
    return t ? d`${r9(t)}` : d``;
  }
};
b1 = new WeakSet(), Z2 = function() {
  if (this.brand === "uzabase")
    return B9;
  if (this.brand === "speeda")
    return this.language === "en" ? D9 : this.language === "zh" ? U9 : I9;
}, F1.styles = b();
let e1 = F1;
$2([
  a({ type: String, reflect: !0 })
], e1.prototype, "language");
$2([
  a({ type: String, reflect: !0 })
], e1.prototype, "brand");
customElements.get("sp-logo") || customElements.define("sp-logo", e1);
const F9 = ":host{display:block;border-radius:6px;padding:8px 0;box-shadow:0 5px 9px 2px #00000021;background-color:#fff}", q1 = class q1 extends u {
  render() {
    return d`<slot></slot>`;
  }
};
...
customElements.get("sp-control-menu-item") || customElements.define("sp-control-menu-item", I);
const G9 = ":host .container{display:flex;gap:2px;align-items:center;padding-top:8px;color:#c92812}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}";
...
const G1 = class G1 extends u {
  ...
  render() {
    return d`
      <div class="${L(this, H1, k2).call(this)}" role="error">
...
}, m1.styles = b(g(X9)), m1.formAssociated = !0;
let V = m1;
j([
  a({ type: String, reflect: !0 })
], V.prototype, "error");
...
customElements.get("sp-text-field") || customElements.define("sp-text-field", V);
const Q9 = ":host .label{margin-bottom:8px;text-align:left}:host .label.none{display:none}";
var e0 = Object.defineProperty, $ = (i, e, t, s) => {
  for (var r = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (r = n(e, t, r) || r);
  return r && e0(e, t, r), r;
}, B, A2, z2;
...
B = new WeakSet(), A2 = function() {
  ...
  const s = t.target;
  this.value = s.value;
}, L1.styles = b(g(Q9)), L1.formAssociated = !0;
let m = L1;
$([
  a({ type: String, reflect: !0 })
], m.prototype, "text");
...
customElements.get("sp-text-field-unit") || customElements.define("sp-text-field-unit", m);
export {
  L2 as SpAiButton,
  v as SpAvatar,
  r1 as SpButton,
  ...
  M as SpCheckboxText,
  A1 as SpControlMenu,
  I as SpControlMenuItem,
  V2 as SpDangerButton,
  p1 as SpFloatingButton,
  d1 as SpIcon,
  Q as SpLabelUnit,
  X as SpLoading,
  e1 as SpLogo,
  m as SpTextFieldUnit
};
