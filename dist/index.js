...
var l1 = (i, t, e) => t.has(i) || L1("Cannot " + e);
var M1 = (i, t, e) => (l1(i, t, "read from private field"), e ? e.call(i) : t.get(i)), M = (i, t, e) => t.has(i) ? L1("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(i) : t.set(i, e), E1 = (i, t, e, r) => (l1(i, t, "write to private field"), r ? r.call(i, e) : t.set(i, e), e), x = (i, t, e) => (l1(i, t, "access private method"), e);
const G = globalThis, p1 = G.ShadowRoot && (G.ShadyCSS === void 0 || G.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, C1 = Symbol(), V1 = /* @__PURE__ */ new WeakMap();
let D1 = class {
  constructor(t, e, r) {
    if (this._$cssResult$ = !0, r !== C1) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (p1 && t === void 0) {
      ...
      r && (t = V1.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && V1.set(e, t));
    }
    return t;
  }
  toString() {
...
const m = (i) => new D1(typeof i == "string" ? i : i + "", void 0, C1), S1 = (i, ...t) => {
  const e = i.length === 1 ? i[0] : t.reduce(((r, s, o) => r + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(s) + i[o + 1]), i[0]);
  return new D1(e, i, C1);
}, ht = (i, t) => {
  if (p1) i.adoptedStyleSheets = t.map(((e) => e instanceof CSSStyleSheet ? e : e.styleSheet));
...
}, k1 = p1 ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const r of t.cssRules) e += r.cssText;
  return m(e);
})(i) : i;
const { is: dt, defineProperty: ct, getOwnPropertyDescriptor: pt, getOwnPropertyNames: Ct, getOwnPropertySymbols: ut, getPrototypeOf: ft } = Object, n1 = globalThis, Z1 = n1.trustedTypes, gt = Z1 ? Z1.emptyScript : "", mt = n1.reactiveElementPolyfillSupport, B = (i, t) => i, Q = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? gt : null;
      break;
  ...
  return e;
} }, u1 = (i, t) => !dt(i, t), z1 = { attribute: !0, type: String, converter: Q, reflect: !1, useDefault: !1, hasChanged: u1 };
Symbol.metadata ??= Symbol("metadata"), n1.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let Z = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(B("properties"))) {
      const e = this.properties, r = [...Ct(e), ...ut(e)];
  ...
  requestUpdate(t, e, r) {
    if (t !== void 0) {
      ...
      if (r ??= s.getPropertyOptions(t), !((r.hasChanged ?? u1)(o, e) || r.useDefault && r.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(s._$Eu(t, r)))) return;
      this.C(t, e, r);
    }
...
Z.elementStyles = [], Z.shadowRootOptions = { mode: "open" }, Z[B("elementProperties")] = /* @__PURE__ */ new Map(), Z[B("finalized")] = /* @__PURE__ */ new Map(), mt?.({ ReactiveElement: Z }), (n1.reactiveElementVersions ??= []).push("2.1.1");
const f1 = globalThis, X = f1.trustedTypes, P1 = X ? X.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, I1 = "$lit$", H = `lit$${Math.random().toFixed(9).slice(2)}$`, q1 = "?" + H, bt = `<${q1}>`, S = document, N = () => S.createComment(""), R = (i) => i === null || typeof i != "object" && typeof i != "function", g1 = Array.isArray, yt = (i) => g1(i) || typeof i?.[Symbol.iterator] == "function", h1 = `[ 	
\f\r]`, j = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, O1 = /-->/g, T1 = />/g, E = RegExp(`>|${h1}(?:([^\\s"'>=/]+)(${h1}*=${h1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), U1 = /'/g, j1 = /"/g, F1 = /^(?:script|style|textarea|title)$/i, vt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), f = vt(1), A = Symbol.for("lit-noChange"), c = Symbol.for("lit-nothing"), B1 = /* @__PURE__ */ new WeakMap(), V = S.createTreeWalker(S, 129);
function W1(i, t) {
  if (!g1(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const $t = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = i[h];
    let p, C, d = -1, $ = 0;
    for (; $ < a.length && (n.lastIndex = $, C = n.exec(a), C !== null); ) $ = n.lastIndex, n === j ? C[1] === "!--" ? n = O1 : C[1] !== void 0 ? n = T1 : C[2] !== void 0 ? (F1.test(C[2]) && (s = RegExp("</" + C[2], "g")), n = E) : C[3] !== void 0 && (n = E) : n === E ? C[0] === ">" ? (n = s ?? j, d = -1) : C[1] === void 0 ? d = -2 : (d = n.lastIndex - C[2].length, p = C[1], n = C[3] === void 0 ? E : C[3] === '"' ? j1 : U1) : n === j1 || n === U1 ? n = E : n === O1 || n === T1 ? n = j : (n = E, s = void 0);
    const w = n === E && i[h + 1].startsWith("/>") ? " " : "";
    o += n === j ? a + bt : d >= 0 ? (r.push(p), a.slice(0, d) + I1 + a.slice(d) + H + w) : a + H + (d === -2 ? h : w);
  }
  return [W1(i, o + (i[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class D {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const h = t.length - 1, a = this.parts, [p, C] = $t(t, e);
    if (this.el = D.createElement(p, r), V.currentNode = this.el.content, e === 2 || e === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (s = V.nextNode()) !== null && a.length < h; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(I1)) {
          const $ = C[n++], w = s.getAttribute(d).split(H), Y = /([.?@])?(.*)/.exec($);
          a.push({ type: 1, index: o, name: Y[2], strings: w, ctor: Y[1] === "." ? _t : Y[1] === "?" ? wt : Y[1] === "@" ? Ht : a1 }), s.removeAttribute(d);
        } else d.startsWith(H) && (a.push({ type: 6, index: o }), s.removeAttribute(d));
        if (F1.test(s.tagName)) {
          const d = s.textContent.split(H), $ = d.length - 1;
          if ($ > 0) {
            s.textContent = X ? X.emptyScript : "";
            for (let w = 0; w < $; w++) s.append(d[w], N()), V.nextNode(), a.push({ type: 2, index: ++o });
            s.append(d[$], N());
          }
        }
      } else if (s.nodeType === 8) if (s.data === q1) a.push({ type: 2, index: o });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(H, d + 1)) !== -1; ) a.push({ type: 7, index: o }), d += H.length - 1;
      }
      o++;
    }
  }
...
function z(i, t, e = i, r) {
  ...
  return s?.constructor !== o && (s?._$AO?.(!1), o === void 0 ? s = void 0 : (s = new o(i), s._$AT(i, e, r)), r !== void 0 ? (e._$Co ??= [])[r] = s : e._$Cl = s), s !== void 0 && (t = z(i, s._$AS(i, t.values), s, r)), t;
}
class xt {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, s = (t?.creationScope ?? S).importNode(e, !0);
    V.currentNode = s;
    let o = V.nextNode(), n = 0, h = 0, a = r[0];
    for (; a !== void 0; ) {
      if (n === a.index) {
        let p;
        a.type === 2 ? p = new K(o, o.nextSibling, this, t) : a.type === 1 ? p = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (p = new At(o, this, t)), this._$AV.push(p), a = r[++h];
      }
...
class K {
  ...
  _$AI(t, e = this) {
    t = z(this, t, e), R(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : yt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: e, _$litType$: r } = t, s = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = D.createElement(W1(r.h, r.h[0]), this.options)), r);
  ...
  _$AC(t) {
    let e = B1.get(t.strings);
    return e === void 0 && B1.set(t.strings, e = new D(t)), e;
  }
  k(t) {
    g1(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let r, s = 0;
    for (const o of t) s === e.length ? e.push(r = new K(this.O(N()), this.O(N()), this, this.options)) : r = e[s], r._$AI(o), s++;
...
class a1 {
  ...
  _$AI(t, e = this, r, s) {
    ...
    let n = !1;
    if (o === void 0) t = z(this, t, e, 0), n = !R(t) || t !== this._$AH && t !== A, n && (this._$AH = t);
    else {
      const h = t;
      let a, p;
      for (t = o[0], a = 0; a < o.length - 1; a++) p = z(this, h[r + a], e, a), p === A && (p = this._$AH[a]), n ||= !R(p) || p !== this._$AH[a], p === c ? t = c : t !== c && (t += (p ?? "") + o[a + 1]), this._$AH[a] = p;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
const Lt = f1.litHtmlPolyfillSupport;
Lt?.(D, K), (f1.litHtmlVersions ??= []).push("3.3.1");
const Mt = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let s = r._$litPart$;
  if (s === void 0) {
    const o = e?.renderBefore ?? null;
    r._$litPart$ = s = new K(t.insertBefore(N(), o), o, void 0, e ?? {});
  }
  return s._$AI(i), s;
};
const m1 = globalThis;
...
const Et = m1.litElementPolyfillSupport;
Et?.({ LitElement: u });
(m1.litElementVersions ??= []).push("4.2.1");
const Vt = { attribute: !0, type: String, converter: Q, reflect: !1, hasChanged: u1 }, St = (i = Vt, t, e) => {
...
var Pt = Object.defineProperty, L = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && Pt(t, e, s), s;
};
const N1 = ["primary", "secondary", "tertiary"], R1 = ["medium", "large", "xLarge"];
function Ot(i) {
  return N1.some((t) => t === i) ? i : (console.warn(`${i}は無効なvariants属性です。`), N1[0]);
}
function Tt(i) {
  return R1.some((t) => t === i) ? i : (console.warn(`${i}は無効なsize属性です。`), R1[0]);
}
...
const J1 = { ATTRIBUTE: 1, CHILD: 2 }, K1 = (i) => (...t) => ({ _$litDirective$: i, values: t });
class Y1 {
  constructor(t) {
  }
  get _$AU() {
...
let d1 = class extends Y1 {
  constructor(t) {
    if (super(t), this.it = c, t.type !== J1.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const v1 = class v1 extends u {
  constructor() {
    super(...arguments);
    M(this, J);
    this.type = "", E1(this, J, /* @__PURE__ */ new Map([
      ["error-fill", Ut],
      ["information-circle", jt],
      ["person", Bt],
      ["check-circle-fill", Nt],
      ["check-small", Ft],
      ["check-circle", Rt],
      ["chevron-down", Dt],
      ["chevron-down-small", qt],
      ["globe", It]
    ]));
  }
  render() {
    const e = M1(this, J).get(this.type);
    return e ? f`${G1(e)}` : f``;
  }
};
J = new WeakMap(), v1.styles = v();
let t1 = v1;
Jt([
  l({ type: String, reflect: !0 })
], t1.prototype, "type");
customElements.get("sp-icon") || customElements.define("sp-icon", t1);
const I = K1(class extends Y1 {
  constructor(i) {
    if (super(i), i.type !== J1.ATTRIBUTE || i.name !== "class" || i.strings?.length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(i) {
...
}), Kt = ":host{display:flex;flex-direction:column;gap:4px}:host .label{font-weight:var(--font-weight-bold);font-size:14px;color:#000000d6}:host .label.none{display:none}:host .support{font-weight:var(--font-weight-normal);font-size:12px;color:#0000008a}:host .support.none{display:none}";
var Yt = Object.defineProperty, Q1 = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && Yt(t, e, s), s;
}, O, X1, tt;
const $1 = class $1 extends u {
  ...
  render() {
    return f`
      <span class=${x(this, O, X1).call(this)}>${this.text}</span>
      <span class=${x(this, O, tt).call(this)}>${this.supportText}</span>
    `;
  }
};
O = new WeakSet(), X1 = function() {
  return I({
    label: !0,
    none: !this.text
  });
...
const x1 = class x1 extends u {
  ...
  render() {
    return f` <span class="${this.loadingClasses}" role="status"></span> `;
  }
};
x1.styles = v(m(Gt));
let F = x1;
...
customElements.get("sp-loading") || customElements.define("sp-loading", F);
const Xt = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, te = `<svg viewBox="0 0 74 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, ee = `<svg viewBox="0 0 134 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, se = `<svg viewBox="0 0 118 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var re = Object.defineProperty, st = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && re(t, e, s), s;
}, s1, rt;
const _1 = class _1 extends u {
  ...
  render() {
    const e = x(this, s1, rt).call(this);
    return e ? f`${G1(e)}` : f``;
  }
};
s1 = new WeakSet(), rt = function() {
  if (this.brand === "uzabase")
    return se;
  if (this.brand === "speeda")
    return this.language === "en" ? te : this.language === "zh" ? ee : Xt;
}, _1.styles = v();
let W = _1;
st([
  l({ type: String, reflect: !0 })
...
customElements.get("sp-logo") || customElements.define("sp-logo", W);
const ie = ":host{display:block;border-radius:6px;padding:8px 0;box-shadow:0 5px 9px 2px #00000021;background-color:#fff}", w1 = class w1 extends u {
  render() {
    return f`<slot></slot>`;
  }
};
...
customElements.get("sp-control-menu-item") || customElements.define("sp-control-menu-item", P);
const ae = ":host .container{display:flex;gap:2px;align-items:center;padding-top:8px}:host .container>.text{font-weight:var(--font-weight-normal);font-size:14px;color:#c92812}:host .container .icon{width:21px;height:21px}:host .container.none{display:none}";
var le = Object.defineProperty, he = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && le(t, e, s), s;
}, r1, it;
const A1 = class A1 extends u {
  ...
  render() {
    return f`
      <div class="${x(this, r1, it).call(this)}" role="error">
...
}, i1.styles = v(m(de)), i1.formAssociated = !0;
let y = i1;
k([
  l({ type: String, reflect: !0 })
], y.prototype, "error");
...
customElements.get("sp-text-field") || customElements.define("sp-text-field", y);
const pe = ":host .label{margin-bottom:8px}:host .label.none{display:none}";
var Ce = Object.defineProperty, _ = (i, t, e, r) => {
  for (var s = void 0, o = i.length - 1, n; o >= 0; o--)
    (n = i[o]) && (s = n(t, e, s) || s);
  return s && Ce(t, e, s), s;
}, U, at, lt;
...
U = new WeakSet(), at = function() {
  ...
  const r = e.target;
  this.value = r.value;
}, o1.styles = v(m(pe)), o1.formAssociated = !0;
let g = o1;
_([
  l({ type: String, reflect: !0 })
], g.prototype, "text");
...
customElements.get("sp-text-field-unit") || customElements.define("sp-text-field-unit", g);
export {
  b as SpButton,
  c1 as SpControlMenu,
  P as SpControlMenuItem,
  t1 as SpIcon,
  q as SpLabelUnit,
  F as SpLoading,
  W as SpLogo,
  g as SpTextFieldUnit
};
